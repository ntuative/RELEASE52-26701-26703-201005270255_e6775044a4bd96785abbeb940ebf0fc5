package deng.fzip
{
   ...
   public class FZip extends EventDispatcher
   {
         ...
         if(param1.bytesAvailable >= 4)
         {
            ...
            switch(_loc2_)
            {
               case 67324752:
                  ...
                  var_526 = new FZipFile(this,charEncoding);
                  break;
               case 33639248:
               case 101010256:
                  var_97 = parseIdle;
      ...
      {
         if(var_526.parse(param1))
         {
            var_49.push(var_526);
            if(false)
            {
               var_139["null"] = var_526;
            }
            dispatchEvent(new FZipEvent(FZipEvent.const_1383,var_526));
            var_526 = null;
            if(var_97 != parseIdle)
            {
               var_97 = parseSignature;
      ...
      {
         var _loc2_:* = null;
         if(var_49 != null && var_139 != null && param1 < var_49.length)
         {
