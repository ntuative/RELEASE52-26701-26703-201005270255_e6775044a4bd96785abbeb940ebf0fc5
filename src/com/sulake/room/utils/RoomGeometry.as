package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_763:Number = 64;
      
      public static const const_885:Number = 32;
      ...
      private var var_1459:Number = 1.0;
      
      private var var_2386:Number = 500.0;
      
      private var var_1460:Number = 1.0;
      
      private var var_83:Vector3d;
      
      private var var_84:Vector3d;
      
      private var var_2387:Number = -500.0;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         _y = new Vector3d();
         var_84 = new Vector3d();
         var_1011 = new Vector3d();
         var_1461 = 1;
         var_1460 = 1;
         x_scale = 1;
         y_scale = 1;
         var_1459 = Math.sqrt(0.5) / Math.sqrt(0.75);
         z_scale = 1;
      ...
      {
         if(var_398 != param1 * var_1459)
         {
            var_398 = param1 * var_1459;
            ++var_77;
         }
      }
      ...
      {
         if(var_395 != param1 * var_1461)
         {
            var_395 = param1 * var_1461;
            ++var_77;
         }
      }
      ...
      {
         if(var_396 != param1 * var_1460)
         {
            var_396 = param1 * var_1460;
            ++var_77;
         }
      }
      ...
      public function setDisplacement(param1:IVector3d, param2:IVector3d) : void
      {
         ...
         if(var_397 != null)
         {
            ...
            var_397.remove(_loc3_);
            _loc4_ = new Vector3d();
            _loc4_.assign(param2);
            var_397.add(_loc3_,_loc4_);
            ++var_77;
         }
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            var_1011.assign(_loc22_);
         }
         else
         {
            var_1011.assign(_loc17_);
         }
         ++var_77;
      }
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.y *= var_396;
         _loc2_.z *= var_398;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,var_1011);
         if(_loc3_ < var_2387 || _loc3_ > var_2386)
         {
            return null;
         }
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= var_396;
            _loc2_.z *= var_398;
            _loc3_ = Vector3d.scalarProjection(_loc2_,var_1011);
         }
      ...
      {
         return new Vector3d(0 * var_395,0 * var_396,0 * var_398);
      }
      ...
      {
         return scale == const_763;
      }
      
      public function get scale() : Number
      {
         return var_147 / Math.sqrt(0.5);
      }
      ...
      private function getDisplacenent(param1:IVector3d) : IVector3d
      {
         ...
         if(var_397 != null)
         {
            ...
            return var_397.getValue(_loc2_);
         }
         return null;
      }
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc5_:Number = param1.x / var_147;
         var _loc6_:Number = -param1.y / var_147;
         var _loc7_:IVector3d = Vector3d.sum(Vector3d.product(var_83,_loc5_),Vector3d.product(_y,_loc6_));
         var _loc8_:Vector3d = new Vector3d(0 * var_395,0 * var_396,0 * var_398);
         var _loc9_:IVector3d = Vector3d.sum(_loc8_,_loc7_);
         var _loc10_:IVector3d = var_84;
         var _loc11_:Vector3d = new Vector3d(param2.x * var_395,param2.y * var_396,param2.z * var_398);
         var _loc12_:Vector3d = new Vector3d(param3.x * var_395,param3.y * var_396,param3.z * var_398);
         var _loc13_:Vector3d = new Vector3d(param4.x * var_395,param4.y * var_396,param4.z * var_398);
