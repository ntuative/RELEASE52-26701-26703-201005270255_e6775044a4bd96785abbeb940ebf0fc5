package com.sulake.room
{
   ...
   public class RoomManager extends Component implements IRoomManager, IRoomInstanceContainer
   {
      ...
      private var var_517:IRoomObjectFactory = null;
      
      private var var_1081:int;
      
      private var var_2418:IRoomContentLoader;
      ...
      public function RoomManager(param1:IContext, param2:uint = 0)
      {
         ...
         var_518 = [];
         var_486 = [];
         _events.addEventListener(RoomContentLoadedEvent.const_348,onContentLoaded);
         _events.addEventListener(RoomContentLoadedEvent.const_436,onContentLoaded);
      ...
      public function createRoomObject(param1:String, param2:int, param3:String, param4:int) : IRoomObject
      {
         ...
         var _loc19_:IRoomObjectEventHandler = var_517.createRoomObjectLogic(_loc11_);
      ...
      private function objectFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_517 = param2 as IRoomObjectFactory;
      ...
      {
         var _loc4_:* = null;
         var _loc2_:int = var_486.indexOf(param1);
         if(_loc2_ < 0)
         {
            return;
         }
      ...
      public function createRoomObjectManager() : IRoomObjectManager
      {
         if(var_517 != null)
         {
            return var_517.createRoomObjectManager();
         }
         return null;
      }
      ...
      private function processInitialContentLoad(param1:String) : void
      {
         ...
         if(var_46.getGraphicAssetCollection(param1) != null)
         {
            _loc2_ = var_518.indexOf(param1);
            if(_loc2_ >= 0)
            {
               var_518.splice(_loc2_,1);
            }
            if(false)
            {
                        ...
                        if(_loc16_ == param1)
                        {
                           ...
                           if(_loc19_ != null)
                           {
                              ...
                              else
                              {
                                 ...
                                 _loc20_ = var_517.createRoomObjectLogic(_loc18_);
