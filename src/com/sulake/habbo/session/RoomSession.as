package com.sulake.habbo.session
{
   ...
   public class RoomSession implements IRoomSession
   {
      ...
      {
         if(var_35 == RoomSessionEvent.const_344 && _connection != null)
         {
            var_35 = RoomSessionEvent.const_103;
            if(isPrivateRoom)
            {
      ...
      {
         return var_1093 as IUserDataManager;
      }
