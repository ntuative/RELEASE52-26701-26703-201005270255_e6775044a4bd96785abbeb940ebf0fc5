package com.sulake.habbo.room
{
   ...
   public class RoomMessageHandler
   {
      ...
      private var var_1012:int = -1.0E9;
      
      private var var_1196:Boolean = true;
      ...
      private function onUserUpdate(param1:IMessageEvent) : void
      {
         ...
         var _loc7_:Number = _loc6_.getNumber(RoomVariableEnum.const_538);
         var _loc8_:int = 0;
            ...
            if(_loc2_.avatar != null)
            {
               ...
               switch(_loc9_.moveType)
               {
                  case SlideObjectMessageData.const_935:
                     _loc10_ = "mv";
                     break;
                  case SlideObjectMessageData.const_869:
                     _loc10_ = "std";
               }
