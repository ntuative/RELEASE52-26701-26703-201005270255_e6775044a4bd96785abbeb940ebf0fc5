package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualization extends RoomObjectSpriteVisualization
   {
      ...
      protected static const const_1450:Number = Math.sqrt(0.5);
       
      
      protected var _direction:int;
      
      protected var var_2321:int = -1;
      ...
      protected var var_1607:String = null;
      ...
      private var var_2231:Number = 0.0;
      ...
      protected var var_2308:Number = NaN;
      ...
      protected function getSpriteAssetName(param1:int, param2:Number) : String
      {
         ...
         if(_loc3_ == null || _loc3_.length == 0)
         {
            ...
            var_644[param1] = _loc3_;
            var_645[param1] = _loc4_;
         }
         if(_loc4_)
         {
      ...
      protected function updateSprites(param1:int, param2:Number) : void
      {
         ...
         var _loc4_:Boolean = false;
         if(var_1607 != null && var_1607.indexOf("http") == 0)
         {
            _loc4_ = true;
         }
            ...
            if(_loc7_ != null)
            {
               ...
               if(_loc8_ != null && _loc8_.asset != null)
               {
                  ...
                  if(_loc5_ < spriteCount - 1)
                  {
                     ...
                     _loc7_.color = getSpriteColor(_loc5_,var_2321,param1);
      ...
      {
         var _loc3_:int = 0;
         if(var_2230 != param1 || var_2231 != param2)
         {
            _loc3_ = spriteCount - 1;
            while(_loc3_ >= 0)
            {
               var_644[_loc3_] = "";
               var_645[_loc3_] = false;
               _loc3_--;
            }
            var_2230 = param1;
            var_2231 = param2;
      ...
      {
         var _loc3_:int = 0;
         if(var_2232 != param1 || var_2229 != param2)
         {
            _loc3_ = spriteCount - 1;
            while(_loc3_ >= 0)
            {
      ...
      protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            var_2321 = _loc3_.getNumber(RoomObjectVariableEnum.const_231);
            ...
            var_1607 = _loc3_.getString(RoomObjectVariableEnum.const_355);
      ...
      protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(var_290 != _loc3_.getUpdateID() || param1 != var_216 || param2 != var_2308)
         {
