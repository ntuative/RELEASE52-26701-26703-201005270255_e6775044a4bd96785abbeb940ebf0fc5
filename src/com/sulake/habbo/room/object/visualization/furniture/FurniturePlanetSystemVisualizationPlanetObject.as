package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePlanetSystemVisualizationPlanetObject
   {
      ...
      {
         var_692 = new Vector3d(0,0,0);
         _children = new Array();
         super();
         _name = param1;
         _index = param2;
         var_1291 = param3;
         var_1747 = param4 * 0 * 2 / 360;
         var_1451 = param5 * 0 * 2 / 360;
         _height = param6;
         var_825 = 0;
      }
      ...
      {
         var _loc3_:Number = var_1291 * Math.cos(var_825 + var_1451);
         var _loc4_:Number = var_1291 * Math.sin(var_825 + var_1451);
         var _loc5_:Number = _height;
         var_692.x = (_loc3_ - _loc4_) * (param2 / 2);
         var_692.y = (_loc4_ + _loc3_) * (param2 / 2) * 0.5 - _height * (param2 / 2);
         var_692.z = -int(4 * (_loc3_ + _loc4_) - 0.7);
         if(param1 != null)
         {
            var_692.add(param1);
         }
