package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePartyBeamerVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_820:int = 15;
      
      private static const const_1167:int = 2;
      
      private static const const_367:int = 2;
      
      private static const const_821:int = 31;
      
      private static const const_1168:int = 1;
      ...
      private function getNewPoint(param1:int, param2:Number) : Point
      {
         ...
         var_1118[param1] = _loc3_;
         if(int(_loc9_) == 0)
         {
            var_1115[param1] = getRandomAmplitudeFactor();
         }
      ...
      private function initItems(param1:Number) : void
      {
         ...
         var_1118 = new Array();
         var_1118.push(Math.random() * _loc2_ * 1.5);
         var_1118.push(Math.random() * _loc2_ * 1.5);
         var_1116 = new Array();
         var_1116.push(1);
         var_1116.push(-1);
         var_1117 = new Array();
         var_1117.push(const_1167);
         var_1117.push(const_1168);
         var_1115 = new Array();
         var_1115.push(getRandomAmplitudeFactor());
         var_1115.push(getRandomAmplitudeFactor());
      }
