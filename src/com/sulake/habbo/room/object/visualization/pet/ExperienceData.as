package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class ExperienceData
   {
      ...
      private var var_796:BitmapDataAsset;
      ...
      {
         super();
         var_796 = param1.getAvatarRendererAsset("pet_experience_bubble_png") as BitmapDataAsset;
      }
      ...
      public function setExperience(param1:int) : void
      {
         ...
         _image = (var_796.content as BitmapData).clone();
