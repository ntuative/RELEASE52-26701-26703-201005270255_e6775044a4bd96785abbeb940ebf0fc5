package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomPlane
   {
      ...
      private var var_721:IPlaneRasterizer = null;
      ...
      private var var_604:PlaneMaskManager = null;
      ...
      public function RoomPlane(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:int, param6:Boolean, param7:Array, param8:int, param9:Number = 0, param10:Number = 0, param11:Number = 0, param12:Number = 0)
      {
         ...
         var_866.assign(param1);
         var_74 = new Vector3d();
         var_74.assign(param2);
         var_289 = new Vector3d();
         var_289.assign(param3);
         var_288 = new Vector3d();
         var_288.assign(param4);
      ...
      private function draw(param1:BitmapData, param2:Matrix) : void
      {
         ...
         if(_bitmapData != null)
         {
            if(param2.a == 1 && param2.d == 1 && param2.c == 0 && param2.b != 0 && Math.abs(param2.b) <= 1 && (_type == const_111 || _type == const_91))
            {
               _loc3_ = 0;
               _loc4_ = 0;
               _loc5_ = 0;
      ...
      private function updateMask(param1:BitmapData, param2:IRoomGeometry) : void
      {
         ...
         var _loc13_:int = 0;
         var _loc14_:int = 0;
         if(!var_865 || false && false && !var_154 || var_604 == null)
         {
            return;
         }
         ...
         if(var_154)
         {
            ...
            _loc9_ = param2.getCoordinatePosition(var_489);
            _loc10_ = 0;
            _loc11_ = 0;
            _loc5_ = 0;
            while(_loc5_ < var_195.length)
            {
               ...
               if(_loc3_ != null)
               {
                  ...
                  _loc12_ = _loc3_.type;
                  var_604.updateMask(var_62,_loc12_,param2.scale,_loc9_,_loc10_,_loc11_);
                  var_723.push(new RoomPlaneBitmapMask(_loc12_,_loc3_.leftSideLoc,_loc3_.rightSideLoc));
               }
               _loc5_++;
            }
            _loc6_ = 0;
            while(_loc6_ < var_260.length)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  var_1041.push(new RoomPlaneRectangleMask(_loc4_.leftSideLength,_loc4_.rightSideLoc,_loc4_.leftSideLength,_loc4_.rightSideLength));
               }
               _loc6_++;
            }
            var_154 = false;
      ...
      private function getTextureIdentifier(param1:Number) : String
      {
         if(var_721 != null)
         {
            return var_721.getTextureIdentifier(param1,normal);
         }
      ...
      private function renderTexture(param1:IRoomGeometry, param2:BitmapData) : void
      {
         ...
         if(_type == const_111 || _type == const_91)
         {
      ...
      private function updateMaskChangeStatus() : void
      {
         ...
         if(true)
         {
            while(_loc1_ < var_195.length)
            {
               ...
               {
                  _loc6_ = false;
                  while(_loc2_ < var_723.length)
                  {
                     _loc7_ = var_723[_loc2_] as RoomPlaneBitmapMask;
                     if(_loc7_ != null)
                     {
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         if(_loc3_)
         {
            ...
            _loc5_ = 0;
            while(_loc5_ < var_1251.length)
            {
               _loc4_ = Number(Vector3d.cosAngle(param1.directionAxis,var_1251[_loc5_]));
               if(_loc4_ > -0.001)
               {
                  if(_isVisible)
                  {
      ...
      private function needsNewTexture(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         updateMaskChangeStatus();
         if(var_722 && (_loc3_ == null || _loc3_.timeStamp >= 0 && param2 > _loc3_.timeStamp || var_154))
         {
            return true;
         }
         return false;
      ...
      private function getTexture(param1:IRoomGeometry, param2:int) : BitmapData
      {
         ...
         if(needsNewTexture(param1,param2))
         {
            ...
            if(var_721 != null)
            {
               _loc3_ = var_721.render(_loc8_,_id,_loc5_,_loc6_,param1.scale,_loc7_,var_1504,var_1876,var_1872,var_1875,var_1877,param2);
               if(_loc3_ != null)
               {
