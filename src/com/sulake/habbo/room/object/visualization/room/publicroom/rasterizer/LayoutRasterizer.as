package com.sulake.habbo.room.object.visualization.room.publicroom.rasterizer
{
   ...
   public class LayoutRasterizer
   {
      ...
      private var var_1112:Point = null;
      ...
      private var var_871:IGraphicAssetCollection;
      ...
      {
         var_544 = true;
         var _loc3_:int = var_379.indexOf(param1);
         if(_loc3_ < 0)
         {
            var_379.push(param1);
            var_545.push(param2);
      ...
      public function initializeAds(param1:int, param2:IRoomObjectSpriteVisualization) : void
      {
         ...
         var _loc11_:* = null;
         var_1114 = param1;
         var _loc3_:LayoutRasterizerData = var_40.getValue(var_785);
         if(_loc3_ == null)
         {
            return;
         }
                  ...
                  if(_loc9_ != null)
                  {
                     if(_loc7_.@id.toString().length > 0)
                     {
                        ...
                        if(_loc10_ == "billboard_bg")
                        {
                           ...
                           {
                              var_1390 = RoomObjectVariableEnum.const_879;
                           }
                           if(_loc11_.indexOf("right") > -1)
                           {
                              var_1390 = RoomObjectVariableEnum.const_946;
                           }
                           if(param2 != null)
                           {
      ...
      public function showAd(param1:IRoomObjectSpriteVisualization, param2:String = "", param3:Boolean = false) : void
      {
         ...
         {
            exchangeElementGraphics("billboard_img",var_1390);
         }
      ...
      public function initializeGeometry(param1:IRoomGeometry) : void
      {
         ...
         var _loc3_:Point = param1.getScreenPoint(var_2264);
         _loc3_.x -= _loc2_.x;
         _loc3_.y -= _loc2_.y;
      ...
      public function set layout(param1:String) : void
      {
         if(param1 != var_785)
         {
            ...
            _adBgIndex = -1;
            _adImgIndex = -1;
            var_1113 = var_40.getValue(var_785);
         }
      }
      ...
      {
         var _loc1_:LayoutRasterizerData = var_40.getValue(var_785);
         if(_loc1_ == null)
         {
            return 0;
         }
      ...
      public function setElementToSprite(param1:int, param2:IRoomObjectSprite, param3:String = "", param4:Boolean = false) : void
      {
         ...
         var _loc9_:IGraphicAsset = var_871.getAsset(_loc8_.@asset);
         ...
         param2.offsetX = int(_loc8_.@x) + _loc9_.offsetX + var_1112.x;
         param2.offsetY = int(_loc8_.@y) + _loc9_.offsetY + var_1112.y;
         ...
         if(_loc6_.@id.toString().length > 0)
         {
            ...
            if(var_379.indexOf(_loc10_) >= 0 && var_544)
            {
               param1 = var_379.indexOf(_loc10_);
               if(true)
               {
                  _loc9_ = var_871.getAsset(var_545[param1]);
                  if(_loc9_ != null && _loc9_.asset != null)
                  {
                     param2.asset = _loc9_.asset.content as BitmapData;
                  }
               ...
               if(true)
               {
                  param2.alpha = var_546[param1];
               }
               var_379.splice(param1,1);
               var_545.splice(param1,1);
               var_546.splice(param1,1);
               if(false)
               {
                  var_544 = false;
               }
