package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      private static const const_809:int = 16777215;
      
      public static const const_1204:int = 10066329;
      
      private static const const_811:int = 13421772;
      
      public static const const_1402:int = 16777215;
      
      public static const const_1277:int = 16777215;
      
      private static const const_810:int = 10066329;
      
      private static const const_808:int = 10066329;
      
      public static const const_1356:int = 13421772;
      ...
      private var var_2063:int = -1000;
      
      private var var_1096:uint = 16777215;
      
      private var var_1586:Boolean = true;
      ...
      private var var_631:Rectangle = null;
      ...
      private var var_2160:String = null;
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_891);
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_916);
         var _loc7_:int = 0;
         while(_loc7_ < var_88.planeCount)
         {
            _loc8_ = var_88.method_6(_loc7_);
            ...
            else if(_loc12_ == RoomPlaneData.const_1378)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_111,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      private function updateMasksAndColors(param1:IRoomObjectModel) : Boolean
      {
         ...
         {
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_1049);
            if(_loc3_ != var_2160)
            {
            ...
            _loc4_ = uint(param1.getNumber(RoomObjectVariableEnum.const_732));
            if(_loc4_ != var_1096)
            {
               var_1096 = _loc4_;
               var_2155 = var_1096 & 255;
               var_2154 = var_1096 >> 8 & 255;
               var_2156 = var_1096 >> 16 & 255;
               _loc2_ = true;
            }
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_1051));
            if(_loc5_ != var_1586)
            {
               var_1586 = _loc5_;
               _loc2_ = true;
      ...
      override public function get boundingRectangle() : Rectangle
      {
         if(var_631 == null)
         {
            var_631 = super.boundingRectangle;
         }
         return new Rectangle(var_631.x,var_631.y,var_631.width,var_631.height);
      }
      ...
      protected function updatePlaneMasks(param1:String) : void
      {
         ...
         var _loc8_:int = 0;
         while(_loc8_ < var_439.maskCount)
         {
            _loc10_ = var_439.getMaskType(_loc8_);
            _loc11_ = var_439.method_8(_loc8_);
            _loc12_ = var_439.getMaskCategory(_loc8_);
            if(_loc11_ != null)
            {
               _loc13_ = 0;
               while(_loc13_ < var_106.length)
               {
                  ...
                  if(_loc3_.type == RoomPlane.const_111 || _loc3_.type == RoomPlane.const_91)
                  {
                     if(_loc3_ != null && _loc3_.location != null && _loc3_.normal != null)
                     {
                        ...
                        if(_loc15_ < 0.01)
                        {
                           if(_loc3_.leftSide != null && _loc3_.rightSide != null)
                           {
                              ...
                              if(_loc3_.type == RoomPlane.const_111 || _loc3_.type == RoomPlane.const_91 && _loc12_ == RoomPlaneBitmapMaskData.const_211)
                              {
               ...
               if(_loc11_ != null)
               {
                  if(_loc11_.update(param1,_loc5_))
                  {
                     if(_loc11_.visible)
                     {
                        ...
                        if(_loc11_.type != RoomPlane.const_198)
                        {
      ...
      override public function update(param1:IRoomGeometry = null, param2:int = 0) : void
      {
         ...
         if(_loc7_ < var_2063 + const_1735 && !_loc4_ && !_loc6_)
         {
            return;
         }
         ...
         while(_loc8_ < var_208.length)
         {
            ...
            if(_loc10_ != null && _loc11_ != null && _loc11_.type != RoomPlane.const_91)
            {
               if(var_1586)
               {
                  ...
                  _loc13_ = uint((_loc12_ & 255) * var_2155 / 255);
                  _loc14_ = uint((_loc12_ >> 8 & 255) * var_2154 / 255);
                  _loc15_ = uint((_loc12_ >> 16 & 255) * var_2156 / 255);
      ...
      private function updateGeometry(param1:IRoomGeometry) : Boolean
      {
         ...
         if(param1.updateId != var_1401)
         {
            ...
            if(_loc3_ != null && (_loc3_.x != var_1125 || _loc3_.y != var_2157 || _loc3_.z != var_2158 || param1.scale != var_2159))
            {
               var_1125 = _loc3_.x;
               var_2157 = _loc3_.y;
               var_2158 = _loc3_.z;
      ...
      private function updatePlaneTexturesAndVisibilities(param1:IRoomObjectModel) : void
      {
         ...
         if(var_168 != param1.getUpdateID())
         {
            _loc2_ = param1.getString(RoomObjectVariableEnum.const_560);
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_524);
            _loc4_ = param1.getString(RoomObjectVariableEnum.const_697);
            updatePlaneTextureTypes(_loc3_,_loc2_,_loc4_);
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_667));
            _loc6_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_612));
            _loc7_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_942));
      ...
      private function updateSprite(param1:IRoomObjectSprite, param2:RoomPlane, param3:String, param4:Number) : void
      {
         ...
         param1.assetName = param3 + "_" + var_1477;
      }
