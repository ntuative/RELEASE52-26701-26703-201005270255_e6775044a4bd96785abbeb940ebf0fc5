package com.sulake.habbo.room.object.visualization.room.utils
{
   public class Randomizer
   {
      ...
      public static const const_1486:int = 16777216;
      
      public static const const_1624:int = 1;
       
      
      private var var_2383:int = 69069;
      
      private var var_1160:int = 1;
      
      private var var_2384:int = 5;
      
      private var var_1433:int = 16777216;
      ...
      private function iterateScaled(param1:int, param2:int) : int
      {
         ...
         return int(param1 + _loc3_ / var_1433 * param2);
      }
      ...
      {
         var _loc1_:int = var_2383 * var_1160 + var_2384;
         if(_loc1_ < 0)
         {
            _loc1_ = -_loc1_;
         }
