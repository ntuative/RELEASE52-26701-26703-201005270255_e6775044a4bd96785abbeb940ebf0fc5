package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1473:int = 1500;
      
      private var var_1472:int = 255;
      
      private var var_1474:int = 255;
      
      private var var_1210:uint = 16777215;
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_891,param1.toString(),true);
            _loc2_.setNumber(RoomObjectVariableEnum.const_732,16777215);
            _loc2_.setNumber(RoomObjectVariableEnum.const_667,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_612,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_942,1);
         }
      }
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         param2.setNumber(RoomObjectVariableEnum.const_1051,int(param1.bgOnly));
         var_1210 = _color;
         var_1472 = var_1348;
         var_1015 = _loc3_;
         var_1474 = _loc4_;
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_837:
               param2.setNumber(RoomObjectVariableEnum.const_667,_loc3_);
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_960:
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_415:
               _loc5_ = "null";
               if(param1.maskCategory == RoomObjectRoomMaskUpdateMessage.const_211)
               {
                  _loc5_ = "null";
               }
               var_439.addMask(param1.maskId,param1.maskType,param1.maskLocation,_loc5_);
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_535:
               _loc4_ = var_439.removeMask(param1.maskId);
         }
         if(_loc4_)
         {
            _loc6_ = var_439.getXML();
            _loc7_ = _loc6_.toXMLString();
            param2.setString(RoomObjectVariableEnum.const_1049,_loc7_);
         }
      }
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_579:
               param2.setString(RoomObjectVariableEnum.const_524,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_715:
               param2.setString(RoomObjectVariableEnum.const_560,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_572:
               param2.setString(RoomObjectVariableEnum.const_697,param1.value);
         }
      }
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(var_842)
         {
            ...
            {
               _loc7_ = var_1210 >> 16 & 255;
               _loc8_ = var_1210 >> 8 & 255;
               _loc9_ = var_1210 & 255;
               _loc10_ = var_1015 >> 16 & 255;
               _loc11_ = var_1015 >> 8 & 255;
               _loc12_ = var_1015 & 255;
               _loc13_ = (_loc2_ - var_842) / var_1473;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = var_1472 + (var_1474 - var_1472) * _loc13_;
               _color = _loc3_;
               var_1348 = _loc4_;
            }
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_732,_loc3_);
         }
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         _loc5_--;
         var _loc7_:* = null;
         var _loc8_:IVector3d = var_88.method_6(_loc5_);
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1237,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1298,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1178,_loc22_);
            ...
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc13_ == RoomPlaneData.const_146 || _loc13_ == RoomPlaneData.const_289)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {
