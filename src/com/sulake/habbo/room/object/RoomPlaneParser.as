package com.sulake.habbo.room.object
{
   ...
   public class RoomPlaneParser
   {
      ...
      private var var_685:Number = 0.0;
      ...
      public function getPlaneType(param1:int) : int
      {
         ...
         {
            return RoomPlaneData.const_953;
         }
      ...
      private function addWall(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:Boolean, param6:Boolean, param7:Boolean) : void
      {
         ...
         var _loc10_:Vector3d = Vector3d.product(_loc9_,1 / _loc9_.length * -var_913);
         ...
         if(param6)
         {
            ...
            if(param7)
            {
               _loc11_ = Vector3d.product(param2,var_913 / param2.length);
      ...
      public function initializeFromTileData(param1:Boolean = false) : Boolean
      {
         ...
         var_685 = getFloorHeight(var_105);
         if(!param1)
         {
            createWallPlanes();
         }
      ...
      {
         var _loc12_:RoomPlaneData = addPlane(RoomPlaneData.const_179,param1,param2,param3);
         ...
         if(_loc12_)
         {
            ...
            if(param6)
            {
               ...
               _loc14_ = addPlane(RoomPlaneData.const_179,_loc13_,new Vector3d(0,0,-_floorThickness),param2);
               if(_loc14_ != null)
               {
                  if(param8 > 0)
                  {
            ...
            if(param7)
            {
               ...
               _loc14_ = addPlane(RoomPlaneData.const_179,_loc13_,new Vector3d(0,0,-_floorThickness),Vector3d.product(param2,-1));
               if(_loc14_ != null)
               {
                  if(param9 > 0)
                  {
            ...
            if(param4)
            {
               ...
               _loc15_ = addPlane(RoomPlaneData.const_179,_loc13_,new Vector3d(0,0,-_floorThickness),Vector3d.product(param3,-1));
               if(_loc15_ != null)
               {
                  if(param11 > 0)
                  {
            ...
            if(param5)
            {
               ...
               _loc15_ = addPlane(RoomPlaneData.const_179,_loc13_,new Vector3d(0,0,-_floorThickness),param3);
               if(_loc15_ != null)
               {
                  if(param10 > 0)
                  {
      ...
      public function method_6(param1:int) : IVector3d
      {
         if(param1 < 0 || param1 >= planeCount)
         {
            return null;
