package com.sulake.habbo.room
{
   ...
   public class RoomEngine extends Component implements IRoomEngine, IRoomManagerListener, IRoomCreator, IRoomEngineServices, IUpdateReceiver
   {
      ...
      private static const const_512:String = "room";
      
      private static const const_800:int = -2;
      
      private static const const_513:String = "temporary_room";
      
      private static const const_294:String = "object_icon_sprite";
      
      private static const const_801:int = -3;
      
      private static const const_799:String = "overlay";
      
      private static const OBJECT_TYPE_SELECTION_ARROW:String = "selection_arrow";
      
      private static const const_1134:String = "tile_cursor";
      
      private static const const_295:int = -1;
      ...
      public function deleteRoomObject(param1:int, param2:int) : Boolean
      {
         if(var_67 != null)
         {
            ...
            {
               return var_67.deleteWallItem(var_115,var_114,param1);
            }
         }
         return false;
      }
      ...
      private function updateRoomCameras(param1:uint) : void
      {
         ...
         var _loc49_:* = null;
         var _loc2_:int = 0;
         for(; _loc2_ < var_320.length; _loc2_++)
         {
            _loc3_ = var_320.getWithIndex(_loc2_) as RoomInstanceData;
            _loc4_ = null;
            _loc5_ = 0;
            _loc6_ = 0;
            if(_loc3_ != null)
               ...
               if(_loc8_ != null)
               {
                  ...
                  if(_loc11_ != null)
                  {
                     ...
                     if(_loc14_ != null)
                     {
                        ...
                        if(_loc15_ != null)
                        {
                           _loc16_ = _loc15_.getNumber(RoomVariableEnum.const_640) - 0.5;
                           _loc17_ = _loc15_.getNumber(RoomVariableEnum.const_614) - 0.5;
      ...
      public function modifyRoomObjectData(param1:int, param2:int, param3:String) : Boolean
      {
         if(var_67 != null)
         {
            if(param2 == RoomObjectCategoryEnum.const_32)
            {
               return var_67.modifyWallItemData(var_115,var_114,param1,param3);
            }
         }
         return false;
      }
      ...
      override public function dispose() : void
      {
         ...
         if(var_320 != null)
         {
            ...
            {
               _loc2_ = var_320.getWithIndex(_loc1_) as RoomInstanceData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function createRoomCanvas(param1:int, param2:int, param3:int, param4:int, param5:int, param6:int) : DisplayObject
      {
         ...
         _loc9_.roomObjectVariableAccurateZ = RoomObjectVariableEnum.const_941;
         ...
         if(_loc10_.geometry != null)
         {
            ...
            _loc10_.geometry.z_scale = _loc8_.getNumber(RoomVariableEnum.const_538);
         }
         if(_loc10_.geometry != null)
         {
            _loc13_ = _loc8_.getNumber(RoomObjectVariableEnum.const_674);
            _loc14_ = _loc8_.getNumber(RoomObjectVariableEnum.const_610);
            _loc15_ = _loc8_.getNumber(RoomObjectVariableEnum.const_980);
            _loc16_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1022);
      ...
      public function updateObjectRoomWindow(param1:int, param2:int, param3:int, param4:Boolean = true) : void
      {
         ...
         if(_loc7_ != null)
         {
            ...
            {
               if(_loc7_.getModel().getNumber(RoomObjectVariableEnum.const_930) > 0)
               {
                  _loc9_ = _loc7_.getModel().getString(RoomObjectVariableEnum.const_892);
                  _loc10_ = _loc7_.getLocation();
                  if(param4)
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_415,_loc5_,_loc9_,_loc10_);
                  }
                  else
                  {
      ...
      private function disposeObject(param1:String, param2:int, param3:int) : void
      {
         ...
         if(_loc4_.disposeObject(param2,param3))
         {
            if(events != null)
            {
               events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.ROOM_OBJECT_REMOVED,var_115,var_114,param2,param3));
            }
         }
      }
      ...
      public function modifyRoomObject(param1:int, param2:int, param3:String) : Boolean
      {
         if(var_67 != null)
         {
            return var_67.modifyRoomObject(var_115,var_114,param1,param2,param3);
         }
         return false;
      }
      ...
      public function updateObjectRoom(param1:int, param2:int, param3:String = null, param4:String = null, param5:String = null) : Boolean
      {
         ...
         if(_loc6_ == null)
         {
            ...
            _loc9_ = var_321.getValue(_loc8_);
            if(_loc9_ == null)
            {
               _loc9_ = new RoomData(param1,param2,null);
               var_321.add(_loc8_,_loc9_);
            }
            if(param3 != null)
            {
         ...
         if(param3 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_579,param3);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         if(param4 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_715,param4);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         if(param5 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_572,param5);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         return true;
      }
      ...
      private function onRoomManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(var_43 != null)
         {
            ...
            var_43.addObjectUpdateCategory(RoomObjectCategoryEnum.const_38);
            var_43.addObjectUpdateCategory(RoomObjectCategoryEnum.const_279);
            var_43.addObjectUpdateCategory(RoomObjectCategoryEnum.const_67);
      ...
      private function roomObjectEventHandler(param1:RoomObjectEvent) : void
      {
         if(var_67 != null)
         {
            var_67.handleRoomObjectEvent(param1,var_115,var_114);
         }
      }
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_12.sessionDataManager = var_368;
      }
      ...
      public function addObjectFurniture(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String, param9:Number = NaN, param10:int = -1) : Boolean
      {
         ...
         if(_loc14_ != null && _loc14_.getModelController() != null)
         {
            ...
            _loc14_.getModelController().setString(RoomObjectVariableEnum.const_355,_loc13_,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_923,1,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_902,param10);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_829,getTimer());
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_253,param1,param2,param3,RoomObjectCategoryEnum.const_34));
         }
      ...
      public function initializeRoom(param1:int, param2:int, param3:XML) : void
      {
         ...
         events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_744,param1,param2));
      }
      
      private function initializeRoomManager() : void
      {
         if(var_26 == null || var_428 == null || var_43 == null || var_748 == null || _communication == null || _habboConfiguration == null || !var_2022)
         {
            return;
         }
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_295,RoomObjectCategoryEnum.const_67);
      }
      ...
      public function updateObjectRoomColor(param1:int, param2:int, param3:uint, param4:int, param5:Boolean) : Boolean
      {
         ...
         var _loc7_:* = null;
         _loc7_ = new RoomObjectRoomColorUpdateMessage(RoomObjectRoomColorUpdateMessage.const_1254,param3,param4,param5);
         _loc6_.getEventHandler().processUpdateMessage(_loc7_);
      ...
      public function update(param1:uint) : void
      {
         ...
         var _loc2_:IRoomInstance = var_43.getRoom(getRoomIdentifier(var_115,var_114));
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_801,RoomObjectCategoryEnum.const_279);
      }
      ...
      public function setObjectMoverIconSpriteVisible(param1:Boolean) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc2_:IRoomRenderingCanvas = getRoomCanvas(var_115,var_114,var_1317);
         if(_loc2_ != null)
         {
      ...
      {
         var _loc2_:* = null;
         var _loc1_:IRoomRenderingCanvas = getRoomCanvas(var_115,var_114,var_1317);
         if(_loc1_ != null)
         {
      ...
      private function onVisualizationFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(var_12 != null)
         {
            var_12.visualizationFactory = var_428;
         }
         initializeRoomManager();
      }
      ...
      private function initializeObjectEvents() : void
      {
         if(var_26 != null)
         {
            if(false)
            {
               var_26.events.addEventListener(RoomObjectMouseEvent.const_215,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectMouseEvent.const_482,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectMouseEvent.const_432,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectStateChangeEvent.const_175,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectStateChangeEvent.const_533,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectWidgetRequestEvent.const_144,roomObjectEventHandler);
               ...
               var_26.events.addEventListener(RoomObjectWidgetRequestEvent.const_102,roomObjectEventHandler);
               ...
               var_26.events.addEventListener(RoomObjectFurnitureActionEvent.const_393,roomObjectEventHandler);
               ...
               var_26.events.addEventListener(RoomObjectFurnitureActionEvent.const_480,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectFurnitureActionEvent.const_409,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectFurnitureActionEvent.const_484,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectFurnitureActionEvent.const_421,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectFurnitureActionEvent.ROOM_OBJECT_JUKEBOX_DISPOSE,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectDimmerStateUpdateEvent.const_60,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectMoveEvent.const_493,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectMoveEvent.const_377,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectRoomAdEvent.const_272,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectRoomAdEvent.const_386,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectRoomAdEvent.const_339,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectRoomAdEvent.const_308,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectRoomActionEvent.const_490,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectRoomActionEvent.const_881,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectRoomActionEvent.const_479,roomObjectEventHandler);
      ...
      public function initializeRoomObjectInsert(param1:int, param2:int, param3:int, param4:String = null) : Boolean
      {
         ...
         if(_loc5_ == null || _loc5_.getNumber(RoomVariableEnum.const_597) != 0)
         {
            return false;
         }
         if(var_67 != null)
         {
            return var_67.initializeRoomObjectInsert(var_115,var_114,param1,param2,param3,param4);
         }
         return false;
      }
      ...
      public function roomManagerInitialized(param1:Boolean = true) : void
      {
         ...
         {
            var_510 = true;
            events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_617,0,0));
            _loc2_ = 0;
            while(_loc2_ < var_321.length)
            {
               _loc3_ = var_321.getWithIndex(_loc2_) as RoomData;
               if(_loc3_ != null)
               {
      ...
      public function addObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:Number, param7:int, param8:String = null) : Boolean
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_253,param1,param2,param3,RoomObjectCategoryEnum.const_38));
         }
         return true;
      }
      ...
      public function updateObjectRoomVisibilities(param1:int, param2:int, param3:Boolean, param4:Boolean = true) : Boolean
      {
         ...
         var _loc6_:* = null;
         _loc6_ = new RoomObjectRoomPlaneVisibilityUpdateMessage(RoomObjectRoomPlaneVisibilityUpdateMessage.const_960,param3);
         _loc5_.getEventHandler().processUpdateMessage(_loc6_);
         _loc6_ = new RoomObjectRoomPlaneVisibilityUpdateMessage(RoomObjectRoomPlaneVisibilityUpdateMessage.const_837,param4);
         _loc5_.getEventHandler().processUpdateMessage(_loc6_);
         return true;
      }
            ...
            if(_loc14_ != null && _loc14_.getModel() != null)
            {
               ...
               switch(param4)
               {
                  ...
                  case RoomObjectCategoryEnum.const_32:
                     ...
                     _loc11_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_385);
                     break;
      ...
      public function addObjectWallItem(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String) : Boolean
      {
         ...
         if(_loc12_ != null && _loc12_.getModelController() != null)
         {
            ...
            _loc12_.getModelController().setString(RoomObjectVariableEnum.const_355,_loc11_,true);
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_941,1,true);
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_253,param1,param2,param3,RoomObjectCategoryEnum.const_32));
         }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_280.events.addEventListener(AdEvent.const_471,showRoomAd);
      }
      ...
      private function getOverlaySprite(param1:IRoomRenderingCanvas) : Sprite
      {
         ...
         return _loc2_.getChildByName(const_799) as Sprite;
      }
      ...
      public function disposeRoom(param1:int, param2:int) : void
      {
         ...
         var _loc4_:RoomInstanceData = var_320.remove(_loc3_);
         if(_loc4_ != null)
         {
            _loc4_.dispose();
         }
      ...
      public function getGenericRoomObjectImage(param1:String, param2:String, param3:IVector3d, param4:int, param5:IGetImageListener, param6:String = null, param7:uint = 0, param8:String = null) : ImageResult
      {
         ...
         _loc9_.id = -1;
         if(!var_510 || param1 == null)
         {
            return _loc9_;
         }
         var _loc10_:IRoomInstance = var_43.getRoom(const_513);
         if(_loc10_ == null)
         {
            _loc10_ = var_43.createRoom(const_513,null);
            if(_loc10_ == null)
            {
               return _loc9_;
            }
         ...
         switch(_loc12_)
         {
            ...
            case RoomObjectCategoryEnum.const_32:
               ...
               _loc13_.getModelController().setString(RoomObjectVariableEnum.const_385,param8);
               break;
            case RoomObjectCategoryEnum.const_38:
            ...
            case RoomObjectCategoryEnum.const_67:
               if(param2 != null)
               {
                  ...
                  if(_loc17_.length >= 3)
                  {
                     ...
                     _loc21_.addPlane(RoomPlaneData.const_179,new Vector3d(0,0,0),new Vector3d(10,0,0),new Vector3d(0,10,0));
                     ...
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_524,_loc18_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_560,_loc19_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_697,_loc20_);
                     if(param6 != null)
                     {
                        _loc23_ = null;
                        _loc24_ = "undefined_" + _loc11_;
                        _loc23_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_415,_loc24_,param6,new Vector3d(2,0,1.75));
         ...
         {
            var_1070.add(String(_loc11_),param5);
            _loc13_.getModelController().setNumber(RoomObjectVariableEnum.const_924,param4,true);
         }
         else
         {
            _loc10_.disposeObject(_loc11_,_loc12_);
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_800,RoomObjectCategoryEnum.const_279);
      }
      ...
      public function handleRoomCanvasMouseEvent(param1:int, param2:int, param3:int, param4:String, param5:Boolean, param6:Boolean, param7:Boolean, param8:Boolean) : void
      {
         ...
         if(_loc9_ != null)
         {
            ...
            if(_loc11_ != null)
            {
               ...
               _loc11_.x = var_1555 - _loc12_.width / 2;
            ...
            if(!_loc9_.handleMouseEvent(param2,param3,param4,param5,param6,param7,param8))
            {
               ...
               if(param4 == MouseEvent.CLICK)
               {
                  if(events != null)
                  {
                     events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_407,var_115,var_114,-1,RoomObjectCategoryEnum.const_228));
                  }
                  _loc13_ = "null";
               }
               ...
               if(var_67 != null)
               {
                  _loc14_ = new RoomObjectMouseEvent(_loc13_,const_295,const_512);
                  var_67.handleRoomObjectEvent(_loc14_,var_115,var_114);
               }
            }
         }
      }
      ...
      public function setObjectMoverIconSprite(param1:int, param2:int, param3:Boolean, param4:String = null) : void
      {
         ...
         var _loc7_:IRoomRenderingCanvas = getRoomCanvas(var_115,var_114,var_1317);
         if(_loc7_ != null)
         {
            ...
            if(_loc11_ != null)
            {
               _loc11_.x = var_1555 - _loc6_.data.width / 2;
      ...
      private function showRoomAd(param1:AdEvent) : void
      {
         ...
         if(var_12 != null)
         {
            ...
            var_12.addGraphicAsset(var_12.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_297,param1.image,true);
            var_12.addGraphicAsset(var_12.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_879,param1.adWarningL,true);
            var_12.addGraphicAsset(var_12.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_946,param1.adWarningR,true);
            ...
            _loc4_ = null;
            _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_838,RoomObjectVariableEnum.const_297,param1.clickUrl);
      ...
      {
         var _loc3_:String = getRoomIdentifier(param1,param2);
         var _loc4_:RoomInstanceData = var_320.getValue(_loc3_) as RoomInstanceData;
         if(_loc4_ == null)
         {
            _loc4_ = new RoomInstanceData(param1,param2);
            var_320.add(_loc3_,_loc4_);
         }
         return _loc4_;
      }
      ...
      private function onHabboConfigurationInit(param1:Event) : void
      {
         if(var_12 != null)
         {
            _events.addEventListener(RoomContentLoader.const_708,onContentLoaderReady);
      ...
      public function cancelRoomObjectInsert() : void
      {
         if(var_67 != null)
         {
            var_67.cancelRoomObjectInsert(var_115,var_114);
         }
      }
      ...
      public function contentLoaded(param1:String, param2:Boolean = false) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:Number = NaN;
         var _loc3_:IRoomInstance = var_43.getRoom(const_513);
         if(_loc3_ == null)
         {
            return;
         }
         ...
         while(_loc8_ >= 0)
         {
            ...
            if(_loc9_ != null && _loc9_.getModel() != null && _loc9_.getType() == param1)
            {
               ...
               if(_loc12_ != null)
               {
                  _loc14_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_924);
               ...
               _loc13_ = var_1070.remove(String(_loc10_)) as IGetImageListener;
      ...
      {
         return getRoomObjectBoundingRectangle(var_115,var_114,const_295,RoomObjectCategoryEnum.const_67,param1);
      }
      ...
      private function createRoom(param1:String, param2:XML, param3:String, param4:String, param5:String, param6:String) : IRoomInstance
      {
         ...
         if(isPublicRoomWorldType(param6))
         {
            ...
            _loc9_ = _loc7_.createRoomObject(const_295,_loc12_,_loc8_) as IRoomObjectController;
            _loc9_.getModelController().setString(RoomObjectVariableEnum.const_969,param6,true);
            _loc7_.setNumber(RoomVariableEnum.const_597,1,true);
            _loc13_ = parseInt(_habboConfiguration.getKey("ads.billboard.displayDelayMillis","1000"));
            _loc9_.getModelController().setNumber(RoomVariableEnum.const_883,_loc13_,true);
            if(var_12 != null)
            {
         ...
         {
            _loc9_ = _loc7_.createRoomObject(const_295,const_512,_loc8_) as IRoomObjectController;
            _loc7_.setNumber(RoomVariableEnum.const_597,0,true);
         }
         _loc7_.setNumber(RoomVariableEnum.const_538,_loc10_,true);
         if(param2 != null)
         {
            _loc14_ = 0;
            if(param2.dimensions.length() == 1)
            {
               ...
               _loc7_.setNumber(RoomVariableEnum.const_640,_loc16_);
               _loc7_.setNumber(RoomVariableEnum.const_561,_loc17_);
               _loc7_.setNumber(RoomVariableEnum.const_614,_loc18_);
               ...
               {
                  _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_916,_loc14_,true);
               }
            }
         }
         if(_loc9_ != null && _loc9_.getEventHandler() != null)
         ...
         if(param3 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_579,param3);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param4 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_715,param4);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param5 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_572,param5);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param2 != null)
         {
            if(param2.doors.door.length() > 0)
            {
               ...
               while(_loc23_ < _loc20_.length())
               {
                  ...
                  if(XMLValidator.checkRequiredAttributes(_loc24_,_loc21_))
                  {
                     ...
                     _loc22_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_415,_loc30_,_loc29_,_loc31_,RoomObjectRoomMaskUpdateMessage.const_211);
                     ...
                     if(_loc28_ == 90 || _loc28_ == 180)
                     {
                        if(_loc28_ == 90)
                        {
                           ...
                           _loc7_.setNumber(RoomObjectVariableEnum.const_610,_loc26_,true);
                        }
                        if(_loc28_ == 180)
                        {
                           _loc7_.setNumber(RoomObjectVariableEnum.const_674,_loc25_,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_610,_loc26_ - 0.5,true);
                        }
                        _loc7_.setNumber(RoomObjectVariableEnum.const_980,_loc27_,true);
                        _loc7_.setNumber(RoomObjectVariableEnum.const_1022,_loc28_,true);
                     }
                  }
                  _loc23_++;
               }
         ...
         _loc7_.createRoomObject(const_800,const_1134,RoomObjectCategoryEnum.const_279);
         _loc7_.createRoomObject(const_801,OBJECT_TYPE_SELECTION_ARROW,RoomObjectCategoryEnum.const_279);
         return _loc7_;
      }
