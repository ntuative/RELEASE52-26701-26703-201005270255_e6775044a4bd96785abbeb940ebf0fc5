package com.sulake.habbo.moderation
{
   ...
   public class IssueManager
   {
      ...
      public static const const_971:String = "issue_bundle_open";
      
      public static const const_728:String = "issue_bundle_my";
      
      public static const const_835:String = "issue_bundle_picked";
      ...
      public function IssueManager(param1:ModerationManager)
      {
         ...
         var_142 = new Map();
         var_948 = new Map();
         var_643 = new IssueBrowser(this,var_61.windowManager,var_61.assets);
         var_780 = [];
         var_949 = [];
         var_1106 = new Map();
      }
      ...
      {
         var _loc2_:IssueHandler = var_1106.getValue(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.update();
         }
      ...
      public function pickBundle(param1:int) : void
      {
         ...
         var_780 = var_780.concat(_loc2_.getIssueIds());
      }
      ...
      public function updateIssue(param1:IssueMessageData) : void
      {
         ...
         var _loc2_:int = int(var_948.getValue(param1.issueId));
         if(_loc2_ != 0)
         {
            ...
            if(_loc3_ != null)
            {
               ...
               else
               {
                  ...
                  var_948.remove(param1.issueId);
                  _loc3_ = null;
               }
            }
         }
         if(param1.state == IssueMessageData.const_1188)
         {
            var_158.remove(param1.issueId);
            return;
         }
         if(_loc3_ == null)
         {
            for each(_loc4_ in var_142)
            {
               if(validateBundle(_loc4_,param1))
               {
                  _loc3_ = _loc4_;
                  _loc3_.updateIssue(param1);
                  var_948.add(param1.issueId,_loc3_.id);
                  break;
               }
            }
         }
         if(_loc3_ == null)
         {
            ...
            var_948.add(param1.issueId,_loc2_);
         ...
         if(param1.state == IssueMessageData.const_156)
         {
            ...
            _loc8_ = var_949.indexOf(param1.issueId);
            if(_loc8_ == -1 && _loc6_)
            {
      ...
      public function handleBundle(param1:int) : void
      {
         ...
         var_1106.remove(param1);
         var_1106.add(param1,_loc3_);
      ...
      {
         var _loc2_:* = var_1106.remove(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            _loc2_ = null;
      ...
      public function autoPick() : void
      {
         ...
         {
            if(_loc3_.state == IssueMessageData.const_156 && (_loc2_ == null || _loc3_.getPrioritySum() > _loc2_.getPrioritySum()))
            {
               _loc2_ = _loc3_;
            }
         }
      ...
      public function playSound(param1:IssueMessageData) : void
      {
         ...
         if(var_643 == null || !var_643.isOpen())
         {
            var_61.soundManager.playSound(HabboSoundTypesEnum.const_1034);
         }
      }
      ...
      public function removeIssue(param1:int) : void
      {
         ...
         var _loc2_:int = var_948.getValue(param1);
         if(_loc2_ != 0)
         {
            _loc3_ = var_142.getValue(_loc2_) as IssueBundle;
            if(_loc3_ != null)
