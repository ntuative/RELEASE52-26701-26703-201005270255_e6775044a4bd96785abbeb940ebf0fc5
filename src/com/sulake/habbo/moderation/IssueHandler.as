package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private var var_401:UserInfoCtrl;
      ...
      private function createView() : void
      {
         ...
         var_401 = new UserInfoCtrl(_window,var_61,_loc3_.message);
         var_1022 = new UserInfoCtrl(_window,var_61,_loc3_.message);
         var_401.load(IWindowContainer(_window.findChildByName("caller_user_info")),var_113.getHighestPriorityIssue().reporterUserId);
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         var_61.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),var_61,WindowTracker.const_1045,_loc2_),_window,false,false,true);
      }
      ...
      private function onReporterClicked(param1:WindowMouseEvent) : void
      {
         ...
         if(_loc2_ != 0)
         {
            ...
            var_401 = new UserInfoCtrl(_window,var_61,_loc3_.message);
            var_401.load(IWindowContainer(_window.findChildByName("caller_user_info")),_loc2_);
         }
      }
