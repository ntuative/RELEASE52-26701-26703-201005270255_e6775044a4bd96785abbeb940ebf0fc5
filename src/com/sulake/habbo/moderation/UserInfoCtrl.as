package com.sulake.habbo.moderation
{
   ...
   public class UserInfoCtrl implements IDisposable
   {
      ...
      private static const const_804:int = 31536000;
      
      private static const const_807:int = 86400;
      
      private static const const_806:int = 3600;
      
      private static const const_805:int = 60;
      ...
      {
         if(param1 < 2 * const_805)
         {
            return param1 + " secs ago";
         }
         if(param1 < 2 * const_806)
         {
            return Math.round(param1 / const_805) + " mins ago";
         }
         if(param1 < 2 * const_807)
         {
            return Math.round(param1 / const_806) + " hours ago";
         }
         if(param1 < 2 * const_804)
         {
            return Math.round(param1 / const_807) + " days ago";
         }
         return Math.round(param1 / const_804) + " years ago";
      }
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.windowTracker.show(new ChatlogCtrl(new GetUserChatlogMessageComposer(_data.userId),_main,WindowTracker.const_1031,_data.userId),_callerFrame,var_1077,false,true);
      }
      ...
      private function onModActionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.windowTracker.show(new ModActionCtrl(_main,_data.userId,_data.userName,var_1380),_callerFrame,var_1077,false,true);
      }
      ...
      private function onRoomVisitsButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.windowTracker.show(new RoomVisitsCtrl(_main,_data.userId),_callerFrame,var_1077,false,true);
      }
      ...
      private function onMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.windowTracker.show(new SendMsgsCtrl(_main,_data.userId,_data.userName,var_1380),_callerFrame,var_1077,false,true);
      }
