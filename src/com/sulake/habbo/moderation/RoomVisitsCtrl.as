package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      {
         var _loc3_:IWindowContainer = IWindowContainer(var_1801.clone());
      ...
      {
         var_1801 = IWindowContainer(_main.getXmlWindow("roomvisits_row"));
         ...
         var_51 = IItemListWindow(var_55.findChildByName("visits_list"));
