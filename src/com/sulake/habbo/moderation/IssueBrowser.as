package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private var var_1447:IIssueBrowserView;
      
      private const const_1746:String = "closed_issues";
      ...
      private var var_1448:PickedIssuesView;
      ...
      private function selectView(param1:String) : void
      {
         ...
         var_341.view.width = var_222.container.width;
         var_341.view.height = var_222.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case const_1717:
               if(var_1447 == null)
               {
                  var_1447 = new MyIssuesView(issueManager,this,var_222.container);
               }
               return var_1447;
            case const_1719:
               if(var_1449 == null)
               {
                  var_1449 = new OpenIssuesView(issueManager,this,var_222.container);
               }
               return var_1449;
            case const_1718:
               if(var_1448 == null)
               {
                  var_1448 = new PickedIssuesView(issueManager,this,var_222.container);
               }
               return var_1448;
            default:
               return null;
