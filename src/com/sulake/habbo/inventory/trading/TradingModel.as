package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_334:uint = 2;
      
      public static const const_389:uint = 4;
      ...
      public static const const_1287:uint = 9;
      ...
      public function updateItemGroupMaps(param1:int, param2:Map, param3:int, param4:Map) : void
      {
         ...
         var_514 = false;
         var_752 = false;
         var_47.updateItemList(var_753);
         var_47.updateItemList(var_1325);
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            var_47.alertPopup(TradingView.const_914);
         }
         else if(param1 is TradingAcceptEvent)
         {
            Logger.log("TRADING::TradingAcceptEvent");
            if(TradingAcceptEvent(param1).userID == var_753)
            {
      ...
      {
         Logger.log("OLD STATE: " + var_35 + " NEW STATE: " + param1 + " OWN: " + var_514 + " OTHER: " + var_752);
         ...
         {
            case const_187:
               if(param1 == const_167 || param1 == const_213)
               {
                  var_35 = param1;
                  _loc2_ = true;
               }
      ...
      {
         var_47.setMinimized(param1 != InventoryCategory.const_79);
      ...
      public function close() : void
      {
         if(var_625)
         {
            if(var_35 != const_187 && var_35 != const_213)
            {
               requestCancelTrading();
               state = TradingModel.TRADING_STATE_CANCELLED;
            }
            state = const_187;
            var_11.toggleInventorySubPage(InventorySubCategory.const_911);
            var_625 = false;
         }
         var_47.setMinimized(false);
      }
