package com.sulake.habbo.inventory
{
   ...
   public class InventoryMainView
   {
      ...
      private var var_872:Boolean = true;
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         _loc2_.container.removeChild(var_1262);
         _loc2_.invalidate();
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         {
            if(var_728 == InventoryCategory.const_151)
            {
               toggleCategoryView(InventoryCategory.const_151);
            }
            else if(var_728 == InventoryCategory.const_79)
            {
      ...
      public function toggleSubCategoryView(param1:String, param2:Boolean = true) : void
      {
         ...
         else
         {
            ...
            if(var_197 != null && var_872)
            {
               var_197.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_51,HabboToolbarIconEnum.INVENTORY,_loc3_ as IWindowContainer));
            }
         }
      }
      ...
      public function setHabboToolbarIcon() : void
      {
         if(var_197 != null)
         {
            var_197.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_117,HabboToolbarIconEnum.INVENTORY));
         }
      }
      ...
      private function setSubViewToCategory(param1:String) : void
      {
         ...
         if(var_197 != null)
         {
            var_197.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_662,HabboToolbarIconEnum.INVENTORY,var_15 as IWindowContainer));
         }
      }
      ...
      public function showInventory() : void
      {
         ...
         if(var_197 != null && var_872)
         {
            var_197.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_51,HabboToolbarIconEnum.INVENTORY,_loc1_ as IWindowContainer));
            var_872 = false;
         }
         var_29.inventoryViewOpened(var_729);
      }
      ...
      public function toggleCategoryView(param1:String, param2:Boolean = true) : void
      {
         ...
         else
         {
            _loc3_.visible = true;
            _loc3_.activate();
            if(param1 != var_728 || !var_29.isInventoryCategoryInit(param1))
            {
               setViewToCategory(param1);
            }
            if(var_197 != null && var_872)
