package com.sulake.habbo.inventory.common
{
   ...
   public class ThumbListManager
   {
      ...
      public function ThumbListManager(param1:IAssetLibrary, param2:IThumbListDataProvider, param3:String, param4:String, param5:int, param6:int)
      {
         ...
         if(_loc7_ != null)
         {
            var_577 = BitmapData(_loc7_.content);
         }
         ...
         _thumbWidth = var_577.width;
         var_93 = var_577.height;
         var_1005 = param5;
         var_824 = param6;
         var_223 = Math.floor(var_1005 / _thumbWidth);
         var_18 = new BitmapData(var_1005,var_824);
      }
      ...
      private function removeItemInImage(param1:Point) : void
      {
         ...
         if(var_18.height < var_824)
         {
            _loc12_ = new BitmapData(var_18.width,var_824);
      ...
      {
         var _loc4_:* = null;
         var _loc3_:BitmapData = new BitmapData(var_577.width,var_577.height);
         if(param2)
         {
            _loc3_.copyPixels(_itemBgImageSelected,var_577.rect,new Point(0,0),null,null,false);
         }
         else
         {
            _loc3_.copyPixels(var_577,var_577.rect,new Point(0,0),null,null,false);
         }
         if(param1 != null)
         {
      ...
      public function updateImageFromList() : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         var_476 = resolveRowCountFromList();
         if(var_476 == 0)
         {
            var_18 = new BitmapData(var_1005,var_824);
            return;
         }
         var_18 = new BitmapData(Math.max(var_223 * _thumbWidth,var_1005),Math.max(var_476 * var_93,var_824),true,16777215);
         var_18.fillRect(var_18.rect,4294967295);
         var _loc1_:int = 0;
         var _loc2_:Array = getList();
         var _loc3_:int = 0;
         while(_loc3_ < var_476)
         {
            _loc4_ = 0;
      ...
      public function addItemAsFirst(param1:IThumbListDrawableItem) : void
      {
         ...
         if(_loc3_.x == var_223 && var_18.height < _loc3_.y * var_93)
         {
         ...
         _loc4_ = new Rectangle(0,0,_thumbWidth * (var_223 - 1),var_93);
         _loc2_.copyPixels(var_18,_loc4_,new Point(_thumbWidth,0),null,null,true);
         _loc4_ = new Rectangle(_thumbWidth * (var_223 - 1),0,_thumbWidth,var_18.height);
         _loc2_.copyPixels(var_18,_loc4_,new Point(0,var_93),null,null,true);
         _loc4_ = new Rectangle(0,var_93,_thumbWidth * (var_223 - 1),0 - var_93);
