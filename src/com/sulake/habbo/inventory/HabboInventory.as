package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private var var_906:IRoomSession;
      ...
      override public function dispose() : void
      {
         ...
         if(var_19 != null)
         {
            ...
            var_19.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_453,roomSessionEventHandler);
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_108:
               var_906 = null;
               break;
            case RoomSessionPropertyUpdateEvent.const_453:
               petsModel.updatePetsAllowed();
         }
      }
      ...
      {
         return EffectsModel(var_48.getValue(InventoryCategory.const_670));
      }
      
      public function get furniModel() : FurniModel
      {
         return FurniModel(var_48.getValue(InventoryCategory.const_79));
      }
      ...
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_875));
      }
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(const_1731);
         }
      }
      
      public function get achievementsModel() : AchievementsModel
      {
         return AchievementsModel(var_48.getValue(InventoryCategory.const_343));
      }
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         {
            _loc3_ = var_905.indexOf(param1);
            if(_loc3_ >= 0)
            {
               var_905.splice(_loc3_,1);
            }
         }
      }
      ...
      {
         return TradingModel(var_48.getValue(InventorySubCategory.const_269));
      }
      
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         var_368 = ISessionDataManager(param2);
      ...
      {
         return var_48.getValue(InventoryCategory.const_342) as MarketplaceModel;
      }
      ...
      private function onCommunicationComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1073 = new IncomingMessages(this);
      ...
      {
         return BadgesModel(var_48.getValue(InventoryCategory.const_276));
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_19.events.addEventListener(RoomSessionPropertyUpdateEvent.const_453,roomSessionEventHandler);
         ...
         var_48.add(InventoryCategory.const_342,_loc3_);
         ...
         var_48.add(InventoryCategory.const_79,_loc4_);
         var _loc5_:BadgesModel = new BadgesModel(this,_windowManager,_communication,_assetLibrary,_localization,var_368);
         var_48.add(InventoryCategory.const_276,_loc5_);
         var _loc6_:EffectsModel = new EffectsModel(this,_windowManager,_communication,_assetLibrary,_localization);
         var_48.add(InventoryCategory.const_670,_loc6_);
         var _loc7_:AchievementsModel = new AchievementsModel(this,_windowManager,_communication,_assetLibrary,_localization,var_368);
         var_48.add(InventoryCategory.const_343,_loc7_);
         var _loc8_:TradingModel = new TradingModel(this,_windowManager,_communication,_assetLibrary,_roomEngine,_localization);
         var_48.add(InventorySubCategory.const_269,_loc8_);
