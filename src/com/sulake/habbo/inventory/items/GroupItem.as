package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      private const const_1721:int = 13421772;
      ...
      protected var var_2313:BitmapData;
      ...
      private const const_1720:int = 8947848;
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(category == FurniCategory.const_691)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < _items.length)
      ...
      public function initImage() : void
      {
         ...
         {
            _loc1_ = _roomEngine.getFurnitureIcon(_type,this,String(var_1578));
         }
         else
         {
            _loc1_ = _roomEngine.getWallItemIcon(_type,this,var_1419);
         }
         if(_loc1_.id > 0)
         {
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc5_)
         {
            if(var_1415 && getRecyclableCount() > 0)
            {
               _loc5_.bitmap = var_2313;
               _loc5_.visible = true;
            }
            else
            {
