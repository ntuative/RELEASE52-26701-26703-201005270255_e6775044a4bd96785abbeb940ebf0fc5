package com.sulake.habbo.avatar.common
{
   ...
   public class CategoryData
   {
      ...
      private const const_1748:int = 2;
      ...
      public function selectPartIndex(param1:int) : AvatarEditorGridPartItem
      {
         ...
         if(var_783 >= 0 && var_184.length > var_783)
         {
            _loc2_ = var_184[var_783];
            if(_loc2_)
            {
               _loc2_.isSelected = false;
            }
         }
         if(var_184.length > param1)
         {
            _loc3_ = var_184[param1] as AvatarEditorGridPartItem;
            if(_loc3_)
            {
      ...
      {
         return var_184[var_783] as AvatarEditorGridPartItem;
      }
