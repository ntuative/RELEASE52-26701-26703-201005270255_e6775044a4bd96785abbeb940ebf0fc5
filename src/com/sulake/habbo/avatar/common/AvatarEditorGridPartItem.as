package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridPartItem
   {
      ...
      private const const_1720:int = 13421772;
      ...
      private var var_607:IFigurePartSet;
      ...
      public function AvatarEditorGridPartItem(param1:IWindowContainer, param2:IAvatarEditorCategoryModel, param3:IFigurePartSet, param4:Array, param5:Boolean = true)
      {
         ...
         if(param3 != null)
         {
            ...
            {
               var_1522 = Math.max(var_1522,_loc6_.colorLayerIndex);
            }
         }
      ...
      private function analyzePartLayers() : Boolean
      {
         ...
         for each(_loc1_ in partSet.parts)
         {
            if(_loc6_)
            {
               _loc2_ = "undefined_undefined_" + _loc1_.type + "_" + _loc1_.id + "_" + const_248[_loc5_] + "_" + FigureData.const_110;
      ...
      private function renderThumb() : BitmapData
      {
         ...
         for each(_loc2_ in _loc8_)
         {
            if(_loc7_)
            {
               _loc3_ = "undefined_undefined_" + _loc2_.type + "_" + _loc2_.id + "_" + const_248[_loc6_] + "_" + FigureData.const_110;
            ...
            if(_loc4_)
            {
               ...
               if(var_1521 && _loc2_.colorLayerIndex > 0)
               {
