package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridColorItem
   {
      ...
      private var var_670:IPartColor;
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.bitmap = new BitmapData(var_672.width,var_672.height,true,0);
            _loc1_.bitmap.copyPixels(var_672,var_672.rect,new Point(0,0));
         }
         var _loc2_:IBitmapWrapperWindow = _window.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
         if(_loc2_ != null)
         {
            _loc2_.bitmap = new BitmapData(var_799.width,var_799.height,true,0);
            _loc5_ = var_799.clone();
            _loc5_.colorTransform(_loc5_.rect,var_670.colorTransform);
         ...
         if(_loc3_ != null)
         {
            if(_isSelected)
            {
               _loc3_.bitmap = new BitmapData(var_671.width,var_671.height,true,16777215);
               _loc3_.bitmap.copyPixels(var_671,var_671.rect,new Point(0,0),null,null,true);
               _loc3_.visible = true;
            }
            else
            {
