package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1633:IWindowContainer;
      
      public static var var_1403:IWindowContainer;
      
      public static var var_2297:int = 6710886;
       
      
      private var var_1628:Boolean = true;
      
      private var var_1124:Array;
      
      private var var_380:Timer;
      
      private var var_550:ITabSelectorWindow;
      
      private var _window:IWindowContainer;
      
      private var var_549:IFrameWindow;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager, param3:IHabboCatalog, param4:Array, param5:Boolean)
      {
         ...
         var _loc8_:* = null;
         var_1124 = [];
         var_1089 = [AvatarEditorFigureCategory.const_635,AvatarEditorFigureCategory.const_47,AvatarEditorFigureCategory.const_209,AvatarEditorFigureCategory.const_586,AvatarEditorFigureCategory.HOTLOOKS,AvatarEditorFigureCategory.const_95];
         super();
         var_29 = param1;
         ...
         if(var_1403 == null)
         {
            ...
            var_1403 = var_29.windowManager.buildFromXML(_loc7_.content as XML) as IWindowContainer;
         }
         if(var_1633 == null)
         {
            _loc8_ = var_29.assets.getAssetByName("color_chooser_cell") as XmlAsset;
            var_1633 = var_29.windowManager.buildFromXML(_loc8_.content as XML) as IWindowContainer;
         }
      ...
      public function update() : void
      {
         ...
         if(var_29.sessionData.hasUserRight("fuse_use_wardrobe") && (var_1629 == AvatarEditorSideCategory.const_95 || var_2289))
         {
      ...
      private function displayStripClubDialog() : void
      {
         ...
         if(!var_549)
         {
            ...
            var_549 = _windowManager.buildFromXML(_loc2_,2) as IFrameWindow;
            var_549.procedure = stripClubDialogEventProc;
            var_549.center();
         }
         else
         {
      ...
      private function createWindow(param1:Boolean) : void
      {
         ...
         var_550 = _window.findChildByName("mainTabs") as ITabSelectorWindow;
         var _loc2_:int = -1;
         while(_loc2_ >= 0)
         {
            _loc4_ = var_550.getSelectableAt(_loc2_);
            if(_loc4_ != null && var_1124.indexOf(_loc4_.name) < 0)
            {
               _loc5_ = var_550.removeSelectable(_loc4_);
               _loc6_ = _loc2_ + 1;
               while(_loc6_ < var_550.numSelectables)
               {
                  var_550.getSelectableAt(_loc6_).x = var_550.getSelectableAt(_loc6_).x - _loc5_.width;
                  _loc6_++;
               }
            }
            _loc2_--;
      ...
      public function validateAvailableCategories(param1:Array) : Boolean
      {
         ...
         if(param1 == null)
         {
            return validateAvailableCategories(var_1089);
         }
         if(param1.length != var_1124.length)
         {
            return false;
         }
         for each(_loc2_ in param1)
         {
            if(var_1124.indexOf(_loc2_) < 0)
            {
               return false;
            }
         }
      ...
      private function setSideContent(param1:String) : void
      {
         ...
         switch(param1)
         {
            case AvatarEditorSideCategory.const_685:
               break;
            case AvatarEditorSideCategory.const_420:
               _loc3_ = var_29.getSideContentWindowContainer(AvatarEditorSideCategory.const_420);
               break;
      ...
      {
         if(var_1629 == AvatarEditorSideCategory.const_95)
         {
            var_2289 = false;
            setSideContent(AvatarEditorSideCategory.const_685);
         }
         else
         {
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         var_285 = param1;
         var_550.setSelected(var_550.getSelectableByName(param1));
         _window.invalidate();
      }
