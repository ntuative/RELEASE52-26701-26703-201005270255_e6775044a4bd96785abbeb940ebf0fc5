package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_1493:PartOffsetData;
      
      private var var_858:AvatarActionManager;
      
      private var var_175:IAssetLibrary;
      
      private var var_859:IAssetLibrary;
      
      private var var_1842:AvatarRenderManager;
      
      private var var_306:FigureData;
      
      private var var_636:AnimationData;
      
      private var _geometry:AvatarModelGeometry;
      
      private var var_716:String;
      
      private var var_1494:AvatarStructureDownloadSet;
      ...
      public function AvatarStructure(param1:AvatarRenderManager, param2:IAssetLibrary, param3:IAssetLibrary, param4:String)
      {
         ...
         var_636 = new AnimationData();
         var_1494 = new AvatarStructureDownloadSet();
         var_715 = new AnimationManager();
         var_716 = param4;
         var_1493 = PartOffsetData.getInstance(param3);
         init();
      }
      ...
      {
         return var_858.getActionDefinitionWithState(param1);
      }
      ...
      {
         return var_858.getCanvasOffsets(param1,param2,param3);
      }
      
      public function injectFigureData(param1:XML) : void
      {
         var_306.injectXML(param1);
      }
      
      public function getActionDefinition(param1:String) : ActionDefinition
      {
         return var_858.getActionDefinition(param1);
      }
               ...
               if(_loc7_.hasAddData())
               {
                  for each(_loc9_ in _loc7_.addData)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        _loc12_ = var_404.addPartDefinition(_loc11_);
      ...
      {
         var _loc4_:Number = AvatarDirectionAngle.const_1219[param3];
      ...
      public function getParts(param1:String, param2:AvatarFigureContainer, param3:IActiveActionData, param4:String, param5:int, param6:Array, param7:Dictionary = null) : Array
      {
         ...
         var _loc8_:ActionDefinition = var_858.getDefaultActionType();
               ...
               if(_loc26_)
               {
                  ...
                  if(_loc27_ != null)
                  {
                     ...
                     for each(_loc28_ in _loc27_.parts)
                     {
                        ...
                        {
                           _loc29_ = [0];
                           _loc30_ = var_636.getAction(param3.definition);
                           if(_loc30_ != null)
                           {
      ...
      {
         Logger.log("[AvatarStructure] Structure " + var_716 + " ready to go!");
      ...
      public function initConfiguration(param1:IHabboConfigurationManager) : void
      {
         ...
         switch(var_716)
         {
            case AvatarType.const_86:
               ...
               var_1494.add(new AvatarStructureDownload(var_175,_loc5_,var_306));
               break;
            case AvatarType.PET:
         }
         var_1494.addEventListener(AvatarStructureDownloadSet.DOWNLOAD_SET_DONE,onStructureReady);
      }
      ...
      {
         var_858 = new AvatarActionManager(var_175,var_716);
      }
      ...
      public function getMandatorySetTypeIds() : Array
      {
         ...
         var_1241 = var_306.getMandatorySetTypeIds();
         return var_1241;
      }
      ...
      private function registerAnimations() : void
      {
         var _loc2_:* = null;
         var _loc1_:int = 1;
         while(var_859.hasAsset("dance" + _loc1_))
         {
            _loc2_ = var_859.getAssetByName("dance" + _loc1_).content as XML;
            var_715.registerAnimation(this,_loc2_);
            _loc1_++;
         }
         _loc1_ = 1;
         while(var_859.hasAsset("fx" + _loc1_))
         {
            _loc2_ = var_859.getAssetByName("fx" + _loc1_).content as XML;
            var_715.registerAnimation(this,_loc2_);
            _loc1_++;
         }
      }
      ...
      {
         return var_1493.getOffset(param1,param2,param3,param4,param5,param6);
      }
      ...
      {
         var_1493.loadOffsets(var_859);
      }
      
      public function sortActions(param1:Array) : Array
      {
         return var_858.sortActions(param1);
      }
   }
}
