   ...
   public class LegsView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_34)
         {
            ...
            var_34["null"] = new AvatarEditorGridView(_model,FigureData.const_193,_windowManager,_assetLibrary);
         }
         else
         {
         ...
         if(_model && var_146 == "")
         {
            _model.switchCategory(FigureData.const_186);
         }
      }
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               ...
               case "tab_shoes":
                  ...
                  break;
               case "tab_belts":
                  switchCategory(FigureData.const_193);
            }
         }
