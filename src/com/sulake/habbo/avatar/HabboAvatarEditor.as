package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      private static const const_1116:String = "hr-100.hd-180-7.ch-215-66.lg-270-79.sh-305-62.ha-1002-70.wa-2007";
      
      private static const const_1115:String = "hr-515-33.hd-600-1.ch-635-70.lg-716-66-62.sh-735-68";
       
      
      private var _view:AvatarEditorView;
      
      private var var_855:AvatarEditorHandler;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_230:IWindowContainer;
      
      private var var_597:ISessionDataManager;
      ...
      private const const_1114:int = 2;
      ...
      private var var_1029:IHabboAvatarEditorDataSaver = null;
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return var_710.getSetType(param1);
      }
      ...
      private function init() : void
      {
         ...
         if(!var_165)
         {
            ...
            var_487["null"] = new FigureData(this);
            var_487["null"] = new FigureData(this);
            _loc1_ = var_487["null"];
            _loc2_ = var_487["null"];
            _loc1_.loadAvatarData(const_1116,FigureData.const_71);
            _loc2_.loadAvatarData(const_1115,FigureData.const_75);
            var_91 = new Map();
            var_403 = new Map();
            var_91.add(AvatarEditorFigureCategory.const_635,new BodyModel(this));
            var_91.add(AvatarEditorFigureCategory.const_47,new HeadModel(this));
            var_91.add(AvatarEditorFigureCategory.const_209,new TorsoModel(this));
            var_91.add(AvatarEditorFigureCategory.const_586,new LegsModel(this));
            var_91.add(AvatarEditorFigureCategory.HOTLOOKS,new HotLooksModel(this));
            var_403.add(AvatarEditorSideCategory.const_95,new WardrobeModel(this));
            var_403.add(AvatarEditorSideCategory.const_420,new ClubPromoModel(this));
            var_165 = true;
         }
      }
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_597 = param2 as ISessionDataManager;
      }
      ...
      public function saveCurrentSelection() : void
      {
         ...
         if(var_1029 != null)
         {
            ...
            _loc2_ = "null";
            var_1029.saveFigure(_loc1_,_loc2_);
         }
      }
      ...
      public function getDefaultColour(param1:String) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               if(_loc4_.isSelectable && var_1030 >= _loc4_.clubLevel)
               {
                  return _loc4_.id;
               }
            }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc8_ != null)
         {
            ...
            {
               if(_loc14_.isSelectable && (_loc13_ || var_1030 >= _loc14_.clubLevel))
               {
                  _loc16_ = 0;
                  while(_loc16_ < const_1114)
                  {
                     _loc17_ = new AvatarEditorGridColorItem(AvatarEditorView.var_1633.clone() as IWindowContainer,param1,_loc14_);
            ...
            if(_loc9_)
            {
               ...
               if(_loc19_)
               {
                  ...
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1403.clone() as IWindowContainer,param1,null,null,false);
            ...
            {
               _loc21_ = false;
               if(_loc6_.gender == FigureData.const_1212)
               {
                  _loc21_ = true;
               }
               ...
               if(_loc6_.isSelectable && _loc21_ && (_loc13_ || var_1030 >= _loc6_.clubLevel))
               {
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1403.clone() as IWindowContainer,param1,_loc6_,_loc12_,_loc15_);
                  _loc3_.push(_loc7_);
               }
            }
         }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return var_403.getValue(AvatarEditorSideCategory.const_95);
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_855 = new AvatarEditorHandler(this,_communication);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return var_710.getPalette(param1);
      }
      ...
      public function openEditor(param1:IWindowContainer = null, param2:IHabboAvatarEditorDataSaver = null, param3:Array = null, param4:Boolean = false) : Boolean
      {
         ...
         else
         {
            if(var_230 == null)
            {
               var_230 = _windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_58,HabboWindowStyle.const_43,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
         ...
         {
            toggleAvatarEditorPage(AvatarEditorFigureCategory.const_635);
         }
         var_1029 = param2;
         return true;
      }
      ...
      {
         var_710 = var_590.getFigureData(AvatarType.const_86);
      ...
      public function loadAvatarInEditor(param1:String, param2:String, param3:int = 0) : void
      {
         ...
         var_1030 = param3;
         var _loc4_:FigureData = var_487[param2];
         if(_loc4_ == null)
         {
            return;
         }
