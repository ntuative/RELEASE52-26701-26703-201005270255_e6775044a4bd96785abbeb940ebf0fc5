package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      private var var_2035:IWindowContainer;
      ...
      private function refreshTab() : void
      {
         ...
         setEnabled(var_1557,this._model.mode != ThumbnailEditorModel.const_57);
         setEnabled(var_1558,this._model.mode != ThumbnailEditorModel.const_37);
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         var_1557 = IButtonWindow(find("top_tab"));
         var_1558 = IButtonWindow(find("obj_tab"));
         var_2035 = IWindowContainer(find("tile_grid"));
         var_2034 = IWindowContainer(find("now_editing_container"));
         ...
         Util.setProcDirectly(var_1557,onTopTabButton);
         Util.setProcDirectly(var_1558,onObjTabButton);
      }
      ...
      private function refreshPositionGrid() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = var_2035;
         _loc1_.visible = true;
         if(_loc1_.numChildren == 0)
         {
            while(_loc3_ <= RoomThumbnailRenderer.const_448)
            {
      ...
      {
         var _loc1_:IWindowContainer = var_2034;
      ...
      private function populateImgList(param1:IItemListWindow, param2:int) : void
      {
         ...
         while(_loc8_ < _loc6_.length)
         {
            ...
            if(_loc9_ == 0)
            {
               _loc7_ = IWindowContainer(_navigator.windowManager.createWindow("row_" + _loc8_,"",HabboWindowType.const_58,HabboWindowStyle.const_43,HabboWindowParam.const_74,new Rectangle(0,0,param1.width,66)));
