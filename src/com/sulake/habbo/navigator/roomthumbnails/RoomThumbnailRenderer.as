package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailRenderer
   {
      ...
      private static const const_1061:int = 8;
      
      public static const const_448:int = 10;
      
      private static const const_1063:int = 40;
      ...
      private var var_795:ThumbnailImageConfigurations;
      ...
      public function RoomThumbnailRenderer(param1:HabboNavigator)
      {
         ...
         super();
         _navigator = param1;
         var_795 = new ThumbnailImageConfigurations(_navigator);
      ...
      {
         var _loc3_:ThumbnailImageConfiguration = this.var_795.getImage(ThumbnailEditorModel.const_37,param2.imgId);
         if(_loc3_ == null)
         {
         ...
         param1.copyPixels(_loc5_,_loc5_.rect,new Point(_loc4_.x + const_1062,_loc4_.y + const_1063 - _loc5_.height),null,null,true);
      }
      ...
      {
         return Point(this.var_1665[param1]);
      }
      ...
      private function refreshBg(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_795.getImage(ThumbnailEditorModel.const_40,param2);
         if(_loc3_ == null)
         {
            Logger.log("Unknown bg image id: " + param2);
            _loc3_ = this.var_795.getImage(ThumbnailEditorModel.const_40,1);
         }
      ...
      private function refreshFront(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_795.getImage(ThumbnailEditorModel.const_57,param2);
         if(_loc3_ == null)
         {
      ...
      private function getLoc(param1:int, param2:int) : Point
      {
         ...
         return new Point(param1 * const_767 + _loc3_,param2 * const_1061);
      }
      ...
      private function refreshCover(param1:BitmapData) : void
      {
         if(var_1149 == null)
         {
            var_1149 = _navigator.getButtonImage("rico_rnd");
         }
         param1.copyPixels(var_1149,var_1149.rect,new Point(0,0),null,null,true);
      }
   }
}
