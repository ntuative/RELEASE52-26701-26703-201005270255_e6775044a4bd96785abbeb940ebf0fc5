package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomSettingsCtrl
   {
      ...
      private var var_675:ICheckBoxWindow;
      ...
      private var var_1706:ITextWindow;
      ...
      private function onConfirmRoomDelete(param1:WindowMouseEvent, param2:int) : void
      {
         ...
         close();
         var_392.roomSettingsRefreshNeeded();
      ...
      {
         if(param1 != this.var_391 || var_991 < 1)
         {
            return;
         }
         var_991 = 0;
         if(param2 == RoomSettingsSaveErrorMessageParser.const_1424)
         {
            this.var_808.displayError("${navigator.roomsettings.roomnameismandatory}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1333)
         {
            this.var_808.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1412)
         {
         ...
         {
            setTagError(this.var_836,param3,"${navigator.roomsettings.unacceptablewords}");
         ...
         {
            setTagError(this.var_836,param3,"${navigator.roomsettings.nonuserchoosabletag}");
         ...
         {
            this.var_808.displayError("Update failed: error " + param2);
         }
      }
      ...
      private function populateForm() : void
      {
         ...
         changePasswordField(_loc1_.doorMode == RoomSettingsData.const_139);
         Logger.log("CATEGORY ID: " + _loc1_.categoryId);
         setCategorySelection(_loc1_.categoryId);
         refreshMaxVisitors(_loc1_);
         setTag(var_836,_loc1_.tags[0]);
         setTag(var_835,_loc1_.tags[1]);
         if(var_1168)
         {
            if(_loc1_.allowPets)
            {
               this.var_1168.select();
            }
            else
            {
               this.var_1168.unselect();
            }
         }
         if(var_1169)
         {
      ...
      {
         return IWindowContainer(_navigator.windowManager.createWindow(param1,"",HabboWindowType.const_58,HabboWindowStyle.const_43,HabboWindowParam.const_74,new Rectangle(0,0,100,20)));
      }
      ...
      private function onSaveButtonClick(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            ...
            case "doormode_password":
               ...
               break;
            default:
               _loc2_.doorMode = RoomSettingsFlatInfo.const_474;
         }
         ...
         _loc2_.allowPets = var_1168.isSelected;
         _loc2_.allowFoodConsume = var_1169.isSelected;
         _loc2_.allowWalkThrough = var_1167.isSelected;
         _loc2_.hideWalls = var_675.isSelected;
         _loc2_.tags = new Array();
         addTag(var_836,_loc2_.tags);
         addTag(var_835,_loc2_.tags);
         this.clearErrors();
         this.var_991 = _loc2_.roomId;
      ...
      public function refresh(param1:IWindowContainer) : void
      {
         ...
         var_1706.visible = var_467;
         var_1707.visible = !var_467;
         if(var_467)
         {
         ...
         else
         {
            ...
            var_989.height = Util.getLowestPoint(this.var_989) + 4;
         }
         var_1435.text = !!var_467 ? "${navigator.roomsettings.tobasicsettings}" : "${navigator.roomsettings.toadvancedsettings}";
         Util.moveChildrenToColumn(_window,[var_1434.name,_thumbnailContainer.name,var_989.name,var_990.name,var_1165.name,var_1436.name],0,0);
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_959,onDoorModePasswordUnselect);
         ...
         this.var_808 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("room_name")),60);
         this.var_1166 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("description")),255);
         this.var_836 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("tag1")),30);
         ...
         this.var_1168 = ICheckBoxWindow(_window.findChildByName("allow_pets_checkbox"));
         this.var_1169 = ICheckBoxWindow(_window.findChildByName("allow_foodconsume_checkbox"));
         this.var_1167 = ICheckBoxWindow(_window.findChildByName("allow_walk_through_checkbox"));
         this.var_675 = ICheckBoxWindow(_window.findChildByName("hide_walls_checkbox"));
         ...
         var_989 = IWindowContainer(_window.findChildByName("basic_settings_container"));
         var_990 = IWindowContainer(_window.findChildByName("advanced_settings_container"));
         var_1436 = IWindowContainer(_window.findChildByName("switch_view_container"));
         ...
         var_993 = IWindowContainer(_window.findChildByName("password_container"));
         var_1707 = ITextWindow(_window.findChildByName("basic_caption"));
         var_1706 = ITextWindow(_window.findChildByName("advanced_caption"));
