package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_954:RoomLayout;
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         super();
         _navigator = param1;
         var_547 = new Timer(100);
         var_547.addEventListener(TimerEvent.TIMER,updateArrowPos);
         var_40 = new Array();
      ...
      private function prepare() : void
      {
         ...
         var_1119 = new TextFieldManager(_navigator,ITextFieldWindow(var_20.findChildByName("room_name_input")),25,null,_navigator.getText("navigator.createroom.roomnameinfo"));
      ...
      public function dispose() : void
      {
         if(var_547)
         {
            var_547.removeEventListener(TimerEvent.TIMER,updateArrowPos);
            var_547.reset();
            var_547 = null;
         }
      }
      ...
      {
         var_1119.goBackToInitialState();
         var_1119.input.textBackgroundColor = 4294967295;
         var_954 = var_40[0];
      ...
      {
         return IWindowContainer(_navigator.windowManager.createWindow("","",HabboWindowType.const_58,HabboWindowStyle.const_43,HabboWindowParam.const_74,new Rectangle(0,0,100,300)));
      }
      ...
      private function onCreateButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = var_1119.getText();
      ...
      {
         var _loc1_:Boolean = var_1119.checkMandatory(_navigator.getText("navigator.createroom.nameerr"));
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(var_954.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!var_1391 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            var_1391 = true;
            _loc3_.y = 1;
