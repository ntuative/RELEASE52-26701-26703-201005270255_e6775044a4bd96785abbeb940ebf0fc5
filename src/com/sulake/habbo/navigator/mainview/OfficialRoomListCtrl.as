package com.sulake.habbo.navigator.mainview
{
   ...
   public class OfficialRoomListCtrl implements IViewCtrl
   {
      ...
      private static const const_1082:int = 267;
      
      private static const const_1081:int = 65;
      ...
      private var var_807:UserCountRenderer;
      ...
      public function OfficialRoomListCtrl(param1:HabboNavigator)
      {
         super();
         _navigator = param1;
         var_807 = new UserCountRenderer(_navigator);
      }
      ...
      private function handleClick(param1:IWindow) : void
      {
         ...
         else if(_loc2_.tag != null)
         {
            ...
            _navigator.mainViewCtrl.startSearch(Tabs.const_210,Tabs.const_329,_loc2_.tag);
         }
      ...
      private function refreshPublicSpaceImage(param1:IWindowContainer, param2:OfficialRoomEntryData, param3:IBitmapWrapperWindow) : void
      {
         ...
         var _loc5_:String = "publicSpace." + _loc4_ + "." + param2.method_2;
         if(param3.tags[0] == _loc5_)
         {
            param3.visible = true;
            return;
         }
         param3.x = !!param2.method_2 ? int(const_1083) : 0;
         param3.width = 274;
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:OfficialRoomEntryData) : Boolean
      {
         ...
         if(param1)
         {
            ...
            if(param3.type == OfficialRoomEntryData.const_1289)
            {
      ...
      private function refreshCell(param1:IWindowContainer, param2:OfficialRoomEntryData) : void
      {
         ...
         _loc3_.visible = true;
         _loc3_.width = !!param2.method_2 ? int(const_1081) : int(const_1082);
      ...
      private function refreshDetails(param1:IWindowContainer, param2:OfficialRoomEntryData) : void
      {
         ...
         _loc3_.visible = param2.method_2;
      ...
      private function refreshUserCount(param1:IWindowContainer, param2:OfficialRoomEntryData) : void
      {
         ...
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         if(param2.method_2 && (param2.type == OfficialRoomEntryData.const_669 || param2.type == OfficialRoomEntryData.const_721))
         {
            _loc3_ = 3;
            _loc4_ = 34;
            _loc5_ = 13;
            var_807.refreshUserCount(param2.maxUsers,param1,param2.userCount,"${navigator.usercounttooltip.users}",param1.width - _loc3_ - _loc4_,param1.height - _loc3_ - _loc5_);
         }
      }
      ...
      private function refreshPicText(param1:IWindowContainer, param2:OfficialRoomEntryData) : void
      {
         ...
         if(param2.picText == "" || param2.method_2)
         {
            _loc3_.visible = false;
            return;
         }
