package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class SearchTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_1602:TextSearchInputs;
      ...
      private function onClearResultsClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _navigator.mainViewCtrl.startSearch(Tabs.const_210,Tabs.const_221,"-1",MainViewCtrl.const_594);
      }
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(var_1602 == null)
         {
            ...
            var_1602 = new TextSearchInputs(_navigator,false,_loc4_);
         ...
         {
            var_1602.searchStr.setText(_navigator.data.guestRoomSearchResults.searchParam);
         }
