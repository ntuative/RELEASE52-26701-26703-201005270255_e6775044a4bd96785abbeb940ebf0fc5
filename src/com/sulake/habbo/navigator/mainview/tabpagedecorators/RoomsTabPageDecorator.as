package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class RoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private function startSearch() : void
      {
         ...
         if(_loc1_ == 0)
         {
            _navigator.mainViewCtrl.startSearch(Tabs.const_274,Tabs.const_320);
         }
         else if(_loc1_ == 1)
         {
            _navigator.mainViewCtrl.startSearch(Tabs.const_274,Tabs.const_652);
         }
         else
         {
            ...
            _navigator.mainViewCtrl.startSearch(Tabs.const_274,Tabs.const_320,"" + _loc3_);
         }
      }
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(var_478 == null)
         {
            var_478 = IDropMenuWindow(_loc3_.findChildByName("roomCtgFilter"));
            var_478.procedure = onChangeFilter;
