package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class MyRoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_470:IDropMenuWindow;
      
      private var var_2402:IWindowContainer;
      ...
      {
         var _loc1_:int = var_470 == null ? 0 : int(var_470.selection);
         Logger.log("Me subNavi selection changed: " + _loc1_);
         _navigator.mainViewCtrl.startSearch(Tabs.const_252,getSearchTypeForIndex(_loc1_));
      }
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(var_470 == null)
         {
            var_470 = IDropMenuWindow(_loc3_.findChildByName("meSubNavi"));
            var_470.procedure = onChangeSubNavi;
            prepareSubNavi();
         }
         _loc3_.visible = true;
      }
