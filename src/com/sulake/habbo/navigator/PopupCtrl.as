package com.sulake.habbo.navigator
{
   ...
   public class PopupCtrl
   {
      ...
      public function PopupCtrl(param1:HabboNavigator, param2:int, param3:int, param4:String)
      {
         ...
         var_350.addEventListener(TimerEvent.TIMER,onDisplayTimer);
      ...
      public function dispose() : void
      {
         ...
         if(var_350)
         {
            var_350.removeEventListener(TimerEvent.TIMER,onDisplayTimer);
            var_350.reset();
            var_350 = null;
         }
         if(var_308)
      ...
      public function showPopup(param1:IWindow) : void
      {
         if(var_50 == null)
         {
            var_50 = IWindowContainer(_navigator.getXmlWindow(var_1175));
            var_50.visible = false;
         ...
         var_50.x = _loc2_.x + var_1869 + param1.width;
