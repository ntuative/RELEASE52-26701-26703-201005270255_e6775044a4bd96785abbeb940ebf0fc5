package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_845:RoomCreateViewCtrl;
      
      private var var_1799:RoomThumbnailRenderer;
      ...
      private var var_452:Tabs;
      
      private var var_257:MainViewCtrl;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_257 = new MainViewCtrl(this);
         var_586 = new RoomInfoViewCtrl(this);
         var_845 = new RoomCreateViewCtrl(this);
         var_1799 = new RoomThumbnailRenderer(this);
         var_992 = new GuestRoomPasswordInput(this);
         _doorbell = new GuestRoomDoorbell(this);
         var_452 = new Tabs(this);
      }
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         var_257.startSearch(Tabs.const_210,Tabs.const_329,param1);
         var_257.mainWindow.activate();
      }
      ...
      {
         if(param1 != null && var_197 != null)
         {
            var_197.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_51,HabboToolbarIconEnum.NAVIGATOR,param1));
         }
      }
      ...
      private function setHabboToolbarIcon() : void
      {
         if(var_197 != null)
         {
            var_197.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_117,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.settings != null && this._data.settings.homeRoomId > 0)
            {
               var_197.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_117,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         var_257.startSearch(Tabs.const_252,Tabs.const_246);
         var_452.getTab(Tabs.const_252).tabPageDecorator.tabSelected();
      }
      ...
      {
         var _loc1_:Boolean = var_257.onNavigatorToolBarIconClick();
         if(_loc1_)
         {
