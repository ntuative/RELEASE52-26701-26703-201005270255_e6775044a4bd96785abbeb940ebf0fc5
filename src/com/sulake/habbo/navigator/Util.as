package com.sulake.habbo.navigator
{
   ...
   public class Util
   {
      ...
      private static var var_1421:CutToHeight = new CutToHeight();
      
      private static var var_1422:CutToWidth = new CutToWidth();
      ...
      public static function cutTextToHeight(param1:ITextWindow, param2:String, param3:int) : void
      {
         ...
         var_1421.beforeSearch(param2,param1,param3);
         binarySearch(var_1421,param2.length - 1);
      }
      ...
      public static function cutTextToWidth(param1:ITextWindow, param2:String, param3:int) : void
      {
         ...
         var_1422.beforeSearch(param2,param1,param3);
         binarySearch(var_1422,param2.length - 1);
      }
   }
}
