package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconGroup
   {
      ...
      {
         return var_1218.indexOf(param1) > -1;
      }
      ...
      {
         return var_703.indexOf(param1) > -1;
      }
      ...
      private function alignItems() : void
      {
         ...
         var _loc3_:* = 0;
         var _loc4_:int = 0;
         while(_loc4_ < var_1219.length)
         {
            _loc2_ = var_703.indexOf(var_1219[_loc4_]);
            if(_loc2_ > -1)
            {
            ...
            if(_loc2_ != null)
            {
               if(!containsIcon(_loc2_))
               {
                  ...
                  if(_loc5_.length() > 0)
                  {
                     ...
                     {
                        _loc3_ = "null";
                        var_1218.push(_loc3_);
                        _loc6_.dockMenu(_loc3_,getMenuYieldList(_loc3_),_loc5_[_loc9_].@locktoicon == "TradingItemListEvent");
                        _loc9_++;
                     }
                  }
                  else
      ...
      public function getIconById(param1:String) : ToolbarIcon
      {
         ...
         return var_301[var_703.indexOf(param1)];
      }
      ...
      public function getMenuYieldList(param1:String) : Array
      {
         ...
         var _loc3_:XMLList = var_1803.elements("menu");
         var _loc5_:int = 0;
