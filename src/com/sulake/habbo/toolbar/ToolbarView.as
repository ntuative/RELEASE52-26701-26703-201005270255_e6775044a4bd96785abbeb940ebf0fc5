package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      private var var_1523:Number = 15;
      
      private var _events:IEventDispatcher;
      
      private var var_256:ToolbarBarMenuAnimator;
      
      private var var_1524:Number = 5;
      ...
      private var var_1052:Boolean = true;
      ...
      public function ToolbarView(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IEventDispatcher)
      {
         ...
         var_198 = param1.createWindow("extrabar_container_window","",HabboWindowType.const_58,HabboWindowStyle.const_944,0 | 0,new Rectangle(0,0,1,1),null,0,0) as IWindowContainer;
         ...
         var_1052 = String(_loc7_.relocate_by_drag.@state) == "TradingItemListEvent";
         if(var_1052)
         {
         ...
         var_1279 = _loc7_.toolbar.@margin_bottom;
         var_1523 = _loc7_.toolbar.@min_group_margin;
         var_1524 = _loc7_.toolbar.@margin_to_extrabar;
         ...
         createGroupsFromXmlList(_loc8_,var_263,param1,param2,_window,var_256);
         createGroupsFromXmlList(_loc9_,var_608,param1,param2,var_198,var_256);
         alignWindows();
      }
      ...
      private function alignWindows() : void
      {
         ...
         else
         {
            ...
            if(false)
            {
               ...
               {
                  _loc7_ = Number(Math.max(var_1523,(0 - _loc6_ * _loc9_ - _toolbarMarginTop - var_1279) / -1));
               }
               else
               {
                  _loc7_ = Number(Math.max(var_1523,(0 - _loc6_ * _loc9_ - _toolbarMarginTop - var_1279) / -1));
         ...
         _loc2_ = 0;
         while(_loc2_ < var_608.length)
         {
            _loc3_ = var_608[_loc2_];
            if(_loc3_ != null)
            {
      ...
      private function getGroupForIcon(param1:String) : ToolbarIconGroup
      {
         ...
         _loc3_ = 0;
         while(_loc3_ < var_608.length)
         {
            _loc2_ = var_608[_loc3_];
            if(_loc2_.acceptsIcon(param1))
            {
               return _loc2_;
            }
