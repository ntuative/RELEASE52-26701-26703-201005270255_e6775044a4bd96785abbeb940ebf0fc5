package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_779:int = 50;
      
      private static const const_1091:Number = 25;
      ...
      private var var_1001:ToolbarView;
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         var_475.push(param2);
         param1.addEventListener(WindowEvent.const_405,windowEventListener);
         param1.addEventListener(WindowEvent.const_240,windowEventListener);
      }
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = var_1001.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
      ...
      {
         var _loc2_:Point = var_1001.getIconLoc(param1.iconId);
      ...
      {
         return param1.x + param1.width < const_779 + _toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_779 || param1.desktop.height - param1.y < const_1090;
      }
