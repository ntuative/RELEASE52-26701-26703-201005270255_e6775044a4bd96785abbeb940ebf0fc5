   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_471,0,0,_loc4_,var_1489,var_856,var_857));
         }
      }
      ...
      private function onConfigurationInit(param1:Event = null) : void
      {
         var _loc6_:* = null;
         var _loc7_:* = null;
         var_1838 = int(_config.getKey("interstitial.interval","30000"));
         var_1837 = int(_config.getKey("interstitial.show.time","5000"));
         var_1488 = int(_config.getKey("interstitial.max.displays.flash","-1"));
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         var_1489 = _loc2_.clickUrl;
         if(var_1239 != "" && var_1489 != "")
         {
            _loc3_ = var_1239;
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_375,0,0,param1.bitmapData,var_1839));
            var_712 = getTimer();
         }
         else
         {
      ...
      private function adWarningRightReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_857 = emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(var_1488 > 0 && var_1490 >= var_1488)
         {
            return false;
         }
         var _loc1_:int = getTimer() - var_712;
         if(_loc1_ > var_1838)
         {
            ++var_1490;
      ...
      {
         var_322 = param2 as IHabboCommunicationManager;
         if(var_322 == null)
         {
            return;
         }
         _connection = var_322.getHabboMainConnection(onConnectionReady);
         if(_connection != null)
         {
      ...
      private function stopInterstitial() : void
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_395));
         }
      }
