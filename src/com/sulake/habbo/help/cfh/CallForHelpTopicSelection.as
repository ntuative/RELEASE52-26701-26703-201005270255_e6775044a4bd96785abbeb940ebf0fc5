package com.sulake.habbo.help.cfh
{
   ...
   public class CallForHelpTopicSelection extends HelpViewController implements IHelpViewController
   {
      ...
      private static const const_361:int = 1;
      ...
      private function handleListItemClick(param1:IWindow) : void
      {
         ...
         if(var_733 == null || _loc3_ < 0 || _loc3_ >= var_733.length)
         {
            return;
         }
         if(_loc3_ > -1)
         {
            main.component.callForHelpData.topicIndex = var_733[_loc3_];
            main.showUI(HabboHelpViewEnum.const_703);
            main.tellUI(HabboHelpViewEnum.const_703,null);
         }
      }
   }
}
