package com.sulake.habbo.help
{
   ...
   public class IncomingMessages
   {
      ...
      private function onFaqText(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            var_22.tellUI(HabboHelpViewEnum.const_207,_loc4_);
         }
      }
      ...
      private function onFaqCategory(param1:IMessageEvent) : void
      {
         ...
         var_22.tellUI(HabboHelpViewEnum.const_282,_loc6_);
      }
      
      private function method_9(param1:int) : String
      {
         if(param1 == 1)
         {
            return "useless";
      ...
      private function onIssueClose(param1:IMessageEvent) : void
      {
         ...
         var_22.windowManager.alert("${mod.alert.title}","${help.cfh.closed." + method_9(_loc3_.closeReason) + "}",0,onAlertClose);
      }
      ...
      private function onFaqClientFaqs(param1:IMessageEvent) : void
      {
         ...
         var_22.tellUI(HabboHelpViewEnum.const_155);
      }
      ...
      {
         var_22.showUI(HabboHelpViewEnum.const_304);
      }
      ...
      private function onFaqCategories(param1:IMessageEvent) : void
      {
         ...
         var_22.showUI(HabboHelpViewEnum.const_504);
      }
      ...
      private function onFaqSearchResults(param1:IMessageEvent) : void
      {
         ...
         var_22.showUI(HabboHelpViewEnum.const_563);
         var_22.tellUI(HabboHelpViewEnum.const_563,_loc5_);
      }
      ...
      private function onUsers(param1:IMessageEvent) : void
      {
         ...
         while(_loc4_ < _loc3_.getUserCount())
         {
            ...
            if(_loc5_.webID != _userId && _loc5_.userType == RoomObjectTypeEnum.const_313)
            {
         ...
         var_22.tellUI(HabboHelpViewEnum.const_688);
      }
