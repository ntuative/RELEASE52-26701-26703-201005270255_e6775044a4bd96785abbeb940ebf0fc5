package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      private static const const_1481:int = 0;
      ...
      private var var_2259:String = "HHVE_HELP_FRONTPAGE";
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager, param4:IHabboLocalizationManager, param5:IHabboToolbar)
      {
         ...
         _windowManager.registerLocalizationParameter("info.client.version","version","26701-26703-201005270241");
         var_197 = param5;
         var_109 = new Map();
         var_109.add(HabboHelpViewEnum.const_1216,IHelpViewController(new PlaceholderView(this,_windowManager,_assetLibrary)));
         var_109.add(HabboHelpViewEnum.const_155,IHelpViewController(new HelpMainView(this,_windowManager,_assetLibrary)));
         var_109.add(HabboHelpViewEnum.const_504,IHelpViewController(new FaqBrowseTopView(this,_windowManager,_assetLibrary)));
         var_109.add(HabboHelpViewEnum.const_282,IHelpViewController(new FaqBrowseCategoryView(this,_windowManager,_assetLibrary)));
         var_109.add(HabboHelpViewEnum.const_207,IHelpViewController(new FaqBrowseEntry(this,_windowManager,_assetLibrary)));
         var_109.add(HabboHelpViewEnum.const_563,IHelpViewController(new FaqBrowseSearchResults(this,_windowManager,_assetLibrary)));
         var_109.add(HabboHelpViewEnum.const_304,IHelpViewController(new CallForHelpTopicSelection(this,_windowManager,_assetLibrary)));
         var_109.add(HabboHelpViewEnum.const_703,IHelpViewController(new CallForHelpTextInput(this,_windowManager,_assetLibrary)));
         var_109.add(HabboHelpViewEnum.const_206,IHelpViewController(new CallForHelpSentView(this,_windowManager,_assetLibrary,"help_cfh_thanks")));
         ...
         var_109.add(HabboHelpViewEnum.const_1029,IHelpViewController(new CallForHelpPendingItemView(this,_windowManager,_assetLibrary)));
         var_109.add(HabboHelpViewEnum.const_688,IHelpViewController(new CallForHelpReportUserSelection(this,_windowManager,_assetLibrary)));
      }
      ...
      private function addBackButtonWindow() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(var_285 == HabboHelpViewEnum.const_155 || false)
         {
            return;
         }
         if(var_449 == null)
      ...
      {
         var_2258 = param1;
         var _loc2_:IHelpViewController = var_109.getValue(HabboHelpViewEnum.const_155) as IHelpViewController;
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_206:
               ...
               break;
            case CallForHelpResultEnum.const_843:
               showUI(HabboHelpViewEnum.const_1029);
               break;
      ...
      {
         var _loc3_:* = null;
         if(var_285 == HabboHelpViewEnum.const_155)
         {
            return;
         }
         if(true)
         {
            ...
            var_647.push(_loc3_.content as BitmapData);
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(var_647[1],var_647[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(var_647[0],var_647[0].rect,new Point(0,0));
         }
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         if(_loc3_)
         {
            if(var_197 != null)
            {
               var_197.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_51,HabboToolbarIconEnum.HELP,_window));
            }
         }
      ...
      public function handleCallGuideBot() : void
      {
         ...
         hideUI();
         var_22.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_426));
      }
