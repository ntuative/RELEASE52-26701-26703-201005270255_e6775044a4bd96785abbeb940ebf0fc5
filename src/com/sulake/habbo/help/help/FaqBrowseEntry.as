package com.sulake.habbo.help.help
{
   ...
   public class FaqBrowseEntry extends SearchViewController implements IHelpViewController
   {
      ...
      override public function update(param1:* = null) : void
      {
         ...
         if(true)
         {
            main.sendMessage(new GetFaqTextMessageComposer(var_245.questionId));
            return;
         }
         var _loc3_:FaqCategory = var_245.category;
         if(_loc3_ == null)
         {
            return;
         }
         ...
         if(_loc4_ != null)
         {
            _loc4_.text = var_245.questionText;
         }
         _loc4_ = container.findChildByTag("faq_answer_text") as ITextWindow;
         if(_loc4_ != null)
         {
            _loc4_.htmlText = hackHTML(var_245.answerText);
         }
         if(_loc3_ != null)
         {
      ...
      override public function windowProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "help_faq_back":
               if(var_245 != null)
               {
                  _loc3_ = var_245.category;
                  main.showUI(HabboHelpViewEnum.const_282);
                  main.tellUI(HabboHelpViewEnum.const_282,_loc3_);
               }
               break;
      ...
      private function getNextItem() : FaqItem
      {
         ...
         var _loc2_:FaqCategory = var_245.category;
         if(_loc2_ == null)
         {
            return null;
         }
