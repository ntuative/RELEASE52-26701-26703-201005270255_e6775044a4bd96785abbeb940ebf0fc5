package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialUI implements INameChangeUI
   {
      ...
      public static const const_205:String = "TUI_NAME_VIEW";
      ...
      public function TutorialUI(param1:HabboHelp)
      {
         super();
         _main = param1;
         _main.events.addEventListener(HabboHelpTutorialEvent.const_426,onTaskDoneEvent);
         _main.events.addEventListener(HabboHelpTutorialEvent.const_486,onTaskDoneEvent);
         _main.events.addEventListener(HabboHelpTutorialEvent.const_489,onTaskDoneEvent);
      }
      ...
      public function prepareForTutorial() : void
      {
         ...
         _main.hideUI();
         _main.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_115));
      }
      ...
      public function update(param1:Boolean, param2:Boolean, param3:Boolean) : void
      {
         ...
         var_1019 = param2;
         var_1020 = param3;
         if(var_33 == null || var_33.id == const_90)
         {
            prepareForTutorial();
            showView(const_90);
         }
      ...
      public function onUserNameChanged(param1:String) : void
      {
         ...
         if(var_33 != null && (var_33.id == const_205 || var_33.id == const_90))
         {
            showView(const_90);
         }
      }
      ...
      public function onChangeUserNameResult(param1:ChangeUserNameResultMessageEvent) : void
      {
         ...
         if(_loc2_.resultCode != ChangeUserNameResultMessageEvent.var_652)
         {
            showView(const_205);
      ...
      public function dispose() : void
      {
         ...
         if(_main)
         {
            _main.events.removeEventListener(HabboHelpTutorialEvent.const_426,onTaskDoneEvent);
            _main.events.removeEventListener(HabboHelpTutorialEvent.const_486,onTaskDoneEvent);
            _main.events.removeEventListener(HabboHelpTutorialEvent.const_489,onTaskDoneEvent);
            _main = null;
         }
      }
      ...
      public function onTaskDoneEvent(param1:HabboHelpTutorialEvent) : void
      {
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_426:
               var_1020 = true;
               if(var_33 != null && var_33.id == const_445)
               {
                  showView(const_90);
               }
               break;
      ...
      {
         var_1018 = true;
         if(var_33 != null && (var_33.id == const_352 || var_33.id == const_90))
         {
            showView(const_90);
         }
      }
      ...
      {
         return var_1018 && var_1019 && var_1020;
      }
   }
}
