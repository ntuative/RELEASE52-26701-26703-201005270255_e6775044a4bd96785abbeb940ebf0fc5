package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_1647:PseudoRandom;
      
      private var _windowManager:IHabboWindowManager;
      
      private var _habboConfiguration:IHabboConfigurationManager;
      
      private var var_1423:ILogger;
      
      private var var_1143:String;
      
      private var var_1648:String;
      
      private const const_1451:String = "fuselogin";
      
      private var var_322:ICoreCommunicationManager;
      
      private var var_388:IKeyExchange;
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !var_1646)
         {
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(var_667 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(var_667);
            _loc2_.send(_loc4_);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         param1.send(new VersionCheckMessageComposer(401,var_1143,var_1648));
         var _loc2_:String = "";
         var _loc3_:SharedObject = SharedObject.getLocal(const_1451,"/");
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var_388.generateSharedKey(_loc4_,10);
         var _loc5_:String = var_388.getSharedKey(16).toUpperCase();
         var _loc6_:RC4_R27 = new RC4_R27(null,null);
         var _loc7_:IEncryption = new RC4_R27(_loc6_,var_1647);
      ...
      private function onUniqueMachineId(param1:UniqueMachineIDEvent) : void
      {
         ...
         var _loc2_:SharedObject = SharedObject.getLocal(const_1451,"/");
      ...
      {
         var_667 = _habboConfiguration.getKey("sso.ticket",null);
         var_1143 = _habboConfiguration.getKey("flash.client.url","");
         var_1648 = _habboConfiguration.getKey("external.variables.txt","");
         if(var_169 == null)
         {
         ...
         if(var_667 != null)
         {
            var_60.mode = HabboConnectionType.const_408;
            var_60.initConnection(HabboConnectionType.const_259);
         }
      }
      
      private function receiveLoggerInterface(param1:IID, param2:IUnknown) : void
      {
         var_1423 = param2 as ILogger;
      }
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         var_1647 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(var_60.mode)
         {
            case HabboConnectionType.const_408:
               _loc6_ = "";
               ...
               var_980 = _loc4_;
               var_169.loadBannerImage(_loc7_ + "?token=" + var_980,onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1014:
               sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1278:
               var_563 = generateRandomHexString(30);
               var_388 = new DiffieHellman(new BigInteger(_habboConfiguration.getKey("connection.development.prime"),16),new BigInteger(_habboConfiguration.getKey("connection.development.generator"),16));
               var_388.init(var_563);
               _loc8_ = var_388.getPublicKey(10);
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,var_980);
         ...
         var_388 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 10;
         var _loc14_:* = null;
         while(_loc13_ > 0)
         {
            _loc14_ = generateRandomHexString(30);
            var_388.init(_loc14_);
            _loc15_ = var_388.getPublicKey(10);
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               var_60.mode = HabboConnectionType.const_1014;
            }
         }
         var_60.initConnection(HabboConnectionType.const_259);
      }
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         dispatchLoginStepEvent(HabboCommunicationEvent.const_245);
      }
