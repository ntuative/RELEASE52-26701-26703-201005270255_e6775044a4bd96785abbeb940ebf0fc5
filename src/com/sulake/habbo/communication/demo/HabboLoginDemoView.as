package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      private var var_238:HabboCommunicationDemo;
      ...
      {
         var_238.windowManager.removeWindow("habbo_login_window");
      }
      ...
      private function onParsedTicketSuccess(param1:Event) : void
      {
         ...
         var_238.shockwaveClientUrl = var_116.shockwaveClientUrl;
         var_238.ssoTicket = var_116.ticket;
         var_116.removeEventListener(SSOTicket.const_305,onParsedTicketSuccess);
         var_116.removeEventListener(SSOTicket.const_270,onParsedTicketFailure);
         var_116 = null;
      ...
      private function windowEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            _loc6_ = SharedObject.getLocal(const_1451,"/");
      ...
      {
         var _loc1_:XmlAsset = (var_238 as Component).assets.getAssetByName("login_window") as XmlAsset;
         if(_loc1_ == null)
         {
            Logger.log("Could  not find embedded Window XML for Login Window, login_window");
            return;
         }
         _window = var_238.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_110,HabboWindowStyle.const_42,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         var _loc2_:XML = _loc1_.content as XML;
         var _loc3_:IWindowContainer = var_238.windowManager.buildFromXML(_loc2_) as IWindowContainer;
         ...
         if(_loc4_ != null)
         {
            _loc4_.addEventListener(WindowMouseEvent.const_104,windowEventProcessor);
         }
         else
         {
            Logger.log("Could not find the button");
         }
         var _loc7_:SharedObject = SharedObject.getLocal(const_1451,"/");
         if(_loc5_ != null)
         {
      ...
      private function listEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_238.sendTryLogin(name,password,param2.id);
      }
      ...
      private function initSSOTicket() : void
      {
         ...
         if(false)
         {
            _loc1_ = var_238.habboConfiguration.getKey("url.prefix",_loc1_);
            _loc1_ = _loc1_.replace("http://","");
            _loc1_ = _loc1_.replace("https://","");
         }
         var _loc2_:IHabboWebLogin = var_238.habboCommunication.habboWebLogin(name,password);
         var_116 = new SSOTicket(var_238.assets,_loc2_,_loc1_);
         var_116.addEventListener(SSOTicket.const_305,onParsedTicketSuccess);
         var_116.addEventListener(SSOTicket.const_270,onParsedTicketFailure);
      }
      ...
      public function populateUserList(param1:Map) : void
      {
         ...
         var _loc3_:XmlAsset = var_238.assets.getAssetByName("login_user_list_item") as XmlAsset;
         var _loc4_:IWindow = var_238.windowManager.buildFromXML(_loc3_.content as XML);
