package com.sulake.habbo.communication.demo
{
   ...
   public class HabboHotelView implements IDisposable
   {
      ...
      private var var_630:Function;
      
      private var _window:IWindowContainer;
      
      private var var_766:IAssetLibrary;
      
      private var var_925:uint = 0;
      
      private var var_629:Function;
      ...
      private function hotelViewLoadedCallbackHandler(param1:AssetLoaderEvent) : void
      {
         ...
         else if(param1.type == AssetLoaderEvent.const_36)
         {
            if(_events != null)
            {
               _events.dispatchEvent(new Event(HabboHotelViewEvent.const_498));
            }
      ...
      {
         var _loc3_:AssetLoaderStruct = var_766.loadAssetFromFile("hotel_view_banner_" + var_925,new URLRequest(param1),"image/png");
         if(param2 == null)
         {
         ...
         else
         {
            if(_events != null)
            {
               _events.dispatchEvent(new Event(HabboHotelViewEvent.const_651));
            }
            var_629 = param2;
