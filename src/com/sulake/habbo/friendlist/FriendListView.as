package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private static const const_1456:String = "noconvinfo";
      
      private static const const_1457:String = "messageinput";
      ...
      private var var_1187:FriendListTabsView;
      ...
      public function FriendListView(param1:HabboFriendList)
      {
         super();
         _friendList = param1;
         var_1187 = new FriendListTabsView(_friendList);
      }
      ...
      private function prepare() : void
      {
         ...
         var_861 = IWindowContainer(var_15.content.findChildByName("main_content"));
         var_264 = IWindowContainer(var_15.content.findChildByName("footer"));
         var_1187.prepare(var_861);
         var_15.procedure = onWindow;
         var_15.content.setParamFlag(HabboWindowParam.const_966,false);
         var_15.content.setParamFlag(HabboWindowParam.const_1272,true);
         var_15.header.setParamFlag(HabboWindowParam.const_606,false);
         var_15.header.setParamFlag(HabboWindowParam.const_1026,true);
         var_15.content.setParamFlag(HabboWindowParam.const_606,false);
         var_15.content.setParamFlag(HabboWindowParam.const_1026,true);
         var_15.findChildByName("open_edit_ctgs_but").procedure = onEditCategoriesButtonClick;
         var_1188 = ITextWindow(var_15.findChildByName("info_text"));
         var_1188.text = "";
      ...
      private function refreshWindowSize() : void
      {
         ...
         var_264.y = Util.getLowestPoint(var_15.content);
         ...
         var_15.scaler.setParamFlag(HabboWindowParam.const_1015,this._friendList.tabs.findSelectedTab() != null);
         var_15.scaler.setParamFlag(HabboWindowParam.const_606,false);
         var_15.scaler.setParamFlag(HabboWindowParam.const_966,false);
         var_15.scaler.x = 0 - var_15.scaler.width;
         var_15.scaler.y = 0 - var_15.scaler.height;
         var_1453 = var_15.height;
         var_1452 = var_15.width;
      ...
      private function onWindow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = var_1453 == -1 ? 0 : int(0 - var_1453);
         var _loc4_:int = var_1452 == -1 ? 0 : int(0 - var_1452);
