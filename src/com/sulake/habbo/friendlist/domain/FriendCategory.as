package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategory implements IDisposable
   {
      ...
      {
         return Math.ceil(this.var_242.length / const_340);
      }
      ...
      public function addFriend(param1:Friend) : void
      {
         ...
         while(_loc3_ < var_242.length)
         {
            ...
            {
               var_242.splice(_loc3_,0,param1);
               return;
            }
            _loc3_++;
         }
      ...
      {
         checkPageIndex();
         return Math.min((this.var_907 + 1) * const_340,this.var_242.length);
      }
