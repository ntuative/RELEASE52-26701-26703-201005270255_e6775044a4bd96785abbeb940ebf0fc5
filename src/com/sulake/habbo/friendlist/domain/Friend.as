package com.sulake.habbo.friendlist.domain
{
   ...
   public class Friend implements IFriend, IDisposable
   {
      ...
      public static const const_1697:int = "M".charCodeAt(0);
      ...
      public function Friend(param1:FriendData)
      {
         ...
         _id = param1.id;
         _name = param1.name;
         var_602 = param1.gender;
         var_754 = param1.online;
         var_1191 = param1.followingAllowed && param1.online;
         var_303 = param1.figure;
         var_1321 = param1.motto;
         var_1322 = param1.lastAccess;
         var_1223 = param1.categoryId;
         var_1320 = param1.realName;
