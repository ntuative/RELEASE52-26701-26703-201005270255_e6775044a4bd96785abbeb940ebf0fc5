package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList
   {
      ...
      private var var_1510:OpenedToWebPopup;
      
      private var var_820:IAvatarRenderManager;
      
      private var var_197:IHabboToolbar;
      
      private var var_452:FriendListTabs;
      ...
      private var var_1509:AvatarSearchResults;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_597:ISessionDataManager;
      
      private var var_354:FriendRequests;
      
      private var var_1902:int;
      
      var var_91:FriendCategories;
      
      private var var_1903:FriendListLookAndFeel;
      ...
      {
         var_1903 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         var_91 = new FriendCategories(new FriendCategoriesDeps(this));
         var_1509 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         var_354.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            var_354.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            var_452.findTab(FriendListTab.const_88).setNewMessageArrived(true);
            refreshToolBarIcon();
         }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         var_354 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit,_loc2_.evenMoreExtendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            var_91.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         var_91.addCategory(new FriendCategory(FriendCategory.const_1006,getText("friendlist.friends")));
         var_91.addCategory(new FriendCategory(FriendCategory.const_503,getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in getSortedFriends(_loc2_.friends))
         {
            var_91.addFriend(new Friend(_loc4_));
         }
         var_452 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!var_494)
         {
         ...
         getBuddyRequests();
         registerListeners();
         var_197.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_117,HabboToolbarIconEnum.FRIENDLIST));
      ...
      override public function dispose() : void
      {
         ...
         if(var_130)
         {
            var_130.release(new IIDHabboMessenger());
            var_130 = null;
         }
         if(var_151)
         {
         ...
         if(var_820)
         {
            var_820.release(new IIDAvatarRenderManager());
            var_820 = null;
         }
         if(var_868)
         {
            var_868.release(new IIDHabboNotifications());
            var_868 = null;
         }
         if(var_197)
         {
         ...
         if(var_597)
         {
            var_597.release(new IIDSessionDataManager());
            var_597 = null;
         }
         super.dispose();
      }
      ...
      public function isEmbeddedMinimailEnabled() : Boolean
      {
         ...
         return _loc1_ == "TradingItemListEvent";
      }
      ...
      private function toggleWindow() : void
      {
         ...
         {
            _view.openFriendList();
            _loc1_ = var_452.findSelectedTab();
            if(_loc1_ == null)
            {
      ...
      {
         var_197 = IHabboToolbar(param2) as IHabboToolbar;
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         var_1509.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      public function refreshToolBarIcon() : void
      {
         ...
         _loc1_.iconState = String(var_354.getCountOfOpenRequests() > 0 ? "2" : "0");
         var_197.events.dispatchEvent(_loc1_);
      }
      ...
      private function onUserRights(param1:IMessageEvent) : void
      {
         ...
         var _loc2_:int = 0;
         if(var_597.hasUserRight("fuse_super_extended_buddylist"))
         {
            _loc2_ = 0;
         }
         else if(var_597.hasUserRight("fuse_extended_buddylist"))
         {
            _loc2_ = 0;
         }
         if(_loc2_ > var_354.limit)
         {
            var_354.limit = _loc2_;
         }
      }
      
      public function declineFriendRequest(param1:int) : void
      {
         var _loc2_:FriendListTab = var_452.findTab(FriendListTab.const_88);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         var _loc2_:IAvatarImage = var_820.createAvatarImage(param1,AvatarScaleType.SMALL);
         if(!_loc2_)
         {
            return null;
         }
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var_354.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = var_452.findTab(FriendListTab.const_88);
      ...
      {
         var_868 = param2 as IHabboNotifications;
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         if(var_1510 == null)
         {
            var_1510 = new OpenedToWebPopup(this);
         }
         var_1510.show(x,y);
      }
