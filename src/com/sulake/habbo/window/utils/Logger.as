package com.sulake.habbo.window.utils
{
   ...
   public class Logger extends Component implements ILogger
   {
      ...
      private var var_346:ITextWindow;
      ...
      private function windowManagerReceived(param1:IID, param2:IUnknown) : void
      {
         ...
         _window = var_1471.create("Logger::Output",HabboWindowType.const_110,WindowStyle.const_318,0 | 0 | 0 | 0,new Rectangle(0,0,180,240),loggerEventProc,"Logger") as IFrameWindow;
         var_346 = var_1471.create("Logger::Output::Text",HabboWindowType.const_1,WindowStyle.const_318,0 | 0 | 0,new Rectangle(0,0,_window.content.width,_window.content.height),null,"") as ITextWindow;
         var_346.multiline = true;
         var_346.background = true;
         var_346.border = true;
         var_346.fontFace = "Volter";
         var_346.fontSize = 9;
         IWindowContainer(_window.findChildByName("content_area")).addChild(var_346);
