package com.sulake.habbo.widget.infostand
{
   ...
   public class InfostandWidget extends RoomWidgetBase
   {
      ...
      private var var_1388:InfoStandPetData;
      ...
      private var var_364:InfoStandBotView;
      ...
      private const const_1466:String = "infostand_pet_view";
      
      private const const_1468:String = "infostand_furni_view";
      
      private const const_1730:int = 3000;
      ...
      public function InfostandWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager)
      {
         ...
         _config = param4;
         var_892 = new InfoStandFurniView(this,const_1468);
         var_201 = new InfoStandUserView(this,const_1467);
         var_313 = new InfoStandPetView(this,const_1466);
         var_364 = new InfoStandBotView(this,const_1465);
         var_429 = new InfostandUserData();
         var_450 = new InfostandFurniData();
         var_1388 = new InfoStandPetData();
         var_136 = new Timer(const_1730);
      ...
      private function onUserTags(param1:RoomWidgetUserTagsUpdateEvent) : void
      {
         ...
         {
            var_201.setTags(param1.tags,var_1999);
         }
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_237,onClose);
         ...
         param1.addEventListener(RoomWidgetBadgeImageUpdateEvent.const_707,onBadgeImage);
         param1.addEventListener(RoomWidgetPetInfoUpdateEvent.const_157,onPetInfo);
      ...
      private function onUpdateTimer(param1:TimerEvent) : void
      {
         ...
         messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_492,var_313.getCurrentPetId()));
      }
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_237,onClose);
         ...
         param1.removeEventListener(RoomWidgetBadgeImageUpdateEvent.const_707,onBadgeImage);
         param1.removeEventListener(RoomWidgetPetInfoUpdateEvent.const_157,onPetInfo);
      ...
      private function onBadgeImage(param1:RoomWidgetBadgeImageUpdateEvent) : void
      {
         ...
         if(_loc2_ >= 0)
         {
            if(userData.isBot())
            {
               var_364.setBadgeImage(_loc2_,param1.badgeImage);
            }
            else
            {
      ...
      public function get mainContainer() : IWindowContainer
      {
         ...
         {
            _mainContainer = windowManager.createWindow("infostand_main_container","",HabboWindowType.const_58,HabboWindowStyle.const_42,HabboWindowParam.const_42,new Rectangle(0,0,50,100)) as IWindowContainer;
      ...
      private function onRoomObjectRemoved(param1:RoomWidgetRoomObjectUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetRoomObjectUpdateEvent.const_257:
               ...
               {
                  _loc2_ = param1.id == var_1388.roomIndex;
                  break;
               }
               if(var_364 != null && false && var_364.window.visible)
               {
                  _loc2_ = param1.id == var_429.userRoomId;
                  break;
               }
