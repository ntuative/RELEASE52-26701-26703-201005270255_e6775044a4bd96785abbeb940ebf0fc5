package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_1739:uint = 6710886;
      
      private var _window:IItemListWindow;
      
      private const const_1745:String = "level";
      
      private var var_110:IItemListWindow;
      
      private const const_1741:String = "energy";
      
      private var var_1388:Map;
      
      private const const_1740:String = "nutrition";
      ...
      private const const_1743:int = 16;
      
      private var _widget:InfostandWidget;
      
      private var var_185:PetCommandTool;
      
      private const const_1744:uint = 11184810;
      
      private const const_1742:String = "experience";
      ...
      private function createWindow(param1:String) : void
      {
         ...
         var_249 = _window.getListItemByName("info_border") as IBorderWindow;
         if(var_249 != null)
         {
            var_110 = var_249.findChildByName("infostand_element_list") as IItemListWindow;
         }
         _window.name = param1;
         _widget.mainContainer.addChild(_window);
         var _loc3_:IWindow = var_249.findChildByTag("close");
         if(_loc3_ != null)
         {
         ...
         var _loc6_:IBitmapWrapperWindow = var_249.findChildByName("petrespect_icon") as IBitmapWrapperWindow;
         if(_loc6_ != null)
         {
      ...
      {
         if(var_110 == null || var_249 == null || var_64 == null)
         {
            return;
         }
         ...
         var_249.height = NaN;
         _window.width = Math.max(var_249.width,var_64.width);
      ...
      private function openTrainView() : void
      {
         ...
         var _loc1_:InfoStandPetData = var_1388.getValue(var_564) as InfoStandPetData;
         if(_loc1_ != null)
         {
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         ageText = param1.age;
         updateStateElement(const_1745,param1.level,param1.levelMax);
         updateStateElement(const_1742,param1.experience,param1.experienceMax);
         updateStateElement(const_1741,param1.energy,param1.energyMax);
         updateStateElement(const_1740,param1.nutrition,param1.nutritionMax);
         ...
         updateWindow();
         var_564 = param1.id;
         var_1388.remove(param1.id);
         var_1388.add(param1.id,param1);
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(var_185 && var_185.getPetId() == var_564)
               {
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_488,_widget.petData.ownerId);
      ...
      private function createPercentageBar(param1:int, param2:int) : BitmapData
      {
         ...
         var _loc5_:BitmapData = new BitmapData(const_1738,const_1743,false);
         _loc5_.fillRect(new Rectangle(0,0,_loc5_.width,_loc5_.height),const_1744);
         ...
         _loc5_.fillRect(_loc7_,const_1739);
         return _loc5_;
      }
