package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_520:int = 16;
      
      private static const const_1077:int = 20;
      
      private static const const_370:int = 10;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         var_988 = _localization.getKey("widgets.chatinput.mode.whisper",":tell");
         var_1700 = _localization.getKey("widgets.chatinput.mode.shout",":shout");
         var_1702 = _localization.getKey("widgets.chatinput.mode.speak",":speak");
         var_674 = new Timer(1000,1);
         var_674.addEventListener(TimerEvent.TIMER_COMPLETE,onTypingTimerComplete);
         var_804 = new Timer(5000,1);
         var_804.addEventListener(TimerEvent.TIMER_COMPLETE,onIdleTimerComplete);
         createWindow();
         refreshView();
      }
      ...
      private function createWindow() : void
      {
         ...
         _window = _windowManager.createWindow("chatinput_widget_window","",HabboWindowType.const_58,HabboWindowStyle.const_42,0 | 0,new Rectangle(300,400,400,30),null) as IWindowContainer;
         ...
         _loc4_.addEventListener(WindowKeyboardEvent.const_158,windowKeyEventProcessor);
         ...
         _window.addEventListener(WindowEvent.const_405,onWindowMoved);
         var_1164 = true;
         var_124 = "";
      }
      ...
      private function refreshView() : void
      {
         ...
         var _loc12_:* = 0;
         var _loc13_:* = 0;
         var_1701 = _loc2_.width + const_520 + _loc6_.width + const_1077;
         if(_loc7_ != null)
         {
         ...
         if(_loc8_ != null)
         {
            _loc13_ = Number(Math.max(const_1078,_loc8_.width) + const_520);
            _loc8_.x = _loc12_;
      ...
      private function windowKeyEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc4_ == Keyboard.BACKSPACE)
         {
            ...
            if(_loc8_ != null)
            {
               ...
               if(_loc10_[0] == var_988 && _loc10_.length == 3 && _loc10_[2] == "")
               {
                  _loc8_.text = "";
                  var_124 = "";
               }
      ...
      public function setMaxWidth(param1:Number) : void
      {
         ...
         {
            _loc3_ = Math.min(int(_loc2_.textWidth),var_434);
         }
         else
         {
            _loc3_ = Math.min(_loc3_,var_434);
         }
