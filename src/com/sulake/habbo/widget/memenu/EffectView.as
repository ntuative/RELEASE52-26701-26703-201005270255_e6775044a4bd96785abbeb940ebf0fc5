   ...
   public class EffectView
   {
      ...
      private function createWindow(param1:String) : void
      {
         ...
         else
         {
            ...
            var_873 = _window.findChildByName("effect_hilite");
            var_873.visible = false;
         }
         var_875 = _window.findChildByName("time_left") as ITextWindow;
         setTimeLeft();
         var_874 = _window.findChildByName("loader_bar");
         if(var_874 != null)
         {
            var_434 = var_874.width;
            var_180.start();
            onUpdate();
         }
         if(false)
      ...
      private function setTimeLeft() : void
      {
         ...
         if(var_875 != null)
         {
            var_875.caption = "${widgets.memenu.effects.active.timeleft}";
            _loc1_ = "null";
            if(false)
            {
               _loc2_ = 0;
            ...
            {
               var_875.caption = "${widgets.memenu.effects.activate}";
            }
         }
      }
