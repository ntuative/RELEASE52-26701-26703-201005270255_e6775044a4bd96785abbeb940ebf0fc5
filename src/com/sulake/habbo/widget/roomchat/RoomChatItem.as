package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatItem
   {
      ...
      private static const const_520:int = 6;
      
      private static const const_370:int = 10;
      
      private static const const_1172:Number = 18;
      
      private static const const_1483:Number = 10;
      
      private static const const_1482:Number = 8;
      ...
      {
         _widget.onItemMouseClick(var_1121,var_787,var_1122,_roomId,_roomCategory,param1);
      }
      ...
      private function addEventListenerToChild(param1:IWindow) : void
      {
         if(param1 != null)
         {
            ...
            param1.addEventListener(WindowMouseEvent.const_104,onBubbleMouseUp);
         }
      }
      ...
      public function renderView() : void
      {
         ...
         if(_loc18_ != null)
         {
            ...
            if(var_1123 != 0)
            {
               _loc30_ = uint(var_1123 >> 16 & 255);
               _loc31_ = uint(var_1123 >> 8 & 255);
               _loc32_ = uint(var_1123 >> 0 & 255);
            }
         ...
         if(_loc19_ != null)
         {
            if(_loc2_)
            {
               _width += _loc19_.textWidth + const_370;
            }
            else
            {
               _loc19_.text = var_787 + ":";
               _loc19_.y += var_453;
               _loc19_.width = _loc19_.textWidth + const_370;
               _width += _loc19_.textWidth + const_370;
            }
         }
         if(_loc20_ != null)
         {
            if(var_1395 == RoomWidgetChatUpdateEvent.const_254)
            {
               _loc20_.text = _localizations.registerParameter("widgets.chatbubble.respect","username",var_787);
            }
            else if(var_1395 == RoomWidgetChatUpdateEvent.const_287)
            {
               _loc20_.text = _localizations.registerParameter("widget.chatbubble.petrespect","petname",var_787);
            }
            else
            {
            ...
            _loc20_.x = _width;
            _loc20_.y += var_453;
            _loc20_.width = _loc20_.textWidth + const_520;
            _width += _loc20_.textWidth + const_520;
         }
         if(_loc22_ != null)
         {
            _loc22_.width = _loc19_.textWidth + const_370 + _loc20_.textWidth + const_520;
            _loc37_ = new Matrix();
