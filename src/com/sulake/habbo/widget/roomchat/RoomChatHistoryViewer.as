package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryViewer implements IDisposable
   {
      ...
      public function RoomChatHistoryViewer(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         var_152.state = RoomChatHistoryPulldown.const_214;
         ...
         var_45 = param2.createWindow("chatscroller","",HabboWindowType.const_899,HabboWindowStyle.const_42,0 | 0,new Rectangle(param3.rectangle.right - SCROLLBAR_WIDTH,param3.y,SCROLLBAR_WIDTH,param3.height - 0),null,0) as IScrollbarWindow;
      ...
      {
         return !!var_304 ? Number(SCROLLBAR_WIDTH) : Number(0);
      }
      ...
      private function processDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(var_228 > 0 && param2)
         {
            if(var_1229)
            {
               if(Math.abs(param1 - var_228) <= const_908)
               {
                  return;
               }
               var_1229 = false;
            ...
            if(var_304)
            {
               ...
               _loc7_ = true;
               _loc8_ = true;
               if(var_45.scrollV < 1 - const_1106 / var_45.scrollable.scrollableRegion.height)
               {
                  _loc8_ = false;
               }
               if(_loc8_ || var_1481)
      ...
      public function showHistoryViewer() : void
      {
         if(!var_304 && !var_1330)
         {
            ...
            var_152.state = RoomChatHistoryPulldown.const_336;
            if(_widget != null)
            {
      ...
      public function set visible(param1:Boolean) : void
      {
         ...
         var_152.state = param1 == true ? 0 : int(RoomChatHistoryPulldown.const_214);
      }
