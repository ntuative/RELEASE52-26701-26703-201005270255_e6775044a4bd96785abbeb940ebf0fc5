package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryPulldown
   {
      ...
      private static const const_780:int = 150;
      
      private static const const_781:int = 250;
      ...
      public function RoomChatHistoryPulldown(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         var_39 = param3;
         var_1765 = (_assetLibrary.getAssetByName("chat_grapbar_bg") as BitmapDataAsset).content as BitmapData;
         var_1456 = (_assetLibrary.getAssetByName("chat_grapbar_grip") as BitmapDataAsset).content as BitmapData;
         var_1767 = (_assetLibrary.getAssetByName("chat_grapbar_handle") as BitmapDataAsset).content as BitmapData;
         var_1458 = (_assetLibrary.getAssetByName("chat_grapbar_x") as BitmapDataAsset).content as BitmapData;
         var_1457 = (_assetLibrary.getAssetByName("chat_grapbar_x_hi") as BitmapDataAsset).content as BitmapData;
         var_1763 = (_assetLibrary.getAssetByName("chat_grapbar_x_pr") as BitmapDataAsset).content as BitmapData;
         var_1766 = (_assetLibrary.getAssetByName("chat_history_bg") as BitmapDataAsset).content as BitmapData;
         var_73 = _windowManager.createWindow("chat_history_bg","",HabboWindowType.BITMAP_WRAPPER,HabboWindowStyle.const_43,HabboWindowParam.const_74,new Rectangle(0,0,param3.width,param3.height - const_80),null,0,0) as IBitmapWrapperWindow;
         var_39.addChild(var_73);
         _window = _windowManager.createWindow("chat_pulldown","",HabboWindowType.const_58,HabboWindowStyle.const_43,HabboWindowParam.const_44,new Rectangle(0,0 - const_80,param3.width,const_80),null,0) as IWindowContainer;
         var_39.addChild(_window);
         var_99 = _windowManager.createWindow("REGIONchat_pulldown","",WindowType.const_477,HabboWindowStyle.const_42,0 | 0 | 0 | 0,new Rectangle(0,0,param3.width,param3.height - const_80),null,0) as IRegionWindow;
         if(var_99 != null)
         {
            var_99.background = true;
            var_99.mouseTreshold = 0;
            var_99.addEventListener(WindowMouseEvent.const_55,onPulldownMouseDown);
            var_39.addChild(var_99);
         ...
         if(_loc6_ != null)
         {
            ...
            _loc6_.addEventListener(WindowMouseEvent.const_104,onCloseButtonMouseUp);
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            case const_501:
               var_73.blend += param1 / const_781;
               _window.blend += param1 / const_781;
               if(false)
               {
                  state = const_336;
               }
               break;
            case const_796:
               var_73.blend = 0 - param1 / const_780;
               _window.blend = 0 - param1 / const_780;
               if(true)
               {
                  state = const_214;
               }
      ...
      private function buildWindowGraphics() : void
      {
         ...
         if(var_1764 == _window.width)
         {
            return;
         }
         var_1764 = _window.width;
         ...
         if(_loc1_ != null && _loc3_ != null && _loc4_ != null)
         {
            if(_loc1_.width > 0 && _loc1_.height > 0)
            {
               ...
               tileBitmapHorz(var_1765.clone(),_loc7_);
