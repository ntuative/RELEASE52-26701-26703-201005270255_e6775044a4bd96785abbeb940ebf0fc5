package com.sulake.habbo.widget.furniture.clothingchange
{
   ...
   public class ClothingChangeFurnitureWidget extends RoomWidgetBase
   {
      ...
      private static const const_819:String = "Girl";
      
      private static const const_818:String = "Boy";
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetClothingChangeUpdateEvent.const_315,onUpdate);
         param1.addEventListener(RoomWidgetClothingChangeUpdateEvent.const_856,onUpdate);
      ...
      private function showGenderSelectionInterface(param1:RoomWidgetClothingChangeUpdateEvent) : void
      {
         ...
         var_1814 = param1.objectCategory;
         ...
         _window = windowManager.createWindow("clothing change gender selection","",HabboWindowType.const_58,HabboWindowStyle.const_42,0 | 0 | 0 | 0,new Rectangle(100,100,200,200),null,0) as IWindowContainer;
         ...
         _loc4_ = _window.findChildByName(const_819);
         if(_loc4_ != null)
         {
            _loc4_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onGenderSelectionMouseEvent);
         }
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetClothingChangeUpdateEvent.const_315,onUpdate);
         param1.removeEventListener(RoomWidgetClothingChangeUpdateEvent.const_856,onUpdate);
      ...
      private function requestEditor(param1:String) : void
      {
         ...
         var_646 = _loc4_;
         var_646.offset(100,100);
         var _loc6_:IWindow = var_646.findChildByTag("close");
         if(_loc6_ != null)
         {
            _loc6_.procedure = onEditorWindowClose;
         }
         var _loc7_:* = null;
         _loc7_ = new RoomWidgetClothingChangeMessage(RoomWidgetClothingChangeMessage.const_322,param1,var_162,var_1814,_roomId,_roomCategory,_loc5_);
      ...
      private function hideEditorInterface() : void
      {
         ...
         if(var_646 != null)
         {
            _loc1_ = var_646 as IFrameWindow;
            if(_loc1_ != null)
            {
