package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerViewColorGrid
   {
      ...
      private function populateColourGrid(param1:IHabboWindowManager) : void
      {
         ...
         {
            _loc3_ = param1.buildFromXML(var_1333) as IWindowContainer;
            _loc3_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onClick);
            _loc3_.background = true;
            _loc3_.color = 4294967295;
            _loc3_.width = var_516.width;
            _loc3_.height = var_516.height;
            var_426.addGridItem(_loc3_);
            _loc4_ = _loc3_.findChildByTag("BG_BORDER") as IBitmapWrapperWindow;
            if(_loc4_ != null)
            {
               _loc4_.bitmap = new BitmapData(var_516.width,var_516.height,true,0);
               _loc4_.bitmap.copyPixels(var_516,var_516.rect,new Point(0,0));
            }
            ...
            if(_loc6_ != null)
            {
               _loc6_.bitmap = new BitmapData(var_759.width,var_759.height,true,16777215);
               _loc6_.bitmap.copyPixels(var_759,var_759.rect,new Point(0,0),null,null,true);
      ...
      {
         var _loc2_:int = var_426.getGridItemIndex(param1.target as IWindow);
      ...
      public function setSelectedColorIndex(param1:int) : void
      {
         ...
         if(param1 < 0 || param1 >= var_426.numGridItems)
         {
            return;
         }
         select(var_426.getGridItemAt(param1) as IWindowContainer);
      }
      ...
      private function select(param1:IWindowContainer) : void
      {
         ...
         if(var_309 != null)
         {
            _loc2_ = var_309.getChildByName("chosen");
            if(_loc2_ != null)
            {
