package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private function createWindow() : void
      {
         ...
         _window = _widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_58,HabboWindowStyle.const_43,0 | 0,new Rectangle(const_1093,const_1094,2,2),null,0) as IWindowContainer;
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         selectTab(param1);
         var_1049 = _loc2_.light;
         if(var_357 != null)
         {
            var_357.setValue(var_1049);
         }
         _selectedColorIndex = colors.indexOf(_loc2_.color);
         if(var_497 != null)
         {
            var_497.setSelectedColorIndex(_selectedColorIndex);
         }
