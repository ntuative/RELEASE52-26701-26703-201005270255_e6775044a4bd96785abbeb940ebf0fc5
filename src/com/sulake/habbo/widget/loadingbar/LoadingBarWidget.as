package com.sulake.habbo.widget.loadingbar
{
   ...
   public class LoadingBarWidget extends RoomWidgetBase
   {
      ...
      private var var_442:Sprite = null;
      ...
      private function onShowInterstitial(param1:RoomWidgetInterstitialUpdateEvent) : void
      {
         ...
         {
            var_442 = new Sprite();
            var_442.addChild(new Bitmap(_image));
            var_442.addEventListener(MouseEvent.CLICK,clickHandler);
         }
         else
         {
            _loc5_ = var_442.getChildAt(0) as Bitmap;
            if(_loc5_ != null)
            {
               _loc5_.bitmapData = _image;
            }
         }
         _loc2_.setDisplayObject(var_442);
         _window.visible = true;
         _window.center();
      }
      ...
      private function clickHandler(param1:Event) : void
      {
         if(var_1607 != "")
         {
            HabboWebTools.openWebPage(var_1607);
         }
      }
      ...
      override public function dispose() : void
      {
         if(var_442 != null)
         {
            var_442.removeEventListener(MouseEvent.CLICK,clickHandler);
            var_442 = null;
         }
         if(_image != null)
         {
