package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketPlaceLogic implements IMarketPlace
   {
      ...
      public const const_1749:int = 3;
      
      public const const_1665:int = 2;
      ...
      private var var_1831:MarketplaceItemStats;
      ...
      public function buyOffer(param1:int) : void
      {
         ...
         showConfirmation(const_1513,_loc2_);
      }
      ...
      {
         if(param1.furniCategoryId != var_1829 || param1.furniTypeId != var_1828)
         {
            return;
         }
         var_1831 = param1;
      ...
      public function onBuyResult(param1:IMessageEvent) : void
      {
         ...
         else if(parser.result == 3)
         {
            ...
            showConfirmation(const_1665,updateItem);
            _visualization.listUpdatedNotify();
         }
      ...
      public function onOwnOffers(param1:IMessageEvent) : void
      {
         ...
         var_1833 = _loc3_.creditsWaiting;
         var_193 = new Map();
      ...
      private function showConfirmation(param1:int, param2:MarketPlaceOfferData) : void
      {
         if(!var_207)
         {
            var_207 = new MarketplaceConfirmationDialog(this,_catalog,_roomEngine);
         }
      ...
      {
         requestOffers(var_1826,var_1834,var_1827,var_1830);
      }
