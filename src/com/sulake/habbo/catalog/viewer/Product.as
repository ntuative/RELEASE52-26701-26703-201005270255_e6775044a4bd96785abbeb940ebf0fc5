package com.sulake.habbo.catalog.viewer
{
   ...
   public class Product extends ProductGridItem implements IProduct, IGetImageListener
   {
      ...
      private var var_1287:IProductData;
      ...
      {
         super();
         var_1290 = param1.productType;
         var_1289 = param1.furniClassId;
         var_1057 = param1.extraParam;
         var_1056 = param1.productCount;
         var_1288 = param1.expiration;
         var_1287 = param2;
      ...
      public function initIcon(param1:IProductContainer, param2:IGetImageListener = null) : BitmapData
      {
         ...
         switch(productType)
         {
            ...
            case ProductTypeEnum.const_85:
               _loc6_ = _loc4_.getWallItemIcon(productClassId,param2,var_1057);
               break;
