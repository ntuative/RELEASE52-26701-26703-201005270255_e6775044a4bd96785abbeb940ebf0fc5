package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private var var_869:MarketPlaceOfferData;
      
      private const const_1460:int = 1;
      
      private const const_1725:int = 40;
      ...
      private const const_1724:int = 10;
      ...
      private function method_2(param1:MarketPlaceOfferData) : void
      {
         var _loc9_:* = null;
         var _loc10_:* = null;
      ...
      private function updateList() : void
      {
         ...
         updateStatusDisplay(const_1459,_loc2_.length);
         if(!var_408)
         {
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:* = null;
         if(!marketPlace || !param2 || !_itemList || !var_600)
         {
            return;
         }
         var _loc3_:* = [];
      ...
      {
         var _loc5_:* = null;
         updateStatusDisplay(const_1460);
         var _loc1_:int = -1;
         var _loc2_:int = -1;
         var _loc3_:String = "";
         var _loc4_:int = 1;
      ...
      private function populateList() : Boolean
      {
         ...
         while(_loc1_ < 5)
         {
            if(var_870 >= var_600.length)
            {
               return true;
            }
            addListItem(var_600.getWithIndex(var_870));
            ++var_870;
            _loc1_++;
         }
         return false;
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "back_button":
                  ...
                  break;
               case "buy_button":
                  marketPlace.buyOffer(var_869.offerId);
            }
            return;
         }
