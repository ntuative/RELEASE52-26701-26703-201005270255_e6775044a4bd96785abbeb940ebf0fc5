package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class PetsCatalogWidget extends CatalogWidget implements ICatalogWidget, IPetDataListener, IAvatarImageListener
   {
      ...
      private function getPurchaseParameters() : String
      {
         ...
         var breed:IBreed = var_580[var_1465] as IBreed;
      ...
      override public function init() : void
      {
         ...
         var_833 = getPetTypeIndexFromProduct(_loc5_.localizationId);
         var_299 = [];
         var_580 = [];
         if(page && false && page.viewer.catalog)
         {
            ...
            {
               _loc11_ = _loc10_.avatarRenderManager.petDataManager.getPetData(var_833,this);
               if(_loc11_)
               {
                  var_580 = _loc11_.breeds;
         ...
         var _loc6_:int = 0;
         while(_loc6_ < var_580.length)
         {
            _loc12_ = var_580[_loc6_] as IBreed;
            _loc3_.push(_loc4_.getKey(getRaceLocalizationKey(var_833,_loc12_.id),getRaceLocalizationKey(var_833,_loc12_.id)));
            _loc6_++;
         }
         var_600.add(var_833,_loc5_);
         ...
         events.addEventListener(WidgetEvent.const_1017,onApproveNameResult);
         _loc5_ = var_600.getWithIndex(0);
         if(_loc5_ != null)
         {
      ...
      private function onApproveNameResult(param1:CatalogWidgetApproveNameResultEvent) : void
      {
         ...
         (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(var_600.getWithIndex(0),page,p);
      }
      ...
      {
         var _loc7_:* = null;
         var _loc1_:Offer = var_600.getWithIndex(0);
         if(_loc1_ == null)
         {
            return;
         }
         ...
         var _loc3_:IBreed = var_580[var_1465] as IBreed;
         if(!_loc3_)
         {
            return;
         }
         var _loc4_:IAvatarImage = (page.viewer.catalog as HabboCatalog).avatarRenderManager.createPetImage(var_833,_loc3_.id,_loc2_,AvatarScaleType.const_56,this);
         if(_loc4_ == null)
         {
            return;
         }
         _loc4_.initActionAppends();
         _loc4_.appendAction(AvatarAction.const_302,AvatarAction.const_743);
