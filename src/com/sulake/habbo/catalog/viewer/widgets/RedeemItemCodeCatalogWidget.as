package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function dispose() : void
      {
         ...
         if(var_1046 != null)
         {
            var_1046.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         if(var_1047 != null)
         {
            var_1047.removeEventListener(WindowKeyboardEvent.const_158,windowKeyEventProcessor);
         }
      }
      ...
      {
         super.init();
         var_1046 = _window.findChildByName("redeem") as IButtonWindow;
         if(var_1046 != null)
         {
            var_1046.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         var_1047 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(var_1047 != null)
         {
            var_1047.addEventListener(WindowKeyboardEvent.const_158,windowKeyEventProcessor);
         }
      }
