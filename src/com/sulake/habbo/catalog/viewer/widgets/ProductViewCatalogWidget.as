package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1336:IScrollbarWindow;
      
      protected var var_1184:XML;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_1383.text = "${" + _loc3_.name + "}";
            var_1384.text = "${" + _loc3_.description + "}";
         }
         else
         {
            var_1383.text = "${" + _loc2_.localizationId + "}";
            var_1384.text = "${" + _loc2_.localizationId + "}";
         }
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_406:
                  _loc4_ = var_1337.clone();
                  if(var_621 != null)
                  {
                     var_621.visible = true;
                     (_loc2_.productContainer as BundleProductContainer).populateItemGrid(var_621,var_1336,var_1184);
                  }
                  break;
                     ...
                     case ProductTypeEnum.const_212:
                        ...
                        if(_loc12_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc13_ != null)
                           {
                              ...
                              _loc13_.appendAction(AvatarAction.const_302,AvatarAction.const_584);
                              _loc13_.appendAction(AvatarAction.const_737,_loc6_.productClassId);
      ...
      {
         var_1383 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         var_1384 = _window.findChildByName("ctlg_description") as ITextWindow;
         var_86 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         var_1574 = new Point(var_86.x,var_86.y);
         var_621 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         var_1336 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         if(var_621 == null)
         {
         ...
         var_1337 = _loc2_.content as BitmapData;
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(var_86 != null && true)
         {
            ...
            var_86.bitmap.copyPixels(param1,param1.rect,_loc4_,null,null,true);
            var_86.invalidate();
            var_86.x = var_1574.x;
            var_86.y = var_1574.y;
            if(param3 != null)
