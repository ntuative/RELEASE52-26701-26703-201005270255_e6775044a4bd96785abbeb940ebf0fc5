package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNavigator implements ICatalogNavigator
   {
      ...
      private var var_2392:String = "magic.pixels";
      
      private var var_2391:String = "catalog.page.club";
      
      private var var_2420:String = "magic.credits";
      ...
      private function openCreditsPage() : void
      {
         ...
         var _loc1_:* = _catalog.configuration.getKey("client.credits.embed.enabled","false") == "TradingItemListEvent";
         if(false && _loc1_)
         {
      ...
      {
         _catalog.openCatalogPage(var_2391,true);
      }
