package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNodeRenderable extends CatalogNode
   {
      ...
      private static var var_1514:XML;
      
      private static var var_1513:XML;
       
      
      private var var_2348:IWindowContainer;
      ...
      private var var_1512:Number = 4.294967295E9;
      ...
      public function CatalogNodeRenderable(param1:ICatalogNavigator, param2:NodeData, param3:int)
      {
         ...
         if(var_1514 == null)
         {
            ...
            var_1514 = _loc4_.content as XML;
         }
         if(var_1513 == null)
         {
      ...
      override public function activate() : void
      {
         ...
         if(_loc1_ != null)
         {
            if(var_1512 == 4294967295)
            {
               var_1512 = _loc1_.color;
            }
      ...
      override public function open() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1408;
            }
         }
      }
      ...
      private function createWindow() : void
      {
         if(depth == 1)
         {
            _window = navigator.catalog.windowManager.buildFromXML(var_1514) as IWindowContainer;
         }
         else
         {
      ...
      {
         var_51 = navigator.catalog.windowManager.buildFromXML(var_1513) as IItemListWindow;
         if(var_51 == null)
         {
      ...
      override public function close() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1386;
            }
         }
      }
