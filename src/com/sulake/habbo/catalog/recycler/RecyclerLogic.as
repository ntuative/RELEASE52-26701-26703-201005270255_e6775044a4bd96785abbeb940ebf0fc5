package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(var_1619)
         {
            case RecyclerStatusMessageEvent.const_1297:
               var_283 = const_368;
               if(_view == null)
               {
                  return;
            ...
            case RecyclerStatusMessageEvent.const_845:
               ...
               break;
            case RecyclerStatusMessageEvent.const_1403:
               if(_view == null)
               {
                  return;
               }
      ...
      {
         return var_1619 != RecyclerStatusMessageEvent.const_845;
      }
      
      private function get statusActive() : Boolean
      {
         return var_283 != const_817;
      }
      ...
      {
         return active && var_283 == const_368;
      }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_1030:
               if(_view != null)
               {
