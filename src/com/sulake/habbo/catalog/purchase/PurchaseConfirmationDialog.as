package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private const const_1454:uint = 4.294967295E9;
      
      private const const_1453:uint = 4.293848814E9;
      ...
      private function suggestionsEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
               _loc5_ = var_221.findChildByName("suggestion_list") as IItemListWindow;
               if(_loc5_ == null)
               {
                  return;
               }
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == var_818;
               }
            }
            _loc4_++;
         }
      ...
      private function updatePreview() : void
      {
         ...
         _loc3_ = _loc2_.getFurnitureImage(var_818,new Vector3d(180),64,this,_loc1_.toString());
         if(_loc3_ == null)
         {
            return;
         }
      ...
      {
         return param1 % 2 == 0 ? uint(const_1453) : uint(const_1454);
      }
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               _catalog.purchaseProduct(var_446,var_79,var_998);
               dispose();
               break;
            case "cancel_button":
      ...
      private function selectHighlighted() : void
      {
         ...
         var _loc1_:IItemListWindow = var_221.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc1_ == null)
         {
            return;
         }
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(var_818);
         var _loc8_:int = !!_loc6_ ? 0 : int(var_573[_boxIndex]);
         var _loc9_:int = !!_loc6_ ? 0 : int(var_572[var_189]);
         _catalog.purchaseProductAsGift(var_446,var_79,var_998,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function nameInputHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            case WindowEvent.const_132:
               ...
               if(var_1735 == _loc3_.text)
               {
                  return;
               }
               _loc4_ = _loc3_.text.toLowerCase();
               _loc5_ = [];
               for each(_loc7_ in var_242)
               {
            ...
            case WindowMouseEvent.const_55:
               ...
               break;
            case WindowKeyboardEvent.const_539:
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            var_1446 = _loc1_.stuffTypes;
            var_573 = _loc1_.boxTypes;
            var_572 = _loc1_.method_7;
            var_818 = var_1446[0];
            _boxIndex = var_573[0];
            var_189 = var_572[0];
            initColorGrid();
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         var _loc2_:IItemListWindow = var_221.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(var_221 == null)
         {
            var_221 = _window.findChildByName("suggestion_container") as IWindowContainer;
         }
         if(var_471 == null)
         {
            var_471 = createWindow("suggestion_list_item") as IWindowContainer;
            var_471.procedure = suggestionsEventHandler;
         }
         if(var_221 == null || var_471 == null)
         {
            return;
         }
         var _loc2_:IItemListWindow = var_221.findChildByName("suggestion_list") as IItemListWindow;
         ...
         {
            _loc5_ = var_471.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
