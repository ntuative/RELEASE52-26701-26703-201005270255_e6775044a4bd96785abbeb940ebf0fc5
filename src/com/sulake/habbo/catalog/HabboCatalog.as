package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener
   {
      ...
      private var var_437:ClubBuyController;
      ...
      private var var_323:CatalogViewer;
      
      private var var_2144:Boolean = true;
      
      private var _roomEngine:IRoomEngine;
      
      private var var_436:ICatalogNavigator;
      ...
      private var var_1091:ClubGiftController;
      ...
      {
         return var_368.getProductData(param1);
      }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         updatePurse();
         if(!var_2143 && var_522 != null)
         {
            var_522.playSound(HabboSoundTypesEnum.const_982);
         }
         var_2143 = false;
      }
      ...
      public function getFurnitureData(param1:int, param2:String) : IFurnitureData
      {
         ...
         {
            _loc3_ = var_368.getFloorItemData(param1);
         }
         if(param2 == ProductTypeEnum.const_85)
         {
            _loc3_ = var_368.getWallItemData(param1);
         }
         return _loc3_;
      }
      ...
      private function createClubBuyController() : void
      {
         if(var_437 == null)
         {
            var_437 = new ClubBuyController(this);
         }
      }
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_103:
               var_1357 = param1.session.isPrivateRoom;
               if(var_87 != null)
               {
      ...
      private function noCreditsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:Event) : void
      {
         ...
         {
            if(false && "TradingItemListEvent" == var_151.getKey("client.credits.embed.enabled"))
            {
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         if(!var_923)
         {
            if(!var_368.loadProductData(this))
            {
               return;
            }
            init();
         ...
         {
            var_197.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_51,HabboToolbarIconEnum.CATALOGUE,_mainContainer));
         }
         if(false)
         {
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         var_1091.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function createCatalogNavigator() : void
      {
         ...
         var_436 = new CatalogNavigator(this,_loc1_) as ICatalogNavigator;
      ...
      private function createClubGiftController() : void
      {
         if(var_1091 == null)
         {
            var_1091 = new ClubGiftController(this);
         }
      }
      ...
      public function showPurchaseConfirmation(param1:IPurchasableOffer, param2:ICatalogPage, param3:String = "") : void
      {
         ...
         {
            var_437.showConfirmation(param1 as ClubBuyOfferData,param2);
         }
      }
      ...
      {
         var_197.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_117,HabboToolbarIconEnum.CATALOGUE));
      }
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         var_436.buildCatalogIndex(_loc2_);
         if(var_1092 != "")
         {
            var_436.openPage(var_1092);
            var_1092 = "";
         }
         else
         {
            var_436.openFrontPage();
         }
      }
      ...
      private function onPixelsBalance(param1:IMessageEvent) : void
      {
         ...
         updatePurse();
         if(!var_2144 && var_522 != null)
         {
            var_522.playSound(HabboSoundTypesEnum.const_851);
         }
         var_2144 = false;
      }
      ...
      private function createCatalogViewer() : void
      {
         ...
         var_323 = new CatalogViewer(this,_loc1_,_roomEngine);
         var_323.habboCatalog = this;
      }
