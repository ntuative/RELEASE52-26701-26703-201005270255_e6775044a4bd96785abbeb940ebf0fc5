package com.sulake.habbo.tracking
{
   ...
   public class LagWarningLogger
   {
      ...
      {
         var _loc2_:* = null;
         if(!var_1178 || var_1572 <= 0)
         {
            return;
         }
         var _loc1_:int = getTimer();
         if(var_1571 == 0 || _loc1_ - var_1571 > var_1572)
         {
            if(_connection != null)
            {
      ...
      {
         var_1178 = Boolean(int(param1.getKey("lagWarningLog.enabled","0")));
         var_1572 = int(param1.getKey("lagWarningLog.interval.minutes","10")) * 1000 * 60;
      }
