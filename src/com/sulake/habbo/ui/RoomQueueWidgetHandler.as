package com.sulake.habbo.ui
{
   ...
   public class RoomQueueWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionQueueEvent.const_382:
               ...
               {
                  case RoomSessionQueueEvent.const_824:
                     _loc3_ = "null";
                     break;
               ...
               if(_loc7_.length > 1)
               {
                  if(_loc6_ && _loc2_.queueTypes.indexOf(RoomSessionQueueEvent.const_888) != -1)
                  {
                     _loc8_ = _loc2_.getQueueSize(RoomSessionQueueEvent.const_888) + 1;
                     _loc9_ = true;
                  }
                  else
                  {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetRoomQueueMessage.const_558);
         _loc1_.push(RoomWidgetRoomQueueMessage.CHANGE_TO_SPECTATOR_QUEUE);
         _loc1_.push(RoomWidgetRoomQueueMessage.const_699);
         _loc1_.push(RoomWidgetRoomQueueMessage.const_762);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomQueueMessage.const_558:
            ...
            case RoomWidgetRoomQueueMessage.CHANGE_TO_SPECTATOR_QUEUE:
               ...
               break;
            case RoomWidgetRoomQueueMessage.const_699:
               _container.roomSession.changeQueue(RoomSessionQueueEvent.const_824);
               break;
            case RoomWidgetRoomQueueMessage.const_762:
               if(false)
               {
      ...
      {
         return [RoomSessionQueueEvent.const_382];
      }
