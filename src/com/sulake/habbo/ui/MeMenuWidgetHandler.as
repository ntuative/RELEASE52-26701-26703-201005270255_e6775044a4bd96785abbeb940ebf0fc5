   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler, IHabboAvatarEditorDataSaver
   {
      ...
      private function setMeMenuToolbarIcon(param1:Boolean) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            Logger.log("MeMenuWidgetHandler: set toolbar icon: " + var_197 + " " + _loc7_);
            if(var_197 != null && _loc7_ != null)
            {
               _loc9_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_987,HabboToolbarIconEnum.MEMENU);
               _loc9_.bitmapData = _loc7_;
               var_197.events.dispatchEvent(_loc9_);
            }
         }
      }
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(_container != null)
         {
            if(false)
            {
               _container.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_747,onFigureUpdate);
            }
            if(false)
            {
            ...
            if(false)
            {
               _container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_442,onHelpTutorialEvent);
               _container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_115,onHelpTutorialEvent);
            }
            _container = null;
         }
         _container = param1;
         if(_container != null && false)
         {
            _container.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_747,onFigureUpdate);
         ...
         if(var_11 != null)
         {
            (var_11 as Component).events.addEventListener(HabboInventoryEffectsEvent.const_875,onAvatarEffectsChanged);
            (var_11 as Component).events.addEventListener(HabboInventoryHabboClubEvent.const_1021,onHabboClubSubscriptionChanged);
         }
         var_197 = _container.toolbar;
         if(var_197)
         {
         ...
         if(false)
         {
            _container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_442,onHelpTutorialEvent);
            _container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_115,onHelpTutorialEvent);
         }
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_115:
               _container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_115));
               break;
            case HabboHelpTutorialEvent.const_442:
               _container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_451));
         }
      }
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetSelectEffectMessage.const_760);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_658);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_717);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_615);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_573);
         _loc1_.push(RoomWidgetStopEffectMessage.const_552);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1390);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_874);
         _loc1_.push(RoomWidgetToolbarMessage.const_556);
         _loc1_.push(RoomWidgetToolbarMessage.const_554);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_299);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1377);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_993);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_716);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_654);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_604);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1236);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_632);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_569);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_599);
         _loc1_.push(RoomWidgetClothingChangeMessage.const_322);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetGetEffectsMessage.const_564:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_760:
               if(var_11 != null)
               {
            ...
            case RoomWidgetOpenCatalogMessage.const_573:
               ...
               if(_catalog != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_974)
               {
                  _catalog.openCatalogPage(CatalogPageName.const_226,true);
               }
               break;
            case RoomWidgetOpenInventoryMessage.const_615:
               ...
               if(var_11 != null)
               {
                  ...
                  switch(_loc3_.inventoryType)
                  {
                     case RoomWidgetOpenInventoryMessage.const_981:
                        _catalog.openCatalogPage(CatalogPageName.const_1284,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_921:
                        var_11.toggleInventoryPage(InventoryCategory.const_276);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1368:
            ...
            case RoomWidgetStopEffectMessage.const_552:
            ...
            case RoomWidgetNavigateToRoomMessage.const_874:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_716:
               if(_container != null)
               {
                  _container.navigator.showOwnRooms();
               }
               break;
            case RoomWidgetToolbarMessage.const_556:
               ...
               if(var_197)
               {
                  var_197.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_51,HabboToolbarIconEnum.MEMENU,_loc5_.window));
                  if(var_11 != null)
                  {
                     _loc12_ = false;
                     if(_container != null && false)
            ...
            case RoomWidgetToolbarMessage.const_554:
               ...
               if(var_197 && false)
               {
                  var_197.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_411,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_299:
               ...
               break;
            case RoomWidgetGetSettingsMessage.const_604:
               _container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_316,_container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_632:
               _container.soundManager.volume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               _container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_316,_container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_569:
               _container.soundManager.previewVolume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               _container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_316,_container.soundManager.volume));
               break;
            case RoomWidgetAvatarEditorMessage.const_599:
               if(false && _container.habboHelp.events)
               {
                  _container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_489));
               }
               break;
            case RoomWidgetClothingChangeMessage.const_322:
