package com.sulake.habbo.ui
{
   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(_container != null)
         {
            if(false)
            {
               ...
               _container.sessionDataManager.events.removeEventListener(BadgeImageReadyEvent.const_137,onBadgeImage);
            }
            if(false)
            {
               _container.roomSessionManager.events.removeEventListener(RoomSessionUserFigureUpdateEvent.const_149,onFigureUpdate);
               _container.roomSessionManager.events.removeEventListener(RoomSessionPetInfoUpdateEvent.const_157,onPetInfo);
         ...
         if(false)
         {
            ...
            _container.sessionDataManager.events.addEventListener(BadgeImageReadyEvent.const_137,onBadgeImage);
         }
         if(false)
         {
            _container.roomSessionManager.events.addEventListener(RoomSessionUserFigureUpdateEvent.const_149,onFigureUpdate);
            _container.roomSessionManager.events.addEventListener(RoomSessionPetInfoUpdateEvent.const_157,onPetInfo);
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_32:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_567);
               _loc6_.id = param1.id;
               ...
               _loc9_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_902);
               _loc10_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_829);
            ...
            case RoomObjectCategoryEnum.const_38:
               ...
               if(_loc11_.type == RoomObjectTypeEnum.const_313)
               {
                  _loc12_ = "null";
               ...
               if(_loc16_ != null)
               {
                  _loc13_.carryItem = _loc16_.getModel().getNumber(RoomObjectVariableEnum.const_559);
               }
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_243)
               {
                  _loc13_.realName = _container.sessionDataManager.realName;
               }
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_234)
               {
                  ...
                  _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1319;
                  if(!_loc25_)
                  {
                  ...
                  if(!_loc26_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_897;
                  }
                  if(!_loc27_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_859;
                  }
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc14_.push(RoomWidgetUserInfoUpdateEvent.const_1352);
               }
               else
               {
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc5_:IAvatarImage = var_628.getValue(_loc2_.petId) as IAvatarImage;
         if(_loc5_ == null)
         {
            _loc5_ = _container.avatarRenderManager.createPetImageFromFigure(_loc4_,AvatarScaleType.const_56);
            var_628.add(_loc2_.petId,_loc5_);
         }
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetFurniActionMessage.const_534);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_730);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_544);
         _loc1_.push(RoomWidgetUserActionMessage.const_438);
         _loc1_.push(RoomWidgetUserActionMessage.const_643);
         _loc1_.push(RoomWidgetUserActionMessage.const_577);
         _loc1_.push(RoomWidgetUserActionMessage.const_1425);
         _loc1_.push(RoomWidgetPetCommandMessage.const_633);
      ...
      public function dispose() : void
      {
         ...
         if(var_628 != null)
         {
            _loc1_ = var_628.getKeys();
            for each(_loc2_ in _loc1_)
            {
               _loc3_ = var_628.getValue(_loc2_);
               if(_loc3_)
               {
                  _loc3_.dispose();
               }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_438)
            {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetFurniActionMessage.const_281:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_534:
            ...
            case RoomWidgetRoomTagSearchMessage.const_730:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_544:
               ...
               break;
            case RoomWidgetUserActionMessage.const_438:
            ...
            case RoomWidgetPetCommandMessage.const_541:
               ...
               break;
            case RoomWidgetPetCommandMessage.const_633:
