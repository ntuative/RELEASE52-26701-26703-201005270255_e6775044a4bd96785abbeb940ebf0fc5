package com.sulake.habbo.ui
{
   ...
   public class FurnitureEcotronBoxWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_596,RoomWidgetEcotronBoxOpenMessage.const_609,RoomWidgetEcotronBoxOpenedMessage.const_1303];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_596:
               ...
               break;
            case RoomWidgetEcotronBoxOpenMessage.const_609:
