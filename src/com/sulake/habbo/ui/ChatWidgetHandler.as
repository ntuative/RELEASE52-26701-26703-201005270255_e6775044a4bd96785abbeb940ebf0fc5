package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler, IAvatarImageListener
   {
      ...
      private var var_819:Number = 0.0;
      
      private var var_472:Point = null;
      ...
      public function dispose() : void
      {
         ...
         if(var_340 != null)
         {
            ...
            {
               _loc2_ = var_340.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           _loc13_ = var_340.getValue(_loc15_) as BitmapData;
                           _loc12_ = uint(var_684.getValue(_loc15_));
                           if(_loc13_ == null)
                           {
                              if(false)
                              {
                                 switch(_loc10_.type)
                                 {
                                    case RoomObjectTypeEnum.const_347:
                                 ...
                                 if(_loc13_ != null)
                                 {
                                    var_340.add(_loc15_,_loc13_);
                                 }
                                 if(_loc12_ != 0)
                                 {
                                    var_684.add(_loc15_,_loc12_);
                                 }
                                 if(_loc16_ != null)
                                 {
                                    _loc16_.dispose();
      ...
      {
         return [RoomWidgetChatMessage.const_729,RoomWidgetChatSelectAvatarMessage.const_565];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_729:
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":v":
                              _loc10_ = new RoomSessionChatEvent(RoomSessionChatEvent.const_148,_container.roomSession,0,"Version 26701-26703-201005270241");
               ...
               break;
            case RoomWidgetChatSelectAvatarMessage.const_565:
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(var_819 > 0)
            {
               _loc5_ = Number(_loc4_.scale / var_819);
            }
            if(var_472 == null)
            {
               var_473.x = 0;
               var_473.y = 0;
               var_473.z = 0;
               var_472 = _loc4_.getScreenPoint(var_473);
               var_819 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            var_473.x = 0;
            var_473.y = 0;
            var_473.z = 0;
            _loc8_ = _loc4_.getScreenPoint(var_473);
            if(_loc8_ != null)
            {
               if(_loc8_.x != var_472.x || _loc8_.y != var_472.y)
               {
                  _loc9_ = PointMath.sub(_loc8_,PointMath.mul(var_472,_loc5_));
