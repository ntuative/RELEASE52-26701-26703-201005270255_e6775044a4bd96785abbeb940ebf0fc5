package com.sulake.core.runtime
{
   ...
   public final class CoreComponent extends ComponentContext implements ICore
   {
      ...
      private static const const_1133:String = "library";
      
      private static const const_1126:String = "asset-libraries";
      
      private static const const_1127:String = "library";
      
      private static const const_1132:String = "service-libraries";
      ...
      private var var_739:IEventDispatcher;
      
      private var var_888:Profiler;
      
      private var var_266:uint;
      
      private var var_508:Array;
      
      private var var_265:LibraryLoaderQueue;
      
      private var var_612:Array;
      
      private var var_738:ProfilerViewer;
      
      private var var_236:uint;
      ...
      public function CoreComponent(param1:DisplayObjectContainer, param2:uint)
      {
         ...
         switch(param2 & 0)
         {
            ...
            case Core.const_1211:
               ...
               var_888 = new Profiler(this);
               attachComponent(var_888,[new IIDProfiler()]);
               var_738 = new ProfilerViewer();
               var_217.addChild(var_738);
               break;
      ...
      private function errorInLoadingProcess(param1:LibraryLoaderEvent = null) : void
      {
         ...
         error("Failed to download library \"" + _loc2_.url + "\" HTTP status " + param1.status + ": " + _loc2_.getLastErrorMessage(),true,Core.const_1421);
         if(!_isDisposed)
         {
      ...
      override public function removeUpdateReceiver(param1:IUpdateReceiver) : void
      {
         ...
         {
            _loc3_ = var_508[_loc4_] as Array;
      ...
      {
         return var_236 - getNumberOfFilesPending();
      }
      ...
      private function updateLoadingProgress(param1:LibraryLoaderEvent = null) : void
      {
         if(var_739)
         {
            var_739.dispatchEvent(new ProgressEvent(ProgressEvent.PROGRESS,false,false,param1.bytesLoaded,param1.bytesTotal));
         }
      }
      ...
      public function readConfigDocument(param1:XML, param2:IEventDispatcher = null) : void
      {
         ...
         var_739 = loadingEventDelegate;
         if(var_265 == null)
         {
            var_265 = new LibraryLoaderQueue(_debug);
         }
         try
         {
      ...
      override public function registerUpdateReceiver(param1:IUpdateReceiver, param2:uint) : void
      {
         ...
         var _loc3_:Array = var_508[param2] as Array;
         _loc3_.push(param1);
      }
         ...
         while(criticality < CoreComponent.const_145)
         {
            ...
            while(index != length)
            {
               ...
               else
               {
                  try
                  {
                     var_888.update(receiver,msSinceLastUpdate);
                  }
                  catch(e:Error)
                  {
      ...
      override public function dispose() : void
      {
         ...
         if(!disposed)
         {
            ...
            while(_loc3_ < CoreComponent.const_145)
            {
               _loc2_ = var_508[_loc3_] as Array;
      ...
      private function finalizeLoadingEventDelegate() : void
      {
         if(var_739)
         {
            var_739.dispatchEvent(new Event(Event.COMPLETE));
         }
      }
      ...
      private function updateLoadingProcess(param1:LibraryLoaderEvent = null) : void
      {
         ...
         if(param1 != null)
         {
            if(param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE || param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_ERROR)
            {
               ...
               if(var_739)
               {
                  var_739.dispatchEvent(new ProgressEvent(ProgressEvent.PROGRESS,false,false,var_236 - 0,var_236));
               }
            }
         }
         if(false)
