package com.sulake.core.runtime
{
   ...
   public class Component implements IUnknown
   {
      ...
      public static const const_1003:uint = 4;
      ...
      protected var var_1956:Boolean = false;
      ...
      public function release(param1:IID) : uint
      {
         ...
         if(_loc2_ == null)
         {
            var_971 = "Attempting to release unknown interface:" + param1 + "!";
            throw new Error(var_971);
         }
         var _loc3_:uint = _loc2_.release();
         if(var_1132 & const_1003)
         {
            if(_loc3_ == 0)
            {
