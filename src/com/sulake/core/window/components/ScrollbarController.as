package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow
   {
      ...
      private static const const_1079:String = "decrement";
      ...
      protected var var_790:Number = 0.1;
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         switch(param1.name)
         {
            case ScrollbarController.const_506:
               if(param2.type == WindowNotifyEvent.const_261)
               {
                  if(!var_568)
                  {
                     if(_horizontal)
      ...
      private function resolveScrollTarget() : Boolean
      {
         ...
         if(var_806 != null)
         {
            ...
            {
               _loc1_ = IWindowContainer(var_9).findChildByName(var_806) as IScrollableWindow;
               if(_loc1_)
               {
                  scrollable = _loc1_;
                  return true;
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_55)
         {
            ...
            else if(param2.name == ScrollbarController.const_1079)
            {
               if(var_21)
               {
                  var_568 = true;
         ...
         if(param1.type == WindowMouseEvent.const_972)
         {
