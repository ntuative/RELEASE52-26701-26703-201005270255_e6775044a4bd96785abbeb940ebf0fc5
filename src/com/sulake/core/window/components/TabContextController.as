package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1146:String = "content";
      
      private static const const_1145:String = "selector";
       
      
      private var var_1177:Boolean = false;
      
      protected var var_973:ITabSelectorWindow;
      
      private var var_923:Boolean = false;
      
      protected var var_1638:IWindowContainer;
      ...
      public function get container() : IWindowContainer
      {
         if(var_1638 == null)
         {
            var_1638 = findChildByTag(TabContextController.const_1146) as IWindowContainer;
         }
         return var_1638;
      }
      ...
      public function get selector() : ITabSelectorWindow
      {
         if(var_973 == null)
         {
            var_973 = findChildByTag(TabContextController.const_1145) as ITabSelectorWindow;
            if(var_973 != null)
            {
               var_973.procedure = selectorEventProc;
            }
         }
         return var_973;
      }
      ...
      {
         return !!var_923 ? selector.iterator : null;
      }
