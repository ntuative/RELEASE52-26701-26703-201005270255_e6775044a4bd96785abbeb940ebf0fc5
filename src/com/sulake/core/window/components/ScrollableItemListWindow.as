   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!var_349)
         {
            ...
            if(var_349)
            {
               var_349.addEventListener(WindowEvent.const_273,scrollBarEventProc);
               var_349.addEventListener(WindowEvent.const_240,scrollBarEventProc);
            }
         }
         return var_349;
      }
      ...
      override public function dispose() : void
      {
         if(var_349)
         {
            var_349.removeEventListener(WindowEvent.const_273,scrollBarEventProc);
            var_349.removeEventListener(WindowEvent.const_240,scrollBarEventProc);
            var_349 = null;
         }
         if(var_862)
         {
