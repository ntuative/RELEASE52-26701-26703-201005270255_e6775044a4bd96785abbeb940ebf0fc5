package com.sulake.core.window.components
{
   ...
   public class DropMenuController extends InteractiveController implements IDropMenuWindow
   {
      ...
      private function getSubMenu() : DropMenuController
      {
         ...
         {
            var_127 = context.create(name + "::submenu","",WindowType.const_400,var_81,0 | 0,_loc1_,subMenuEventProc,null,0,null,[WindowController.EXCLUDE_CHILD_TAG]) as DropMenuController;
         }
         else
         {
      ...
      {
         if(param1.type == WindowMouseEvent.const_104)
         {
         ...
         else if(param1.type == WindowEvent.const_977)
         {
            if(param2 == var_127)
            {
               closeMenuView();
      ...
      protected function populateMenuItemContainer(param1:Array, param2:DropMenuController, param3:Function) : void
      {
         ...
         while(_loc9_ < _loc5_)
         {
            _loc6_ = context.create(name + "::menu_item_" + _loc9_,param1[_loc9_],WindowType.const_396,var_81,0 | 0 | 0 | 0 | 0,null,param3,null,_loc9_,null,["_EXCLUDE"]) as DropMenuItemController;
         ...
         if(var_481 > -1 && _loc5_)
         {
            _loc4_.getListItemAt(var_481).setStateFlag(WindowState.WINDOW_STATE_SELECTED,true);
         }
      }
      ...
      protected function openMenuView() : void
      {
         if(!var_585)
         {
            if(open())
            {
               if(false)
               {
                  populateMenuItemContainer(var_482,getSubMenu(),subMenuEventProc);
                  var_585 = true;
               }
            }
         }
      ...
      public function set selection(param1:int) : void
      {
         ...
         var _loc2_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_425,this,null,true);
         update(this,_loc2_);
         if(!_loc2_.isWindowOperationPrevented())
         {
            var_481 = param1;
            closeMenuView();
            update(this,new WindowNotifyEvent(WindowNotifyEvent.const_309,this,null));
         }
      }
      ...
      protected function closeMenuView() : void
      {
         if(close())
         {
            ...
            var_585 = false;
            getTitleText().text = var_481 < var_482.length && var_481 > -1 ? "null" : caption;
         }
      }
   }
}
