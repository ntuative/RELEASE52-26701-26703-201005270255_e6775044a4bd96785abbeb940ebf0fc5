package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      {
         return new Rectangle(var_655 * maxScrollH,var_381 * maxScrollV,width,height);
      }
      ...
      {
         var_655 = param1;
         _field.scrollH = var_655 * Number(_field.maxScrollH);
         refreshTextImage();
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct("font_size",defaultTextFormat.size,PropertyStruct.const_995,true));
         _loc1_.push(new PropertyStruct("text_color",_field.textColor,PropertyStruct.const_461,true));
         ...
         _loc1_.push(new PropertyStruct("border_color",_field.borderColor,PropertyStruct.const_461,true));
         ...
         _loc1_.push(new PropertyStruct("sharpness",_field.sharpness,PropertyStruct.const_587,true));
         _loc1_.push(new PropertyStruct("style_sheet",_field.styleSheet,PropertyStruct.STRING,false));
         _loc1_.push(new PropertyStruct("thickness",_field.thickness,PropertyStruct.const_587,true));
         _loc1_.push(new PropertyStruct("word_wrap",_field.wordWrap,PropertyStruct.const_64,true));
         _loc1_.push(new PropertyStruct("margin_left",var_69.left,PropertyStruct.const_66,true));
         _loc1_.push(new PropertyStruct("margin_top",var_69.top,PropertyStruct.const_66,true));
         _loc1_.push(new PropertyStruct("margin_right",var_69.right,PropertyStruct.const_66,true));
         _loc1_.push(new PropertyStruct("margin_bottom",var_69.bottom,PropertyStruct.const_66,true));
         ...
         _loc1_.push(new PropertyStruct("spacing",_field.defaultTextFormat.letterSpacing,PropertyStruct.const_587,_field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
