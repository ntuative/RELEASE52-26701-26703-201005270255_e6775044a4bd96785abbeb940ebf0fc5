package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1066:String = "_HEADER";
      
      private static const const_771:String = "margin_right";
      
      private static const const_1065:String = "_SCALER";
      
      private static const const_1068:String = "_TITLE";
      
      private static const const_1067:String = "_CONTENT";
      
      private static const const_768:String = "margin_left";
      
      private static const const_770:String = "margin_bottom";
      ...
      private var var_1154:IHeaderWindow;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_768,_loc3_.left,PropertyStruct.const_66,_loc2_));
         _loc1_.push(new PropertyStruct(const_769,_loc3_.top,PropertyStruct.const_66,_loc2_));
         _loc1_.push(new PropertyStruct(const_771,0 - _loc3_.right,PropertyStruct.const_66,_loc2_));
         _loc1_.push(new PropertyStruct(const_770,0 - _loc3_.bottom,PropertyStruct.const_66,_loc2_));
         return _loc1_;
      }
      ...
      private function setupScaling() : void
      {
         ...
         var _loc2_:Boolean = testParamFlag(WindowParam.const_266);
         var _loc3_:Boolean = testParamFlag(WindowParam.const_223);
      ...
      public function get header() : IHeaderWindow
      {
         if(var_1154 == null)
         {
            var_1154 = findChildByTag(const_1066) as IHeaderWindow;
            if(!var_1154)
            {
      ...
      public function get title() : ITextWindow
      {
         if(_title == null)
         {
            _title = findChildByTag(const_1068) as ITextWindow;
            if(!_title)
            {
      ...
      {
         return content != null && var_659 ? content.iterator : new Iterator(this);
      }
      ...
      public function get content() : IWindowContainer
      {
         if(var_20 == null)
         {
            var_20 = findChildByTag(const_1067) as IWindowContainer;
            if(!var_20)
            {
