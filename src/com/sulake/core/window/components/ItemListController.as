package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow
   {
      ...
      protected static const const_1057:String = "auto_arrange_items";
      ...
      protected var var_2379:Number = 0.0;
      
      protected var var_559:Boolean = false;
      
      protected var var_2380:Number = 0.0;
      ...
      protected var var_792:Boolean = true;
      ...
      public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         var_164 = var_658 || !testParamFlag(WindowParam.const_35);
         _container = var_16.create("_CONTAINER","",WindowType.const_331,WindowStyle.const_318,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[WindowController.INTERNAL_CHILD_TAG,WindowController.EXCLUDE_CHILD_TAG]) as IWindowContainer;
      ...
      {
         return new Rectangle(var_558 * maxScrollH,var_557 * maxScrollV,width,height);
      }
      ...
      public function set scrollH(param1:Number) : void
      {
         ...
         {
            var_558 = param1;
            _container.x = -var_558 * maxScrollH;
            var_16.invalidate(_container,visibleRegion,WindowRedrawFlag.const_78);
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_1056,_spacing,PropertyStruct.const_66,_spacing != DEF_SPACING));
         _loc1_.push(new PropertyStruct(const_1057,var_792,PropertyStruct.const_64,var_792 != const_1447));
         _loc1_.push(new PropertyStruct(const_1059,var_559,PropertyStruct.const_64,var_559 != const_1448));
         _loc1_.push(new PropertyStruct(const_1058,var_1138,PropertyStruct.const_64,var_1138 != DEF_RESIZE_ON_ITEM_UPDATE));
         return _loc1_;
      }
      ...
      public function set scrollV(param1:Number) : void
      {
         ...
         {
            var_557 = param1;
            _container.y = -var_557 * maxScrollV;
            var_16.invalidate(_container,visibleRegion,WindowRedrawFlag.const_78);
         }
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case const_1058:
                  ...
                  break;
               case const_1057:
                  var_792 = _loc2_.value as Boolean;
                  break;
            }
         }
