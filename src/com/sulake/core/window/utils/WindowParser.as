package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_846:String = "_EXCLUDE";
      
      public static const const_1702:String = "_TEMP";
      
      private static const const_1153:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1152:RegExp = /(\s|\n|\r|\t|\v)*$/;
      ...
      protected var var_975:Dictionary;
      
      protected var var_1416:Map;
      
      protected var var_16:IWindowContext;
      
      protected var var_1417:Dictionary;
      
      protected var var_1137:Dictionary;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         TypeCodeTable.fillTables(var_1137,var_1136);
         var_975 = new Dictionary();
         var_1417 = new Dictionary();
         ParamCodeTable.fillTables(var_975,var_1417);
         var_1416 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1152,"");
         return param1.replace(const_1153,"");
      }
      ...
      public function dispose() : void
      {
         ...
         if(!_disposed)
         {
            for(_loc1_ in var_1137)
            {
               delete var_1137[_loc1_];
            }
            for(_loc1_ in var_1136)
            {
               delete var_1136[_loc1_];
            }
            for(_loc1_ in var_975)
            {
               delete var_975[_loc1_];
            }
            for(_loc1_ in var_1417)
            {
               delete var_1417[_loc1_];
            }
            var_1416.dispose();
            var_1416 = null;
            var_16 = null;
      ...
      private function parseSingleWindowEntity(param1:XML, param2:WindowController, param3:Map) : IWindow
      {
         ...
         visible = parseAttribute(xml,"visible",variables,visible.toString()) == "TradingItemListEvent";
         ...
         background = parseAttribute(xml,"background",variables,window.background.toString()) == "TradingItemListEvent";
         blend = Number(parseAttribute(xml,"blend",variables,window.blend.toString()));
         clipping = parseAttribute(xml,"clipping",variables,window.clipping.toString()) == "TradingItemListEvent";
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_846) == -1)
                  {
