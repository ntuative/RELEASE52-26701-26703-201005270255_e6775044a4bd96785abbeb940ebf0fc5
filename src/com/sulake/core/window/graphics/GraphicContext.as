package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_963:uint = 2;
      
      public static const const_1712:uint = 128;
      
      public static const const_1649:uint = 64;
      
      public static const const_655:uint = 4;
      
      public static const const_1414:uint = 0;
      
      public static const const_1233:uint = 16;
      
      public static const const_756:uint = 1;
      
      public static const const_1209:uint = 8;
      ...
      public function GraphicContext(param1:String, param2:uint, param3:Rectangle)
      {
         ...
         switch(param2)
         {
            ...
            case GraphicContext.const_1209:
               ...
               break;
            case GraphicContext.const_1233:
            ...
            case GraphicContext.const_985:
               break;
            case GraphicContext.const_1414:
               break;
            default:
         ...
         if(var_656)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new BitmapData(width,height,var_1635,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new BitmapData(1,1,var_1635,16777215);
                  }
                  var_387 += bitmap.width * bitmap.height * 4;
               }
