package com.sulake.core.window.graphics
{
   ...
   public class WindowRenderer implements IWindowRenderer
   {
      ...
      public function WindowRenderer(param1:ISkinContainer)
      {
         ...
         var_616 = new Array();
         var_1552 = new Point();
         var_1551 = new Rectangle();
         var_318 = new Rectangle();
         var_319 = new Dictionary(true);
         var_668 = param1;
      ...
      {
         var _loc2_:WindowRendererItem = var_319[param1] as WindowRendererItem;
      ...
      public function render() : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            _loc1_ = var_616.pop() as WindowController;
            if(!_loc1_.disposed)
            {
               _loc3_ = getWindowRendererItem(_loc1_);
               var_318.x = _loc3_.dirty.x;
               var_318.y = _loc3_.dirty.y;
               var_318.width = _loc3_.dirty.width;
               var_318.height = _loc3_.dirty.height;
               renderWindowBranch(_loc1_,_loc3_,var_318);
            }
            _loc4_++;
         }
      }
      ...
      {
         param1.removeEventListener(WindowDisposeEvent.const_734,windowDisposedCallback);
         var _loc2_:WindowRendererItem = var_319[param1] as WindowRendererItem;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
      ...
      public function dispose() : void
      {
         ...
         if(!_disposed)
         {
            _disposed = true;
            var_616 = null;
            for(_loc1_ in var_319)
            {
               delete var_319[_loc1_];
            }
            var_319 = null;
      ...
      private function renderWindowBranch(param1:WindowController, param2:WindowRendererItem, param3:Rectangle) : void
      {
         ...
         if(param1.visible)
         {
            if(getDrawLocationAndClipRegion(param1,param3,var_1552,var_1551))
            {
               if(param2.render(param1,var_1552,var_1551))
               {
      ...
      public function registerRenderable(param1:IWindow) : void
      {
         ...
         if(_loc2_ == null)
         {
            ...
            var_319[param1] = _loc2_;
            param1.addEventListener(WindowDisposeEvent.const_734,windowDisposedCallback);
         }
      }
      ...
      public function invalidate(param1:IWindowContext, param2:Rectangle) : void
      {
         ...
         while(_loc4_-- > 0)
         {
            ...
            addToRenderQueue(_loc5_,_loc5_.rectangle,WindowRedrawFlag.const_78);
         }
      }
      ...
      public function addToRenderQueue(param1:IWindow, param2:Rectangle, param3:uint) : void
      {
         ...
         if(getWindowRendererItem(param1).invalidate(param1,param2,param3))
         {
            ...
            var_318.x = param2.x - param1.x;
            var_318.y = param2.y - param1.y;
            var_318.width = param2.width;
            var_318.height = param2.height;
            if(param1.testParamFlag(WindowParam.const_35))
            {
               while(param1.testParamFlag(WindowParam.const_35))
               {
                  ...
                  var_318.offset(param1.x,param1.y);
                  param1 = _loc4_;
               }
            }
            getWindowRendererItem(param1).invalidate(param1,var_318,WindowRedrawFlag.const_292);
