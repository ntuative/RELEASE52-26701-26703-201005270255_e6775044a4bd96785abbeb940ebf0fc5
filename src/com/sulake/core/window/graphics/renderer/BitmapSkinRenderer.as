package com.sulake.core.window.graphics.renderer
{
   ...
   public class BitmapSkinRenderer extends SkinRenderer implements ISkinRenderer
   {
      ...
      private var var_773:Matrix;
      
      protected var var_660:Dictionary;
      
      public function BitmapSkinRenderer(param1:Array)
      {
         super(param1);
         var_660 = new Dictionary(false);
      ...
      private function getBitmapFromCache(param1:ISkinTemplate, param2:String) : BitmapData
      {
         ...
         var _loc4_:BitmapData = var_660[_loc3_];
         if(_loc4_ == null)
         {
         ...
         if(_loc7_ != null && _loc9_ > 0)
         {
            ...
            while(_loc18_ < _loc9_)
            {
               ...
               if(_loc12_ != null)
               {
                  ...
                  else if(_loc11_.scaleH == SkinLayoutEntity.const_288)
                  {
                     _loc14_ = true;
                     _loc13_.right += _loc16_;
                     if(_loc13_.width < 1)
                  ...
                  else if(_loc11_.scaleV == SkinLayoutEntity.const_288)
                  {
                     _loc15_ = true;
                     _loc13_.bottom += _loc17_;
                     if(_loc13_.height < 1)
                  ...
                  else if(_loc11_.scaleV == SkinLayoutEntity.const_288 || _loc11_.scaleH == SkinLayoutEntity.const_288)
                  {
                  ...
                  {
                     var_773.a = _loc13_.width / _loc19_.width;
                     var_773.d = _loc13_.height / _loc19_.height;
                     _loc32_ = new BitmapData(_loc13_.width,_loc13_.height,false);
                     _loc32_.draw(_loc19_,var_773);
                     _loc33_ = new BitmapData(_loc13_.width,_loc13_.height,true,0);
                     _loc33_.draw(_loc20_,var_773,null);
      ...
      override public function dispose() : void
      {
         ...
         super.dispose();
         var_773 = null;
         for(_loc1_ in var_660)
         {
            _loc2_ = var_660[_loc1_] as BitmapData;
            _loc2_.dispose();
            delete var_660[_loc1_];
         }
         var_660 = null;
