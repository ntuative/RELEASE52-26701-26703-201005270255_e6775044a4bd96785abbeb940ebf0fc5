package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IGraphicContextHost
   {
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_118,WindowParam.const_150);
         var _loc2_:* = !testParamFlag(WindowParam.const_141,WindowParam.const_152);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_8.clone();
            if(_loc1_)
      ...
      {
         var_658 = param1;
         var_555 = !!var_658 ? uint(var_555 | var_1414) : uint(var_555 & 16777215);
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + var_1643 + "]";
      }
      ...
      protected function forwardWindowNotifyEvent(param1:WindowNotifyEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowNotifyEvent.const_1013:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_1405:
               _loc2_ = "null";
               _loc4_ = true;
               break;
         ...
         if(_loc2_ == WindowEvent.const_189)
         {
      ...
      public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_17)
         {
            var_17 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_756,var_8);
      ...
      public function set blend(param1:Number) : void
      {
         ...
         var_16.invalidate(this,var_8,WindowRedrawFlag.const_983);
      }
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         _loc3_.parent = this;
         if(var_977 || _loc3_.hasGraphicsContext())
         {
         ...
         update(this,new WindowNotifyEvent(WindowNotifyEvent.const_350,this,param1));
         return param1;
      }
      ...
      {
         var_1414 = param1 & 4278190080;
         var_555 = !!var_658 ? uint(param1) : uint(param1 & 16777215);
         var_16.invalidate(this,var_8,WindowRedrawFlag.const_78);
      }
            ...
            switch(param2.type)
            {
               case MouseEvent.MOUSE_DOWN:
                  ...
                  if(testParamFlag(WindowParam.const_314))
                  {
                     ...
                     while(_loc5_ != null)
                     {
                        if(_loc5_.testParamFlag(WindowParam.const_218))
                        {
                  ...
                  if((_param & 0) > 0)
                  {
                     ...
                     while(_loc5_ != null)
                     {
                        if(_loc5_.testParamFlag(WindowParam.const_266))
                        {
               ...
               case MouseEvent.MOUSE_UP:
                  ...
                  if(testParamFlag(WindowParam.const_266))
                  {
         ...
         if(param2 is WindowNotifyEvent)
         {
            switch(param2.type)
            {
               case WindowNotifyEvent.const_190:
                  ...
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_496,this,null));
                     if(testParamFlag(WindowParam.const_166,WindowParam.const_150))
                     {
                        updateScaleRelativeToParent();
                     }
                     else if(testParamFlag(WindowParam.const_162,WindowParam.const_152))
                     {
                        updateScaleRelativeToParent();
                     }
                     if(var_9 != null)
                     {
                        ...
                        _param = _loc8_;
                        var_9.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_290,var_9,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_429:
                  var_16.invalidate(this,var_8.union(var_58),WindowRedrawFlag.const_470);
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_1041,this,null));
                     if(var_9 != null)
                     {
                        var_9.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_261,var_9,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_321:
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_746,this,null));
                     if(var_9 != null)
                     {
                  ...
                  break;
               case WindowNotifyEvent.const_379:
                  var_16.invalidate(this,var_8,WindowRedrawFlag.const_840);
                  break;
               case WindowNotifyEvent.const_469:
                  _loc6_ = new Array();
               ...
               case WindowNotifyEvent.const_437:
                  if(!(_param & 0))
                  {
                     ...
                     {
                        setupGraphicsContext();
                        var_16.invalidate(this,var_8,WindowRedrawFlag.const_470);
                     }
                  }
                  else if(_param & 0)
                  {
               ...
               case WindowNotifyEvent.const_224:
                  ...
                  break;
               case WindowNotifyEvent.const_496:
                  var_9.getRegionProperties(null,var_294);
                  updateScaleRelativeToParent();
                  break;
               case WindowNotifyEvent.const_350:
      ...
      {
         return var_653 != null ? var_653 : (var_9 != null ? var_9.procedure : nullEventProc);
      }
      ...
      public function removeChild(param1:IWindow) : IWindow
      {
         ...
         update(this,new WindowNotifyEvent(WindowNotifyEvent.const_733,this,param1));
         return param1;
      }
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         _loc2_.parent = this;
         if(var_977 || _loc2_.hasGraphicsContext())
         {
            setupGraphicsContext();
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc6_ && !_loc5_)
         {
            ...
            if(_loc7_ == WindowParam.const_430)
            {
               param1 -= (param3 - 0) / 2;
               _loc5_ = true;
            }
         ...
         if(_loc5_ || _loc6_)
         {
            if(_loc5_)
            {
               _loc10_ = new WindowNotifyEvent(WindowNotifyEvent.const_955,this,null,true);
               update(this,_loc10_);
            ...
            if(_loc6_)
            {
               _loc10_ = new WindowNotifyEvent(WindowNotifyEvent.const_665,this,null,true);
               update(this,_loc10_);
               if(_loc10_.isWindowOperationPrevented())
               {
                  _loc6_ = false;
      ...
      public function lock() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1279,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
      ...
      public function unlock() : Boolean
      {
         ...
         setStateFlag(WindowState.const_69,false);
         _loc1_.type = WindowNotifyEvent.const_1261;
         update(this,_loc1_);
         return true;
      }
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(var_9 != param1)
         {
            ...
            else
            {
               ...
               var_294.width = 0;
               var_294.height = 0;
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_844,this,_loc2_));
            }
         }
      }
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,_type,var_81,_param,var_16,var_8,null,var_653,properties,var_657.concat(),_id) as WindowController;
         _loc2_.var_556 = var_556;
         _loc2_.var_164 = var_164;
         _loc2_._debug = _debug;
         _loc2_.var_294 = var_294.clone();
      ...
      public function enable() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_684;
         update(this,_loc1_);
         return true;
      }
      ...
      protected function forwardMouseEvent(param1:MouseEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case MouseEvent.MOUSE_DOWN:
               ...
               break;
            case MouseEvent.MOUSE_UP:
               _loc2_ = !!_loc6_ ? "null" : WindowMouseEvent.const_460;
               break;
            case MouseEvent.MOUSE_WHEEL:
               _loc2_ = "null";
         }
      ...
      {
         if(var_35 == WindowState.const_475)
         {
            return true;
         }
