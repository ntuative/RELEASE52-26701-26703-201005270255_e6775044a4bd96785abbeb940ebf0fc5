package com.sulake.core.utils
{
   ...
   public class LibraryLoader extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_1444:uint = 2;
      
      protected static const const_1446:uint = 1;
      
      public static const const_878:int = 5;
      
      protected static const const_1123:uint = 7;
      ...
      protected var var_2311:String = "";
      
      protected var var_490:XML;
      
      protected var var_1135:Boolean = true;
      
      protected var var_659:Boolean = false;
      ...
      protected var var_460:Boolean = false;
      ...
      {
         var_2312 = param1;
         dispatchEvent(new LibraryLoaderEvent(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_ERROR,var_150,bytesTotal,bytesLoaded));
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            dispatchEvent(new LibraryLoaderEvent(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_DISPOSE,var_150,bytesTotal,bytesLoaded));
            try
            {
               var_14.close();
               var_14.unload();
      ...
      protected function debug(param1:String) : void
      {
         ...
         if(_debug)
         {
            dispatchEvent(new LibraryLoaderEvent(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_DEBUG,var_150,bytesTotal,bytesLoaded));
         }
      }
      ...
      protected function loadEventHandler(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case Event.UNLOAD:
               ...
               dispatchEvent(new LibraryLoaderEvent(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_UNLOAD,var_150,bytesTotal,bytesLoaded));
               break;
            case ProgressEvent.PROGRESS:
               debug("Load event PROGRESS for file \"" + var_14.contentLoaderInfo.url + "\"");
               dispatchEvent(new LibraryLoaderEvent(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_PROGRESS,var_150,bytesTotal,bytesLoaded));
               break;
         ...
         if(var_461 == LibraryLoader.const_1443)
         {
            if(analyzeLibrary())
            {
               var_461 |= 0;
         ...
         if(var_461 == LibraryLoader.const_1123)
         {
            var_659 = true;
            prepareLibrary();
            removeEventListeners();
            dispatchEvent(new LibraryLoaderEvent(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE,var_150,bytesTotal,bytesLoaded));
         }
      }
