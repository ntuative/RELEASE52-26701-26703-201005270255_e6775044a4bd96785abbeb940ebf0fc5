package com.sulake.core.utils
{
   ...
   public class LibraryLoaderQueue extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_1449:int = 4;
      ...
      private function removeLoader(param1:LibraryLoader) : void
      {
         ...
         _loc2_ = var_626.indexOf(param1);
         if(_loc2_ > -1)
         {
            var_626.splice(_loc2_,1);
         }
      ...
      private function next() : void
      {
         ...
         if(!disposed)
         {
            while(var_251.length < const_1449 && false)
            {
               _loc1_ = var_626.shift();
               var_251.push(_loc1_);
               _loc1_.resume();
            }
         }
