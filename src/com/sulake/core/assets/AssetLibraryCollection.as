package com.sulake.core.assets
{
   ...
   public class AssetLibraryCollection extends EventDispatcher implements IAssetLibrary
   {
      ...
      protected var var_970:LoaderContext;
      ...
      public function AssetLibraryCollection(param1:String)
      {
         ...
         var_30 = new Array();
         var_560 = new Array();
         var_970 = new LoaderContext(false,ApplicationDomain.currentDomain,null);
         var_463 = new AssetLibrary("lib-" + var_662++);
         var_30.push(var_463);
      }
      ...
      public function loadFromFile(param1:LibraryLoader, param2:Boolean = false) : void
      {
         ...
         {
            loaderContext = var_970;
         }
         var _loc3_:IAssetLibrary = new AssetLibrary("lib-" + var_662++);
         var_560.push(_loc3_);
