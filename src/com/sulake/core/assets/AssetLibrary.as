package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      private static var var_1042:Array = new Array();
      
      private static var _sharedListOfTypesByMime:Dictionary;
      
      private static var var_594:uint = 0;
      
      public static const const_593:String = "AssetLibraryReady";
      
      public static const const_1365:String = "AssetLibraryUnloaded";
      
      public static const const_402:String = "AssetLibraryLoaded";
      
      public static const const_1380:String = "AssetLibraryLoadError";
      ...
      public function AssetLibrary(param1:String)
      {
         ...
         ++var_594;
         var_406 = new Dictionary(false);
         var_407 = new Dictionary(false);
         var_724 = new Dictionary(false);
         var_133 = new Dictionary(false);
         var_1042.push(this);
      }
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc5_ in var_406)
         {
            _loc4_ = AssetTypeDeclaration(var_406[_loc5_]);
            if(_loc4_ != null)
            {
               if(_loc4_.fileTypes.indexOf(_loc3_))
               {
      ...
      public function unload() : void
      {
         var _loc1_:* = null;
         var _loc2_:* = null;
         for(_loc1_ in var_407)
         {
            _loc2_ = var_407[_loc1_];
            _loc2_.assetLoader.dispose();
            delete var_407[_loc1_];
         }
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         if(var_491)
         {
            AssetLibrary.fetchLibraryContents(this,var_490,var_352);
         }
         var_310 = true;
         dispatchEvent(new Event(AssetLibrary.const_402));
         dispatchEvent(new Event(AssetLibrary.const_593));
         if(var_491)
         {
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         var _loc4_:AssetLoaderStruct = var_407[param2.url];
         if(_loc4_ != null)
         {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_842,assetLoadEventHandler);
         _loc4_ = new AssetLoaderStruct(param1,_loc6_);
         var_407[param2.url] = _loc4_;
         return _loc4_;
      }
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         ...
         {
            if(var_406.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            var_406[param1.mimeType] = param1;
         }
         return true;
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            unload();
            super.dispose();
            var_1042.splice(var_1042.indexOf(this),1);
            --var_594;
            var_407 = null;
            var_724 = null;
            var_133 = null;
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         {
            _loc3_ = AssetTypeDeclaration(var_406[_loc4_]);
            if(_loc3_ != null)
            {
               if(_loc3_.assetClass == param1)
               {
      ...
      {
         var _loc2_:IAsset = var_133[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      private function assetLoadEventHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var struct:AssetLoaderStruct = var_407[loader.url];
         if(struct == null)
         {
         ...
         switch(e.type)
         {
            case AssetLoaderEvent.const_36:
               ...
               if(decl != null)
               {
                  ...
                  var_133[struct.assetName] = asset;
               }
               else
               {
                  e = new AssetLoaderEvent(AssetLoaderEvent.const_50,e.status);
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         _loc3_ = AssetTypeDeclaration(var_406[param1]);
         if(_loc3_ != null)
         {
            return _loc3_;
         }
