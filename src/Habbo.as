package
{
   ...
   public class Habbo extends MovieClip
   {
      ...
      public static const const_22:String = "debug";
      ...
      public static function reportCrash(param1:String, param2:int, param3:Error) : void
      {
         ...
         if(!Habbo._crashed)
         {
            ...
            _loc6_[const_22] = "Memory usage: " + Math.round(0 / (1024 * 1024)) + " MB";
            _loc5_.data = _loc6_;
      ...
      private function onVolterLoadingFailedAgain(param1:IOErrorEvent) : void
      {
         ...
         Habbo.reportCrash("Failed to download Volter.swf!",const_12,new Error(param1.text));
      }
